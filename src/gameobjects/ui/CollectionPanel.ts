...
const COLLECTION_PAGES: CollectionPage[] = [
  ...
  { collectionCat: CollectionCategory.FOOD, itemCategory: Category.FOOD, line: FoodLine.FRUIT_AVOCADO, title: '牛油果' },
  ...
  { collectionCat: CollectionCategory.FOOD, itemCategory: Category.FOOD, line: FoodLine.FRUIT_DRAGONFRUIT, title: '火龙果' },
