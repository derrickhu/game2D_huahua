...
export const DECO_DEFS: DecoDef[] = [
  ...
  { id: 'workshop_summer_dining_chair', name: '夏日西瓜餐椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 7, icon: 'workshop_summer_dining_chair', desc: '工坊匠心：蜜色木框配薄荷绿坐垫，落地可四面旋转，适合围着西瓜餐桌摆', workshopExclusive: true, defaultScale: 1.55, decorationPanelTab: 'furniture' },
