...
export const DECO_DEFS: DecoDef[] = [
  ...
  { id: 'shelf_step',    name: '阶梯花架',    slot: DecoSlot.SHELF, rarity: DecoRarity.COMMON, cost: 655, starValue: 2, icon: 'shelf_step',   desc: '层层叠叠，像小山丘', unlockRequirement: { level: 2 }, defaultScale: 1.55 },
  ...
  { id: 'table_work',     name: '花艺工作台',  slot: DecoSlot.TABLE, rarity: DecoRarity.FINE,   cost: 1565, starValue: 2, icon: 'table_work',    desc: '蜜木双层台，瓶瓶罐罐都是好看的花', unlockRequirement: { level: 6 }, defaultScale: 1.28 },
  ...
  // ═══════ ③ 灯具 (light) ═══════
  { id: 'light_desk',     name: '台灯',        slot: DecoSlot.LIGHT, rarity: DecoRarity.COMMON, cost: 195, starValue: 2,  icon: 'light_desk',    desc: '简约台灯，温暖光芒', unlockRequirement: { level: 2 }, defaultScale: 0.73 },
  ...
  // ═══════ ⑤ 墙饰 / 挂件 (wallart) ═══════
  { id: 'wallart_plant',  name: '植物壁挂',    slot: DecoSlot.WALLART, rarity: DecoRarity.COMMON, cost: 265, starValue: 2,  icon: 'wallart_plant',  desc: '墙上的一抹绿意', unlockRequirement: { level: 2 }, defaultScale: 1.23 },
  ...
  { id: 'garden_arbor',    name: '藤蔓凉亭',   slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE,   cost: 1735, starValue: 2, icon: 'garden_arbor',    desc: '紫藤木亭轻线稿，自然草边', unlockRequirement: { level: 5 }, defaultScale: 2.7 },
  ...
  { id: 'orn_awaken_bucket',  name: '金属醒花桶',   slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 726, starValue: 2, icon: 'orn_awaken_bucket',  desc: '深水养花，把花叫醒', unlockRequirement: { level: 3 }, defaultScale: 0.77, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_shop'] },
  ...
  { id: 'orn_flora_blooming_cactus', name: '开花仙人球', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 2000, starValue: 1, icon: 'orn_flora_blooming_cactus', desc: '陶盆里的圆滚滚仙人掌，顶着一朵艳粉花', unlockRequirement: { level: 7 }, defaultScale: 0.52 },
  { id: 'orn_flora_fern_terrarium', name: '蕨类生态瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 920, starValue: 1, icon: 'orn_flora_fern_terrarium', desc: '软木塞玻璃罐里迷你苔藓与蕨叶', unlockRequirement: { level: 8 }, defaultScale: 0.48 },
  ...
  { id: 'orn_flora_wildflower_mason_jar', name: '野花花束罐', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 1920, starValue: 1, icon: 'orn_flora_wildflower_mason_jar', desc: '蓝色梅森罐扎着虞美人与矢车菊', unlockRequirement: { level: 10 }, defaultScale: 0.76 },
  ...
  { id: 'orn_flora_hanging_spider_plant', name: '吊兰挂盆', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 8000, starValue: 1, icon: 'orn_flora_hanging_spider_plant', desc: '白绳编织吊盆，斑纹吊兰垂下来', unlockRequirement: { level: 12 }, defaultScale: 1.12 },
  { id: 'orn_flora_cherry_branch_vase', name: '樱花折枝瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 8800, starValue: 2, icon: 'orn_flora_cherry_branch_vase', desc: '青瓷高瓶插一枝盛放的樱花', unlockRequirement: { level: 13 }, defaultScale: 0.98 },
  { id: 'orn_flora_hanging_petunia', name: '矮牵牛吊篮', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 9600, starValue: 1, icon: 'orn_flora_hanging_petunia', desc: '藤编吊篮里粉紫矮牵牛瀑布般垂落', unlockRequirement: { level: 14 }, defaultScale: 0.95 },
  { id: 'orn_flora_wall_ivy_trellis', name: '爬墙常春藤架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 10400, starValue: 2, icon: 'orn_flora_wall_ivy_trellis', desc: '木格栅上攀着翠藤与小紫花', unlockRequirement: { level: 15 }, defaultScale: 1.15 },
  { id: 'orn_flora_fiddle_leaf_pot', name: '琴叶榕大绿植', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 11200, starValue: 1, icon: 'orn_flora_fiddle_leaf_pot', desc: '高筒奶油陶盆里的琴叶榕，一角立刻变森系', unlockRequirement: { level: 16 }, defaultScale: 1.18 },
  { id: 'orn_flora_pink_phalaenopsis_pot', name: '粉蝶兰丛盆', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 12000, starValue: 2, icon: 'orn_flora_pink_phalaenopsis_pot', desc: '小紫盆上多梗盛放的粉色蝴蝶兰，唇瓣形态准确', unlockRequirement: { level: 17 }, defaultScale: 0.88 },
  ...
  { id: 'early_blush_vine_sofa', name: '藤蔓粉沙发', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 1580, starValue: 6, icon: 'early_blush_vine_sofa', desc: '樱粉软绒双人沙发，奶油坐垫与绿藤点缀，休息角立刻变精致', unlockRequirement: { level: 3 }, defaultScale: 1.58, decorationPanelTab: 'furniture' },
  { id: 'early_oak_island', name: '蜜木岛台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 1000, starValue: 6, icon: 'early_oak_island', desc: '空台面蜜色原木岛台，干净好摆，和初级木作很搭', unlockRequirement: { level: 2 }, defaultScale: 1.28, decorationPanelTab: 'furniture' },
  ...
  { id: 'wallart_cream_lace_rod_curtain', name: '奶白蕾丝短帘', slot: DecoSlot.WALLART, rarity: DecoRarity.COMMON, cost: 200, starValue: 1, icon: 'wallart_cream_lace_rod_curtain', desc: '暖木帘杆配奶白蕾丝短帘，绣花边温柔贴墙', unlockRequirement: { level: 1 }, defaultScale: 1.8 },
  ...
  { id: 'table_square_bistro',  name: '方桌',         slot: DecoSlot.TABLE,    rarity: DecoRarity.COMMON, cost: 648,  starValue: 1, icon: 'table_square_bistro',  desc: '方正好用的边角桌', unlockRequirement: { level: 3 },  defaultScale: 1.4,  decorationPanelTab: 'furniture' },
  ...
  { id: 'wallart_greenhouse_chalkboard', name: '花房小黑板', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 630, starValue: 2, icon: 'wallart_greenhouse_chalkboard', desc: '户外落地 A 字招牌架，黑白板粉笔「花花」，小花饰点缀', unlockRequirement: { level: 3 }, defaultScale: 1.02, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_shop'] },
  ...
  { id: 'orn_greenhouse_coat_rack', name: '木轨衣帽挂钩', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 300, starValue: 2, icon: 'orn_greenhouse_coat_rack', desc: '蜜木轨挂着樱粉风衣、薄荷小包与草帽', unlockRequirement: { level: 1 }, defaultScale: 1, decorationPanelTab: 'furniture' },
  ...
  { id: 'tea_paper_lantern', name: '和纸行灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE, cost: 8900, starValue: 4, icon: 'tea_paper_lantern', desc: '竹骨和纸落地行灯，暖黄柔光把茶寮照得静静的', unlockRequirement: { level: 15 }, defaultScale: 1 },
