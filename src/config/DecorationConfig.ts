...
export const ROOM_STYLES: RoomStyleDef[] = [
  ...
  { id: 'style_tea_house_darkwood_two_story_nb2', name: '乌木茶寮', cost: 43000, starValue: 10, rarity: DecoRarity.FINE, bgTexture: 'bg_room_tea_house_darkwood_two_story_nb2', desc: '深色红木双层茶寮：乌木柱栏、黛青屋瓦与暖 cream 地砖，配古风家具更显沉稳', unlockRequirement: { level: 26 }, allowedSceneIds: ['tea_house'] },
  ...
  { id: 'style_forest_treehouse_spring_bloom_nb2', name: '春花藤巢', cost: 64500, starValue: 8, rarity: DecoRarity.FINE, bgTexture: 'bg_room_forest_treehouse_spring_bloom_nb2', desc: '春日换色壳：巨橡抽新芽，粉黄紫爬藤绕干，薄荷春花瓦檐与屋顶鸟巢', unlockRequirement: { level: 36 }, allowedSceneIds: ['forest_treehouse'] },
  ...
  {
    id: 'style_dream_cloud_purple_mooncradle_nb2', name: '紫月云台', cost: 86666, starValue: 8, rarity: DecoRarity.FINE, bgTexture: 'bg_room_dream_cloud_purple_mooncradle_nb2', desc: '梦云小屋换色壳：粉紫月云双层空壳，月石地面、星月吊饰与云梯围栏更梦幻', unlockRequirement: { level: 22 }, allowedSceneIds: ['dream_cloud_house'] },
  ...
  { id: 'style_flower_farm_spring_vine_nb2', name: '青藤春棚', cost: 72000, starValue: 8, rarity: DecoRarity.FINE, bgTexture: 'bg_room_flower_farm_spring_vine_nb2', desc: '春日换色壳：常春藤爬墙、浅绿木瓦与 mint spring 氛围', unlockRequirement: { level: 32 }, allowedSceneIds: ['flower_farm_house'] },
];
...
export const DECO_DEFS: DecoDef[] = [
  ...
  { id: 'shelf_step',    name: '阶梯花架',    slot: DecoSlot.SHELF, rarity: DecoRarity.COMMON, cost: 655, starValue: 3, icon: 'shelf_step',   desc: '层层叠叠，像小山丘', unlockRequirement: { level: 2 }, defaultScale: 1.35 },
  ...
  { id: 'table_drawer',   name: '抽屉式柜台',  slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 1200, starValue: 4, icon: 'table_drawer',  desc: '带抽屉的实用柜台', unlockRequirement: { level: 9 }, defaultScale: 1.23 },
  { id: 'table_work',     name: '花艺工作台',  slot: DecoSlot.TABLE, rarity: DecoRarity.FINE,   cost: 1044, starValue: 3, icon: 'table_work',    desc: '专业的花艺操作台', unlockRequirement: { level: 6 }, defaultScale: 1.38 },
  ...
  // ═══════ ③ 灯具 (light) ═══════
  { id: 'light_desk',     name: '台灯',        slot: DecoSlot.LIGHT, rarity: DecoRarity.COMMON, cost: 195, starValue: 3,  icon: 'light_desk',    desc: '简约台灯，温暖光芒', unlockRequirement: { level: 2 }, defaultScale: 0.43 },
  ...
  // ═══════ ⑤ 墙饰 / 挂件 (wallart) ═══════
  { id: 'wallart_plant',  name: '植物壁挂',    slot: DecoSlot.WALLART, rarity: DecoRarity.COMMON, cost: 265, starValue: 3,  icon: 'wallart_plant',  desc: '墙上的一抹绿意', unlockRequirement: { level: 2 }, defaultScale: 0.93 },
  ...
  { id: 'garden_arbor',    name: '藤蔓凉亭',   slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE,   cost: 1446, starValue: 3, icon: 'garden_arbor',    desc: '紫藤木亭轻线稿，自然草边', unlockRequirement: { level: 5 }, defaultScale: 2 },
  ...
  { id: 'table_wrap_station', name: '花艺包装台',   slot: DecoSlot.TABLE,    rarity: DecoRarity.FINE,   cost: 480,  starValue: 1, icon: 'table_wrap_station', desc: '牛皮纸与丝带，礼物包起来', unlockRequirement: { level: 3 },  defaultScale: 1.2 },
  { id: 'table_rattan_twoset', name: '藤编边桌凳组', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE,   cost: 799,  starValue: 4, icon: 'table_rattan_twoset', desc: '圆几配双凳，度假风下午茶', unlockRequirement: { level: 3 }, defaultScale: 0.83, decorationPanelTab: 'furniture' },
  ...
  { id: 'orn_window_garden',  name: '窗台花园组',   slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 1158,  starValue: 3, icon: 'orn_window_garden',  desc: '三盆小花排排站', unlockRequirement: { level: 6 }, defaultScale: 0.87 },
  ...
  { id: 'table_side_round',     name: '大理石小边几', slot: DecoSlot.TABLE,    rarity: DecoRarity.FINE,   cost: 1200,  starValue: 3, icon: 'table_side_round',     desc: '放一盆小绿植刚好', unlockRequirement: { level: 8 },  defaultScale: 0.97, decorationPanelTab: 'furniture' },
  { id: 'light_radio_vintage',  name: '复古收音机',   slot: DecoSlot.LIGHT,   rarity: DecoRarity.FINE,   cost: 1200,  starValue: 3, icon: 'light_radio_vintage',  desc: '店里轻声放老歌', unlockRequirement: { level: 8 },  defaultScale: 0.36 },
  ...
  { id: 'light_kettle_pastel',  name: '电热水壶',     slot: DecoSlot.LIGHT,   rarity: DecoRarity.COMMON, cost: 360,  starValue: 1, icon: 'light_kettle_pastel',  desc: '泡茶泡咖啡都靠它', unlockRequirement: { level: 5 },  defaultScale: 0.36 },
  { id: 'light_humidifier_cute', name: '桌面加湿器',  slot: DecoSlot.LIGHT,   rarity: DecoRarity.FINE,   cost: 855,  starValue: 2, icon: 'light_humidifier_cute', desc: '给小花加一点湿润', unlockRequirement: { level: 6 },  defaultScale: 0.36 },
  ...
  { id: 'orn_greenhouse_rug', name: '粉色碎花地毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 200, starValue: 3, icon: 'orn_greenhouse_rug', desc: '粉地白花图案的小地垫', unlockRequirement: { level: 2 }, defaultScale: 0.92, depthSortFloorMat: true, decorationPanelTab: 'furniture' },
  ...
  { id: 'butterfly_house_display_case',  name: '观蝶玻璃柜', slot: DecoSlot.SHELF,    rarity: DecoRarity.RARE,   cost: 3000, starValue: 5, icon: 'butterfly_house_display_case',  desc: '木框玻璃柜里陈列蝶影与枝叶', unlockRequirement: { level: 13 }, defaultScale: 1.78, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_writing_desk',  name: '观蝶书写桌', slot: DecoSlot.TABLE,    rarity: DecoRarity.FINE,   cost: 2000,  starValue: 4, icon: 'butterfly_house_writing_desk',  desc: '记录观察笔记的小书桌，静静贴着墙角', unlockRequirement: { level: 12 }, defaultScale: 1.12, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_sofa',          name: '蝶翼双人沙发', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 2000, starValue: 6, icon: 'butterfly_house_sofa',          desc: '柔软靠背像展开的蝶翼，适合小憩', unlockRequirement: { level: 12 }, defaultScale: 1.38, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_wicker_chair',  name: '藤编休闲椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE,   cost: 1720,  starValue: 3, icon: 'butterfly_house_wicker_chair',  desc: '轻盈藤编椅，把温室角落变成阅读位', unlockRequirement: { level: 11 }, defaultScale: 0.98, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_tea_table',     name: '圆茶几', slot: DecoSlot.TABLE,        rarity: DecoRarity.COMMON, cost: 1200,  starValue: 2, icon: 'butterfly_house_tea_table',     desc: '圆润小茶几，摆上点心就很有氛围', unlockRequirement: { level: 8 }, defaultScale: 0.96, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_wall_frame',    name: '蝶影挂画', slot: DecoSlot.WALLART,    rarity: DecoRarity.FINE,   cost: 1200,  starValue: 2, icon: 'butterfly_house_wall_frame',    desc: '把蝴蝶标本感做成柔和挂画，适合干净墙面', unlockRequirement: { level: 8 }, defaultScale: 0.88, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  ...
  { id: 'butterfly_house_moon_specimen_shelf', name: '蝶标标本柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 4500, starValue: 4, icon: 'butterfly_house_moon_specimen_shelf', desc: '浅木陈列柜分层展示框装蝶标，下层玻璃门收纳册', unlockRequirement: { level: 13 }, defaultScale: 1.65, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_aurora_terrarium', name: '幻彩蝴蝶温室', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 5100, starValue: 4, icon: 'butterfly_house_aurora_terrarium', desc: '幻彩玻璃罩温室里长着发光小花，一只蝶影停驻', unlockRequirement: { level: 13 }, defaultScale: 1.68, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_moon_crescent_rug', name: '新月针织毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 5250, starValue: 3, icon: 'butterfly_house_moon_crescent_rug', desc: '奶油针织毯卷着淡紫新月边，铺出柔软阅读角', unlockRequirement: { level: 14 }, defaultScale: 1.25, depthSortYLift: 0, depthSortFloorMat: true, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_moon_star_chair', name: '星纹观蝶椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 5850, starValue: 4, icon: 'butterfly_house_moon_star_chair', desc: '浅木扶手椅配雾蓝软垫与星形抱枕，月辉小憩位', unlockRequirement: { level: 14 }, defaultScale: 1.38, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  ...
  { id: 'villa_rose_armoire', name: '玫瑰顶衣柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 4400, starValue: 4, icon: 'villa_rose_armoire', desc: '奶油白立柜顶饰粉玫瑰，单门单屉收纳花艺杂物', unlockRequirement: { level: 13 }, defaultScale: 1.78, decorationPanelTab: 'furniture' },
  ...
  { id: 'deco_late_lv8_shelf_01', name: '迷你冷藏柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 865, starValue: 2, icon: 'deco_late_lv8_shelf_01', desc: '银灰双门小冷柜，玻璃门后瓶花剪影，无字牌', unlockRequirement: { level: 5 }, defaultScale: 1.12 },
  ...
  { id: 'deco_lv14_wall_butterfly_clock', name: '月蝶壁钟', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 4000, starValue: 5, icon: 'deco_lv14_wall_butterfly_clock', desc: '淡紫蝶翼外框的小壁钟，没有数字，像月光停在墙上', unlockRequirement: { level: 14 }, defaultScale: 0.7 },
  ...
  { id: 'deco_lv16_orn_hanging_chair', name: '藤编吊篮秋千', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 9900, starValue: 6, icon: 'deco_lv16_orn_hanging_chair', desc: '柚木支架吊起藤编篮椅，珊瑚抱枕带来度假感', unlockRequirement: { level: 16 }, defaultScale: 1.58, decorationPanelTab: 'furniture' },
  { id: 'deco_lv16_wall_shell_mirror', name: '贝壳壁挂镜', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 7500, starValue: 6, icon: 'deco_lv16_wall_shell_mirror', desc: '贝壳弧形镜框点缀小珍珠，墙面多了一点海风', unlockRequirement: { level: 16 }, defaultScale: 0.85 },
  { id: 'deco_lv16_garden_coral_planter', name: '珊瑚花箱', slot: DecoSlot.GARDEN, rarity: DecoRarity.RARE, cost: 8100, starValue: 8, icon: 'deco_lv16_garden_coral_planter', desc: '珊瑚色长花箱盛着海风小花，和泳池伞组自然成套', unlockRequirement: { level: 16 }, defaultScale: 1.22, decorationPanelTab: 'garden' },
  { id: 'deco_lv17_shelf_surfboard', name: '冲浪板花架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 9300, starValue: 10, icon: 'deco_lv17_shelf_surfboard', desc: '旧冲浪板改成竖向花架，薄荷蓝与珊瑚花盆呼应海滨套', unlockRequirement: { level: 17 }, defaultScale: 1.55, decorationPanelTab: 'garden' },
  { id: 'deco_lv17_table_terrace_bar', name: '露台折叠吧台', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 10800, starValue: 7, icon: 'deco_lv17_table_terrace_bar', desc: '浅柚木折叠吧台配冰饮托盘，适合海边露台角落', unlockRequirement: { level: 17 }, defaultScale: 1.22, decorationPanelTab: 'furniture' },
  { id: 'deco_lv17_orn_seabreeze_rug', name: '海风圆地毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 7500, starValue: 5, icon: 'deco_lv17_orn_seabreeze_rug', desc: '厚织物圆地毯，抬高软包边与流苏让休闲区更像坐垫', unlockRequirement: { level: 17 }, defaultScale: 1.22, depthSortFloorMat: true, decorationPanelTab: 'furniture' },
  { id: 'deco_lv18_shelf_moon_glasshouse', name: '月光玻璃温室柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 10800, starValue: 7, icon: 'deco_lv18_shelf_moon_glasshouse', desc: '香槟金玻璃小温室，月光蓝蝶影与水晶花盆陈列其中', unlockRequirement: { level: 18 }, defaultScale: 1.3, decorationPanelTab: 'furniture' },
  { id: 'deco_lv18_light_firefly_lamp', name: '星萤庭院灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 8700, starValue: 9, icon: 'deco_lv18_light_firefly_lamp', desc: '月蓝玻璃灯罩里闪着星萤光点，适合蝶屋夜色', unlockRequirement: { level: 18 }, defaultScale: 1.35 },
  { id: 'deco_lv18_garden_butterfly_arch', name: '蝶翼月光拱门', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 12900, starValue: 8, icon: 'deco_lv18_garden_butterfly_arch', desc: '香槟金拱门展开半透明蝶翼，月光蓝水晶点亮庭院入口', unlockRequirement: { level: 18 }, defaultScale: 2.02, decorationPanelTab: 'garden' },
  { id: 'deco_lv19_wall_crystal_specimen', name: '水晶标本墙', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 9900, starValue: 11, icon: 'deco_lv19_wall_crystal_specimen', desc: '香槟金展示框里封存蝶翼水晶与干花标本，精致但无文字', unlockRequirement: { level: 19 }, defaultScale: 0.78 },
  { id: 'deco_lv19_orn_crescent_chaise', name: '月牙贵妃榻', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 11700, starValue: 7, icon: 'deco_lv19_orn_crescent_chaise', desc: '月牙形软榻配淡紫丝绒靠垫，适合高级休息角', unlockRequirement: { level: 19 }, defaultScale: 1.18, decorationPanelTab: 'furniture' },
  { id: 'deco_lv19_table_stardust_aroma', name: '星砂香氛台', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 9000, starValue: 9, icon: 'deco_lv19_table_stardust_aroma', desc: '圆角香氛小台摆着星砂玻璃瓶、月白托盘与迷你花束', unlockRequirement: { level: 19 }, defaultScale: 0.98, decorationPanelTab: 'furniture' },
  { id: 'deco_lv20_garden_moon_fountain', name: '月辉喷泉雕塑', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 14040, starValue: 10, icon: 'deco_lv20_garden_moon_fountain', desc: '月牙水晶喷泉与蝶翼雕塑组成庭院压轴大件', unlockRequirement: { level: 20 }, defaultScale: 1.4, decorationPanelTab: 'garden' },
  { id: 'deco_lv20_shelf_star_observatory', name: '星月观景陈列柜', slot: DecoSlot.SHELF, rarity: DecoRarity.LIMITED, cost: 17940, starValue: 9, icon: 'deco_lv20_shelf_star_observatory', desc: '小型观景台式陈列柜，玻璃穹顶里摆着星月花器', unlockRequirement: { level: 20 }, defaultScale: 1.32, decorationPanelTab: 'furniture' },
  { id: 'deco_lv20_wall_moon_sheer_curtain', name: '月纱蝶影帘', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 14235, starValue: 13, icon: 'deco_lv20_wall_moon_sheer_curtain', desc: '挂墙半透明月光纱帘，香槟金帘杆与蝶影坠饰让墙面更轻盈', unlockRequirement: { level: 20 }, defaultScale: 1.8 },
  ...
  { id: 'deco_lv10_table_zen_tea_low', name: '禅意茶台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 1200, starValue: 4, icon: 'deco_lv10_table_zen_tea_low', desc: '矮樱桃木茶台，青瓷茶具与一枝粉梅，安静茶席角落', unlockRequirement: { level: 10 }, defaultScale: 1.18, decorationPanelTab: 'furniture' },
  { id: 'deco_lv10_orn_zen_cushion_pair', name: '蒲团坐垫组', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 1000, starValue: 2, icon: 'deco_lv10_orn_zen_cushion_pair', desc: '玫粉与抹茶绿圆蒲团，配茶台正合适', unlockRequirement: { level: 10 }, defaultScale: 0.95, decorationPanelTab: 'furniture' },
  ...
  { id: 'deco_lv12_orn_mushroom_stool_pair', name: '蘑菇坐墩组', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 2000, starValue: 4, icon: 'deco_lv12_orn_mushroom_stool_pair', desc: '一红一米双蘑菇坐墩，森系小客座', unlockRequirement: { level: 12 }, defaultScale: 0.85, decorationPanelTab: 'furniture' },
  { id: 'deco_lv13_table_mushroom_round', name: '蘑菇圆茶桌', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 3000, starValue: 5, icon: 'deco_lv13_table_mushroom_round', desc: '粉色蘑菇伞盖做桌面，奶白菌柄做底座', unlockRequirement: { level: 13 }, defaultScale: 0.9, decorationPanelTab: 'furniture' },
  { id: 'deco_lv14_shelf_mushroom_cottage', name: '蘑菇小屋陈列架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 4400, starValue: 8, icon: 'deco_lv14_shelf_mushroom_cottage', desc: '蘑菇屋造型陈列架，三层拱形格放小花盆', unlockRequirement: { level: 14 }, defaultScale: 1.35 },
  { id: 'deco_lv15_garden_mushroom_grove', name: '蘑菇精灵丛', slot: DecoSlot.GARDEN, rarity: DecoRarity.RARE, cost: 2800, starValue: 9, icon: 'deco_lv15_garden_mushroom_grove', desc: '三色蘑菇与苔藓丛，配萤火虫提灯', unlockRequirement: { level: 12 }, defaultScale: 1.60, decorationPanelTab: 'garden' },
  ...
  { id: 'deco_lv16_orn_macaron_tower', name: '马卡龙塔', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 7500, starValue: 5, icon: 'deco_lv16_orn_macaron_tower', desc: '三层瓷盘配粉黄紫蓝马卡龙，下午茶担当', unlockRequirement: { level: 16 }, defaultScale: 0.78 },

  // —— 古董图书套（书架+地球仪桌+切斯特皮椅+植物标本；dark academia，适配复古/月辉）——
  { id: 'deco_lv15_shelf_antique_library', name: '复古胡桃书架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 2900, starValue: 9, icon: 'deco_lv15_shelf_antique_library', desc: '维多利亚胡桃木书架，皮革精装书与黄铜地球仪', unlockRequirement: { level: 12 }, defaultScale: 1.45 },
  { id: 'deco_lv16_table_globe_writing_desk', name: '地球仪写字桌', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 9000, starValue: 9, icon: 'deco_lv16_table_globe_writing_desk', desc: '小巧胡桃木书桌，黄铜浑天仪、羽毛笔与压花玻璃罩', unlockRequirement: { level: 16 }, defaultScale: 1.08, decorationPanelTab: 'furniture' },
  { id: 'deco_lv17_orn_chesterfield_armchair', name: '切斯特皮扶手椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 9750, starValue: 6, icon: 'deco_lv17_orn_chesterfield_armchair', desc: '酒红绗缝皮扶手椅，配胡桃短腿与亚麻盖毯', unlockRequirement: { level: 17 }, defaultScale: 0.98, decorationPanelTab: 'furniture' },
  { id: 'deco_lv18_wallart_botanical_taxonomy', name: '植物标本框', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 7500, starValue: 6, icon: 'deco_lv18_wallart_botanical_taxonomy', desc: '胡桃画框配米色羊皮纸，六格压花标本无文字', unlockRequirement: { level: 18 }, defaultScale: 1.10 },

  // —— 极光晶莹套（镜面池+水晶球+落地灯；月光蝶园色系延伸）——
  { id: 'deco_lv17_garden_aurora_mirror_pond', name: '极光镜面池', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 12300, starValue: 8, icon: 'deco_lv17_garden_aurora_mirror_pond', desc: '奶白卵石围出极光水镜，浮叶莲与水晶星簇', unlockRequirement: { level: 17 }, defaultScale: 1.95, decorationPanelTab: 'garden' },
  { id: 'deco_lv18_orn_aurora_crystal_orb', name: '极光水晶球', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 8100, starValue: 7, icon: 'deco_lv18_orn_aurora_crystal_orb', desc: '玻璃球里漾着极光雾与小弦月，香槟金三脚架托起', unlockRequirement: { level: 18 }, defaultScale: 0.45 },
  { id: 'deco_lv19_light_aurora_floor_lantern', name: '极光落地灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 9300, starValue: 10, icon: 'deco_lv19_light_aurora_floor_lantern', desc: '香槟金细杆托起雾面玻璃灯罩，灯罩里流动极光蓝紫', unlockRequirement: { level: 19 }, defaultScale: 1.30 },

  // —— 云端漫游套（云朵软墩+棉花云中岛+云秋千；棉花糖粉蓝，适配粉蓝/月辉）——
  { id: 'deco_lv18_orn_cloud_pouf_set', name: '云朵软墩组', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 7800, starValue: 6, icon: 'deco_lv18_orn_cloud_pouf_set', desc: '一大一小云朵造型软墩，奶白与浅粉刺绣小星', unlockRequirement: { level: 18 }, defaultScale: 1.05, decorationPanelTab: 'furniture' },
  { id: 'deco_lv19_table_cloud_dessert_island', name: '棉花云中岛', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 10200, starValue: 6, icon: 'deco_lv19_table_cloud_dessert_island', desc: '云朵造型桌面带粉色糖霜流挂，香槟金弯腿与小甜点', unlockRequirement: { level: 19 }, defaultScale: 1, decorationPanelTab: 'furniture' },
  { id: 'deco_lv20_garden_cloud_swing', name: '云端长秋千', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 18525, starValue: 9, icon: 'deco_lv20_garden_cloud_swing', desc: '云朵长椅吊在香槟金 A 形架上，弦月坠与星形抱枕', unlockRequirement: { level: 20 }, defaultScale: 1.9, decorationPanelTab: 'garden' },
  ...
  { id: 'deco_lv13_orn_teddy_armchair', name: '泰迪熊扶手椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 3000, starValue: 5, icon: 'deco_lv13_orn_teddy_armchair', desc: '小熊造型椅背，焦糖蜜色绒面，配奶色小毯', unlockRequirement: { level: 13 }, defaultScale: 0.85, decorationPanelTab: 'furniture' },
  ...
  { id: 'deco_lv16_wallart_harbor_arch_window', name: '海港拱窗景', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 8250, starValue: 8, icon: 'deco_lv16_wallart_harbor_arch_window', desc: '奶白拱窗框里收着金色海港落日，有小帆船与玫瑰窗台', unlockRequirement: { level: 16 }, defaultScale: 1.30 },
  { id: 'deco_lv20_orn_white_grand_piano', name: '白色三角钢琴', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 66000, starValue: 12, icon: 'deco_lv20_orn_white_grand_piano', desc: '奶白漆三角钢琴，香槟金腿与玫瑰花束、水晶烛台', unlockRequirement: { level: 20 }, defaultScale: 1.5, decorationPanelTab: 'furniture' },
  { id: 'jiangnan_wash_bench', name: '临河浣衣凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 7020, starValue: 1, icon: 'jiangnan_wash_bench', desc: '旧木矮凳叠着白布，底下藤篮装着浣衣日常', unlockRequirement: { level: 20 }, defaultScale: 0.95, decorationPanelTab: 'furniture' },

  // ═══════ ⑭ 仙气古风扩展 Lv21–30（batch53 · 全场景通用 · 家具/摆件/墙饰/庭院 Tab）
  { id: 'xianqi_maple_tier_shelf', name: '果篮层架', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 13156, starValue: 4, icon: 'xianqi_maple_tier_shelf', desc: '三层原木架配藤篮与柿子梨，顶栏枫叶花饰', unlockRequirement: { level: 21 }, defaultScale: 1.75 },
  { id: 'xianqi_maple_round_table', name: '枫影圆几', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 14014, starValue: 5, icon: 'xianqi_maple_round_table', desc: '桦木圆几嵌珊瑚枫叶纹，两只琥珀小茶杯', unlockRequirement: { level: 21 }, defaultScale: 0.88 },
  { id: 'xianqi_maple_incense_stand', name: '香云几', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 12584, starValue: 4, icon: 'xianqi_maple_incense_stand', desc: '双层浅木香案，青瓷香炉与轻烟', unlockRequirement: { level: 22 }, defaultScale: 1.27 },
  { id: 'xianqi_maple_folding_chair', name: '折扇游椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 14586, starValue: 5, icon: 'xianqi_maple_folding_chair', desc: '扇形靠背游椅，桃色坐垫与金扇骨', unlockRequirement: { level: 22 }, defaultScale: 0.98, decorationPanelTab: 'furniture' },
  { id: 'xianqi_plum_padded_stool', name: '暖绒绣墩', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 12298, starValue: 4, icon: 'xianqi_plum_padded_stool', desc: '梅粉绒面圆墩，白木底座配银流苏', unlockRequirement: { level: 23 }, defaultScale: 0.45, decorationPanelTab: 'furniture' },
  { id: 'xianqi_maple_landscape_screen', name: '秋山屏风', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 16016, starValue: 6, icon: 'xianqi_maple_landscape_screen', desc: '四扇绢屏绘珊瑚枫山，奶油木框无文字', unlockRequirement: { level: 23 }, defaultScale: 1.82 },
  { id: 'xianqi_plum_snow_window', name: '梅枝雪窗', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 13585, starValue: 5, icon: 'xianqi_plum_snow_window', desc: '圆月窗框，磨砂玻璃上梅枝与细雪', unlockRequirement: { level: 24 }, defaultScale: 1.28 },
  { id: 'xianqi_plum_snow_basin', name: '雪梅水钵', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 15444, starValue: 6, icon: 'xianqi_plum_snow_basin', desc: '白石水钵浮着淡蓝水面与梅瓣', unlockRequirement: { level: 24 }, defaultScale: 0.92 },
  { id: 'xianqi_plum_wardrobe', name: '雪白轻柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 16874, starValue: 6, icon: 'xianqi_plum_wardrobe', desc: '白漆衣柜嵌银梅枝，淡蓝云形拉手', unlockRequirement: { level: 25 }, defaultScale: 1.45 },
  { id: 'xianqi_plum_canopy_bed', name: '寒梅纱床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 25740, starValue: 8, icon: 'xianqi_plum_canopy_bed', desc: '白木四柱床垂冰蓝梅粉纱幔，雪花刺绣', unlockRequirement: { level: 25 }, defaultScale: 2.2, decorationPanelTab: 'furniture' },
  { id: 'xianqi_koi_twin_stone_seat', name: '双鲤石凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 15180, starValue: 5, icon: 'xianqi_koi_twin_stone_seat', desc: '一对石凳刻鲤纹，青绿软垫', unlockRequirement: { level: 26 }, defaultScale: 0.78, decorationPanelTab: 'furniture' },
  { id: 'xianqi_koi_scale_cabinet', name: '鱼鳞圆柜', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 28480, starValue: 6, icon: 'xianqi_koi_scale_cabinet', desc: '鼓形圆柜门绘青金鱼鳞纹', unlockRequirement: { level: 26 }, defaultScale: 0.92 },
  { id: 'xianqi_koi_wall_fountain', name: '壁泉游鳞', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 20000, starValue: 5, icon: 'xianqi_koi_wall_fountain', desc: '挂墙玉色泉板，金鲤浮雕与细流', unlockRequirement: { level: 27 }, defaultScale: 1.25 },
  { id: 'xianqi_koi_pond_tea_table', name: '临池茶台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 30130, starValue: 7, icon: 'xianqi_koi_pond_tea_table', desc: '矮茶台侧嵌小池，青瓷茶具与游鳞', unlockRequirement: { level: 27 }, defaultScale: 1.82 },
  { id: 'xianqi_orchid_pavilion_mirror', name: '兰月妆镜台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 28975, starValue: 6, icon: 'xianqi_orchid_pavilion_mirror', desc: '淡紫木妆台，圆银镜与兰紫绢屏', unlockRequirement: { level: 28 }, defaultScale: 1.4 },
  { id: 'xianqi_koi_stream_bridge', name: '游鳞小桥', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 33430, starValue: 8, icon: 'xianqi_koi_stream_bridge', desc: '青玉短桥金栏，拱下可见锦鲤', unlockRequirement: { level: 28 }, defaultScale: 1.6 },
  { id: 'xianqi_bamboo_mist_fence', name: '翠竹篱段', slot: DecoSlot.GARDEN, rarity: DecoRarity.COMMON, cost: 9680, starValue: 4, icon: 'xianqi_bamboo_mist_fence', desc: '短竹篱系雾灰丝带，清新庭院边栏', unlockRequirement: { level: 29 }, defaultScale: 1 },
  { id: 'xianqi_bamboo_joint_desk', name: '竹节书案', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 21220, starValue: 5, icon: 'xianqi_bamboo_joint_desk', desc: '竹节腿书案，淡绿纸卷与玉镇纸', unlockRequirement: { level: 29 }, defaultScale: 1.18 },
  { id: 'xianqi_bamboo_book_tower', name: '竹筒书塔', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 32100, starValue: 6, icon: 'xianqi_bamboo_book_tower', desc: '竹筒螺旋书塔，素卷与兰芽点缀', unlockRequirement: { level: 29 }, defaultScale: 1.55 },
  { id: 'xianqi_bamboo_mist_daybed', name: '竹影卧榻', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 55000, starValue: 7, icon: 'xianqi_bamboo_mist_daybed', desc: '竹框卧榻配鼠尾草垫，一端垂雾灰纱', unlockRequirement: { level: 29 }, defaultScale: 1.55, decorationPanelTab: 'furniture' },

  // ═══════ ⑭.4 现代生活扩展 Lv25–35（高价常驻 · 电器 / 露营 / 软装 / 店铺小设备）
  { id: 'modern_folding_laundry_rack', name: '阳台折叠晾衣架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 23810, starValue: 4, icon: 'modern_folding_laundry_rack', desc: '白管折叠架挂满柔色衣物，带来阳台生活气', unlockRequirement: { level: 25 }, defaultScale: 1.15, decorationPanelTab: 'furniture' },
  { id: 'modern_kitchen_base_counter', name: '奶油蓝长厨柜', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 34492, starValue: 4, icon: 'modern_kitchen_base_counter', desc: '淡蓝拱形柜门连成一排，奶油台面空无一物，方便摆小家电与摆件', unlockRequirement: { level: 25 }, defaultScale: 1.98, decorationPanelTab: 'furniture' },
  { id: 'modern_hotdog_roller', name: '迷你烤肠机', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 26384, starValue: 5, icon: 'modern_hotdog_roller', desc: '透明罩小烤肠机，银色滚轴与面包托盘，可摆在厨柜台面', unlockRequirement: { level: 21 }, defaultScale: 0.92, depthSortFeetYFudge: 130 },
  { id: 'modern_glass_drink_dispenser', name: '玻璃饮料机', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 27671, starValue: 5, icon: 'modern_glass_drink_dispenser', desc: '双缸水果饮料机，柠檬茶与莓果茶清爽并排，适合厨柜台面', unlockRequirement: { level: 21 }, defaultScale: 0.72, depthSortFeetYFudge: 130 },
  { id: 'modern_camping_tent', name: '奶油露营帐篷', slot: DecoSlot.GARDEN, rarity: DecoRarity.RARE, cost: 46383, starValue: 6, icon: 'modern_camping_tent', desc: '奶油帆布小帐篷配串灯与花盆，庭院立刻有露营感', unlockRequirement: { level: 27 }, defaultScale: 1.65, decorationPanelTab: 'garden' },
  { id: 'modern_picnic_cooler_cart', name: '野餐冰桶推车', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 28314, starValue: 5, icon: 'modern_picnic_cooler_cart', desc: '薄荷冰桶小推车，饮料水果与格纹毯准备好出发', unlockRequirement: { level: 22 }, defaultScale: 1.05, decorationPanelTab: 'furniture' },
  { id: 'modern_plush_cloud_pile', name: '毛绒云朵玩具堆', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 43413, starValue: 5, icon: 'modern_plush_cloud_pile', desc: '云朵、兔兔、小熊与柠檬抱枕叠成软乎乎角落', unlockRequirement: { level: 28 }, defaultScale: 0.9 },
  { id: 'modern_wall_fairy_lights', name: '节日星星串灯', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 41185, starValue: 4, icon: 'modern_wall_fairy_lights', desc: '星星月亮小挂灯串，墙面多一点节日暖光', unlockRequirement: { level: 28 }, defaultScale: 1.25 },
  { id: 'modern_tall_flower_vase', name: '高身鲜花陶瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 39155, starValue: 5, icon: 'modern_tall_flower_vase', desc: '高身奶油陶瓶插满郁金香与小雏菊，清新但有体量', unlockRequirement: { level: 28 }, defaultScale: 0.85 },
  { id: 'modern_capsule_drink_fridge', name: '胶囊饮料冰柜', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 12613, starValue: 4, icon: 'modern_capsule_drink_fridge', desc: '圆角胶囊冰柜排满彩色饮品，可摆在厨柜或台面上', unlockRequirement: { level: 22 }, defaultScale: 0.85, depthSortFeetYFudge: 130 },
  { id: 'modern_waffle_snack_cart', name: '华夫点心小车', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 31918, starValue: 6, icon: 'modern_waffle_snack_cart', desc: '暖橙棚顶小车摆着华夫饼、浆果与糖浆瓶', unlockRequirement: { level: 21 }, defaultScale: 1.05, decorationPanelTab: 'furniture' },
  { id: 'modern_robot_vacuum_dock', name: '圆圆扫地机座', slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE, cost: 23265, starValue: 5, icon: 'modern_robot_vacuum_dock', desc: '猫耳扫地机停在充电座旁，店里也要轻松保持整洁', unlockRequirement: { level: 29 }, defaultScale: 0.85 },
  { id: 'modern_balcony_drying_cabinet', name: '暖风烘衣柜', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 37225, starValue: 6, icon: 'modern_balcony_drying_cabinet', desc: '透明小烘衣柜挂着柔色衣物，顶部一盆薰衣草压住生活感', unlockRequirement: { level: 30 }, defaultScale: 1.35 },
  { id: 'modern_plant_grow_light_shelf', name: '植物补光培育架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 28215, starValue: 6, icon: 'modern_plant_grow_light_shelf', desc: '双层植物培育架配粉色补光灯，水培瓶与苗盘井井有条', unlockRequirement: { level: 30 }, defaultScale: 1.65, decorationPanelTab: 'furniture' },
  { id: 'modern_citrus_soda_machine', name: '柑橘气泡饮料机', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 36036, starValue: 6, icon: 'modern_citrus_soda_machine', desc: '橙黄色气泡饮料机，玻璃缸里冒着柑橘泡泡，适合厨柜台面', unlockRequirement: { level: 22 }, defaultScale: 0.72, depthSortFeetYFudge: 130 },
  { id: 'modern_pegboard_hobby_wall', name: '软木洞洞板', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 13500, starValue: 7, icon: 'modern_pegboard_hobby_wall', desc: '粉色洞洞板收纳丝带、剪刀、小花瓶与便签色块', unlockRequirement: { level: 31 }, defaultScale: 0.9 },
  { id: 'modern_countertop_icecream_machine', name: '软冰淇淋机', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 40541, starValue: 7, icon: 'modern_countertop_icecream_machine', desc: '薄荷奶油色冰淇淋机，两个小甜筒刚好接住软雪糕，适合厨柜台面', unlockRequirement: { level: 24 }, defaultScale: 0.72, depthSortFeetYFudge: 130 },
  { id: 'modern_aquarium_side_table', name: '水族小边桌', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 40150, starValue: 9, icon: 'modern_aquarium_side_table', desc: '圆鼓水族箱托起小边桌，鱼儿与水草在桌下发光', unlockRequirement: { level: 33 }, defaultScale: 0.9, decorationPanelTab: 'furniture' },
  { id: 'modern_plush_display_ladder', name: '毛绒梯形陈列架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 30300, starValue: 8, icon: 'modern_plush_display_ladder', desc: '梯形木架陈列云朵、小熊与花朵毛绒，边上还绕着细灯', unlockRequirement: { level: 33 }, defaultScale: 1.2, decorationPanelTab: 'furniture' },
  { id: 'modern_patio_swing_sofa', name: '露台吊椅沙发', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 54200, starValue: 10, icon: 'modern_patio_swing_sofa', desc: '奶油金属架吊起珊瑚软垫双人椅，花藤把露台变成小假日', unlockRequirement: { level: 35 }, defaultScale: 1.65, decorationPanelTab: 'furniture' },
  { id: 'modern_plush_capybara', name: '卡皮玩偶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 36000, starValue: 6, icon: 'modern_plush_capybara', desc: '圆滚滚卡皮巴拉毛绒，头顶还平衡着一片小橙片，懒萌到犯规', unlockRequirement: { level: 35 }, defaultScale: 0.75 },
  { id: 'modern_plush_clownfish', name: '小丑鱼玩偶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 39999, starValue: 6, icon: 'modern_plush_clownfish', desc: '橙白条纹小丑鱼毛绒，圆眼睛与短鳍摇摇晃晃，像从水族箱跳出来的', unlockRequirement: { level: 36 }, defaultScale: 0.7 },
  { id: 'modern_plush_tree_spirit', name: '树人玩偶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 30000, starValue: 7, icon: 'modern_plush_tree_spirit', desc: '苔藓绿小树人毛绒，叶子头发与胸前花苞，森林精灵也软乎乎', unlockRequirement: { level: 37 }, defaultScale: 0.75 },

  // ═══════ ⑭.4b 海蓝慵懒夏日 Lv38–45（参考地中海阳台蓝系软装）
  { id: 'azure_lazy_wicker_loveseat', name: '海蓝藤编双人沙发', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 49520, starValue: 6, icon: 'azure_lazy_wicker_loveseat', desc: '浅藤编低沙发配天蓝坐垫，星图毯与柠檬片抱枕，慵懒午后标配', unlockRequirement: { level: 38 }, defaultScale: 1.35, decorationPanelTab: 'furniture' },
  { id: 'azure_lazy_wicker_armchair', name: '海蓝藤编单椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 40520, starValue: 6, icon: 'azure_lazy_wicker_armchair', desc: '圆角藤编单椅搭粉蓝猫脸抱枕，一个人也能窝着发呆', unlockRequirement: { level: 39 }, defaultScale: 1.05, decorationPanelTab: 'furniture' },
  { id: 'azure_lazy_ladder_towel_rack', name: '海蓝梯式毛巾架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 31880, starValue: 5, icon: 'azure_lazy_ladder_towel_rack', desc: '天蓝木梯挂着柔色毛巾与海星小挂饰，像迷你阳台角落', unlockRequirement: { level: 40 }, defaultScale: 1.3, decorationPanelTab: 'furniture' },
  { id: 'azure_lazy_glass_shell_table', name: '玻璃海星小边桌', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 42140, starValue: 7, icon: 'azure_lazy_glass_shell_table', desc: '透明玻璃圆缸边桌，水底贝壳与海星轻轻晃，清凉又有趣', unlockRequirement: { level: 41 }, defaultScale: 0.85, decorationPanelTab: 'furniture' },
  { id: 'azure_lazy_star_border_rug', name: '星纹蓝海地毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 30620, starValue: 5, icon: 'azure_lazy_star_border_rug', desc: '牛仔蓝长毯配奶油星纹边与流苏，光脚踩上去就慢下来', unlockRequirement: { level: 42 }, defaultScale: 2.05, depthSortYLift: 0, depthSortFloorMat: true, decorationPanelTab: 'furniture' },
  { id: 'azure_lazy_barrel_stool', name: '木纹海蓝圆凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 29450, starValue: 5, icon: 'azure_lazy_barrel_stool', desc: '短木桶造型圆凳，浅木条与蔚蓝环带，随手一放就是座位', unlockRequirement: { level: 43 }, defaultScale: 0.55, decorationPanelTab: 'furniture' },
  { id: 'azure_lazy_star_lantern_string', name: '星月蓝串灯', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 33140, starValue: 6, icon: 'azure_lazy_star_lantern_string', desc: '星形与圆球串灯暖黄点亮，把夏夜阳台挂成小小银河', unlockRequirement: { level: 44 }, defaultScale: 1.5 },
  { id: 'azure_lazy_lemon_tree_pot', name: '柠檬蓝海花盆', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 36650, starValue: 7, icon: 'azure_lazy_lemon_tree_pot', desc: '蔚蓝陶盆种着小柠檬树，黄果实与绿叶把夏天留在店里', unlockRequirement: { level: 45 }, defaultScale: 1.15, decorationPanelTab: 'furniture' },

  // ═══════ ⑭.4c 慵懒客厅 Lv41–43（豆袋沙发 · 大提琴）
  { id: 'modern_lazy_bean_bag_coral', name: '珊瑚懒人豆袋', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 49520, starValue: 6, icon: 'modern_lazy_bean_bag_coral', desc: '南瓜分段珊瑚粉豆袋，顶上有小提环，一屁股陷进去就不想起来', unlockRequirement: { level: 41 }, defaultScale: 1.08, decorationPanelTab: 'furniture' },
  { id: 'azure_lazy_bean_bag', name: '海蓝懒人豆袋', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 50420, starValue: 6, icon: 'azure_lazy_bean_bag', desc: '同款豆袋换成天蓝面料，软乎乎像一朵云，适合窝着看投影', unlockRequirement: { level: 42 }, defaultScale: 1.08, decorationPanelTab: 'furniture' },
  { id: 'modern_floor_cello', name: '立式大提琴', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 51320, starValue: 7, icon: 'modern_floor_cello', desc: '蜂蜜色木身大提琴斜靠而立，四弦与琴头卷纹把客厅变成小音乐厅', unlockRequirement: { level: 43 }, defaultScale: 1.25, decorationPanelTab: 'furniture' },

  // ═══════ ⑭.5 茶香小院专属家具（tea_house Lv25 解锁；decorationPanelTab=flower_room → 左侧「茶香小院」Tab）
  { id: 'gucha_tea_bench', name: '茶寮长凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 4862, starValue: 1, icon: 'gucha_tea_bench', desc: '素木长凳磨得发亮，台面留着一圈茶渍印', unlockRequirement: { level: 25 }, defaultScale: 1.1, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'jiangnan_lattice_window', name: '花窗栏', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 14014, starValue: 5, icon: 'jiangnan_lattice_window', desc: '冰裂纹花窗格，淡蓝天空映在磨砂玻璃上', unlockRequirement: { level: 25 }, defaultScale: 1.28, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'gucha_water_jar', name: '陶瓮水缸', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 13156, starValue: 4, icon: 'gucha_water_jar', desc: '粗陶大水瓮配竹勺，茶寮取水必备', unlockRequirement: { level: 25 }, defaultScale: 0.82, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'gucha_charcoal_brazier', name: '竹风炉', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 26830, starValue: 5, icon: 'gucha_charcoal_brazier', desc: '竹编风炉炭火微红，陶壶上袅袅茶烟', unlockRequirement: { level: 26 }, defaultScale: 0.88, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'jiangnan_rattan_daybed', name: '藤枕榻', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 31120, starValue: 7, icon: 'jiangnan_rattan_daybed', desc: '竹框卧榻配靛蓝垫与青花枕，午后小憩位', unlockRequirement: { level: 26 }, defaultScale: 1.55, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'gucha_tea_boat', name: '茶则舟', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 27820, starValue: 5, icon: 'gucha_tea_boat', desc: '竹茶船托盘上摆着盖碗与公道杯', unlockRequirement: { level: 27 }, defaultScale: 1.05, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'jiangnan_willow_cart', name: '柳编花车', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 31000, starValue: 6, icon: 'jiangnan_willow_cart', desc: '柳编小车木轮，桶里盛着牡丹与荷花', unlockRequirement: { level: 27 }, defaultScale: 1.22, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'gucha_tea_chest', name: '封箱茶仓', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 19470, starValue: 6, icon: 'gucha_tea_chest', desc: '双层木架堆着蜡封茶砖与纸包', unlockRequirement: { level: 28 }, defaultScale: 1.35, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'xianxia_herb_rack', name: '悬索晒药架', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 28975, starValue: 6, icon: 'xianxia_herb_rack', desc: '竹架悬着干花束与草药纸包，茶香伴药香', unlockRequirement: { level: 28 }, defaultScale: 1.68, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'jiangnan_blue_cabinet', name: '青花博古柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 34520, starValue: 7, icon: 'jiangnan_blue_cabinet', desc: '红木博古架陈列青花瓶盏与折扇', unlockRequirement: { level: 29 }, defaultScale: 1.65, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'xianxia_meditation_platform', name: '蒲团云台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 21880, starValue: 5, icon: 'xianxia_meditation_platform', desc: '云纹矮台配草编蒲团，抹茶粉与小花点缀', unlockRequirement: { level: 30 }, defaultScale: 1.12, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },

  // ═══════ ⑭.6 橡树小屋专属家具（forest_treehouse Lv35–38 · 航海奇遇套）
  { id: 'sea_wheel_wall', name: '舵轮墙挂', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 14000, starValue: 6, icon: 'sea_wheel_wall', desc: '旧木舵轮悬在麻绳上，黄铜毂心闪着冒险光泽', unlockRequirement: { level: 35 }, defaultScale: 0.92, decorationPanelTab: 'flower_room', allowedSceneIds: ['forest_treehouse'] },
  { id: 'sea_anchor_bench', name: '船锚绳凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 34200, starValue: 6, icon: 'sea_anchor_bench', desc: '锈色船锚作靠背，麻绳缠腿托着木纹坐板', unlockRequirement: { level: 36 }, defaultScale: 1.28, decorationPanelTab: 'flower_room', allowedSceneIds: ['forest_treehouse'] },
  { id: 'sea_treasure_chest', name: '珍珠藏箱', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 34800, starValue: 7, icon: 'sea_treasure_chest', desc: '橡木宝箱半开，珍珠珊瑚与黄铜罗盘满溢而出', unlockRequirement: { level: 37 }, defaultScale: 1.02, decorationPanelTab: 'flower_room', allowedSceneIds: ['forest_treehouse'] },
  { id: 'sea_coral_cabinet', name: '珊瑚展柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 35500, starValue: 7, icon: 'sea_coral_cabinet', desc: '拱顶玻璃木柜，粉珊瑚与贝壳分层陈列', unlockRequirement: { level: 38 }, defaultScale: 1.58, decorationPanelTab: 'flower_room', allowedSceneIds: ['forest_treehouse'] },

  // ═══════ ⑭.7 梦云小屋专属家具（dream_cloud_house Lv20–24 · 梦幻卧室休闲套）
  { id: 'dream_cloud_bed', name: '月云大软床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 65000, starValue: 8, icon: 'dream_cloud_bed', desc: '云朵床框托起浅紫绗缝被，月亮与星星抱枕软乎乎地窝在床头', unlockRequirement: { level: 20 }, defaultScale: 1.95, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },
  { id: 'dream_cloud_sofa', name: '星月转角沙发', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 54600, starValue: 8, icon: 'dream_cloud_sofa', desc: '奶油白大转角沙发配粉紫蓝抱枕，像睡前云朵客厅一样柔软', unlockRequirement: { level: 20 }, defaultScale: 2.18, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },
  { id: 'dream_cloud_star_rug', name: '星云软绒地毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 24440, starValue: 6, icon: 'dream_cloud_star_rug', desc: '浅蓝星云绒毯铺在月石地面上，轻柔星光像云雾一样散开', unlockRequirement: { level: 21 }, defaultScale: 1.65, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'], depthSortYLift: 0, depthSortFloorMat: true },
  { id: 'dream_cloud_moon_nightstand', name: '月灯床头柜', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 25480, starValue: 6, icon: 'dream_cloud_moon_nightstand', desc: '小云柜托着暖黄色月牙夜灯，星星抽屉把手带来睡前微光', unlockRequirement: { level: 21 }, defaultScale: 1.15, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },
  { id: 'dream_cloud_star_vanity', name: '星镜梳妆台', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 41340, starValue: 7, icon: 'dream_cloud_star_vanity', desc: '粉紫梳妆台配星形镜框和月金描边，适合摆在梦云卧室一角', unlockRequirement: { level: 22 }, defaultScale: 1.48, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },
  { id: 'dream_cloud_tea_table', name: '薄荷云茶几', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 27040, starValue: 6, icon: 'dream_cloud_tea_table', desc: '薄荷蓝圆茶几踩着云朵小脚，月金边框和小茶具让休闲角更温柔', unlockRequirement: { level: 22 }, defaultScale: 1.24, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },
  { id: 'dream_cloud_bookshelf', name: '浮云星书架', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 28340, starValue: 6, icon: 'dream_cloud_bookshelf', desc: '漂浮云朵书架摆着彩色睡前书和水晶月球，下方垂着小星星', unlockRequirement: { level: 23 }, defaultScale: 1.32, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },
  { id: 'dream_cloud_crescent_cushion', name: '月牙懒人坐垫', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 29640, starValue: 6, icon: 'dream_cloud_crescent_cushion', desc: '金黄月牙抱着软垫和星星靠枕，是二楼休闲角的梦境座位', unlockRequirement: { level: 23 }, defaultScale: 1.18, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },
  { id: 'dream_cloud_floor_lamp', name: '星梦落地灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE, cost: 22750, starValue: 6, icon: 'dream_cloud_floor_lamp', desc: '云朵底座托起细高灯杆，月星灯罩洒下温暖睡前光', unlockRequirement: { level: 24 }, defaultScale: 1.28, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },
  { id: 'dream_cloud_storage_chest', name: '梦境收纳箱', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 25740, starValue: 6, icon: 'dream_cloud_storage_chest', desc: '奶油云朵箱身配浅紫箱盖，月牙锁扣收藏睡前小秘密', unlockRequirement: { level: 24 }, defaultScale: 0.98, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },

  // ═══════ ⑭.8 花田农舍专属家具（flower_farm_house Lv30–34 · 拾光田园套 v2）
  { id: 'farm_vegetable_patch_rug', name: '青畦菜毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 28200, starValue: 6, icon: 'farm_vegetable_patch_rug', desc: '四格小菜畦：卷心菜、小葱、辣椒与胡萝卜，整齐又鲜活', unlockRequirement: { level: 30 }, defaultScale: 2.8, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_farm_house'], depthSortYLift: 0, depthSortFloorMat: true },
  { id: 'farm_garden_tool_stand', name: '农具木架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 20090, starValue: 4, icon: 'farm_garden_tool_stand', desc: '一字木架插着铁铲、手镰与锄头，收工好帮手', unlockRequirement: { level: 30 }, defaultScale: 1.45, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_farm_house'] },
  { id: 'farm_fruit_crate_stack', name: '丰收果筐堆', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 31400, starValue: 6, icon: 'farm_fruit_crate_stack', desc: '三层木筐堆叠，果蔬收成从箱缝满溢出来', unlockRequirement: { level: 31 }, defaultScale: 1.22, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_farm_house'] },
  { id: 'farm_scarecrow', name: '稻草守卫', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 31086, starValue: 6, icon: 'farm_scarecrow', desc: '草帽碎花围巾的软萌稻草人，默默守住院落', unlockRequirement: { level: 31 }, defaultScale: 1.35, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_farm_house'] },
  { id: 'farm_hen_coop', name: '暖巢鸡舍', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 29800, starValue: 7, icon: 'farm_hen_coop', desc: '小木鸡舍里窝着两只圆滚滚的白鸡，静态观景点', unlockRequirement: { level: 32 }, defaultScale: 1.78, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_farm_house'] },
  { id: 'farm_melon_trellis', name: '蜜瓜藤架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 30600, starValue: 6, icon: 'farm_melon_trellis', desc: '木架垂挂圆滚滚蜜瓜，架下连着一小片土畦', unlockRequirement: { level: 32 }, defaultScale: 2.72, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_farm_house'] },
  { id: 'farm_hay_bench', name: '干草长凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 12400, starValue: 3, icon: 'farm_hay_bench', desc: '木框长凳配干草垫，午后歇脚看菜畦', unlockRequirement: { level: 33 }, defaultScale: 1.12, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_farm_house'] },
  { id: 'farm_beehive_stand', name: '蜜意蜂箱', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 27200, starValue: 6, icon: 'farm_beehive_stand', desc: '木架托着草编蜂箱，两三只小蜜蜂停在巢口', unlockRequirement: { level: 33 }, defaultScale: 1.38, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_farm_house'] },
  { id: 'farm_fu_sticker_wall', name: '福字贴纸', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 33800, starValue: 7, icon: 'farm_fu_sticker_wall', desc: '菱形大红福字贴纸，贴在院墙添年味', unlockRequirement: { level: 34 }, defaultScale: 0.92, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_farm_house'] },
  { id: 'farm_ivy_wall', name: '满墙爬山虎', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 38900, starValue: 7, icon: 'farm_ivy_wall', desc: '鲜绿爬山虎从墙脚爬满大半墙面，春意盎然', unlockRequirement: { level: 34 }, defaultScale: 2.08, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_farm_house'] },

  // ═══════ ⑭.9 拾光田园通用件（全场景 · Lv30–31）
  { id: 'farm_rocking_chair', name: '竹木摇椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 29400, starValue: 6, icon: 'farm_rocking_chair', desc: '蜂蜜色木条摇椅，摇啊摇晒太阳', unlockRequirement: { level: 30 }, defaultScale: 1.15, decorationPanelTab: 'furniture' },
  { id: 'farm_picket_fence_wall', name: '木栅栏', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 31800, starValue: 6, icon: 'farm_picket_fence_wall', desc: '栅格木栏缠绿藤紫葡萄，院边小花架', unlockRequirement: { level: 31 }, defaultScale: 1.68, decorationPanelTab: 'garden' },

  // ═══════ ⑮ 古风/民俗/奇匠扩展 Lv30–35（batch51 · 全场景通用 · 售价高于 Lv21–30 档）
  { id: 'ancient_brush_mountain', name: '笔架山', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 36280, starValue: 5, icon: 'ancient_brush_mountain', desc: '青玉笔山插着数支毛笔，案头文房小景', unlockRequirement: { level: 30 }, defaultScale: 0.55 },
  { id: 'ancient_inkstone_desk', name: '砚台书案', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 41705, starValue: 6, icon: 'ancient_inkstone_desk', desc: '红木矮案嵌砚台，青瓷水盂与笔搁一字排开', unlockRequirement: { level: 29 }, defaultScale: 1.2 },
  { id: 'ancient_scroll_rack', name: '经卷竹架', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 36720, starValue: 6, icon: 'ancient_scroll_rack', desc: '竹架三层悬着红绳束口的素卷', unlockRequirement: { level: 30 }, defaultScale: 1.5 },
  { id: 'ancient_dressing_case', name: '梳妆奁台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 36800, starValue: 7, icon: 'ancient_dressing_case', desc: '黑漆妆台配三折铜镜，玉簪盒与珠串小碟', unlockRequirement: { level: 31 }, defaultScale: 1.35 },
  { id: 'folk_kite_wall', name: '沙燕风筝墙', slot: DecoSlot.WALLART, rarity: DecoRarity.COMMON, cost: 35800, starValue: 6, icon: 'folk_kite_wall', desc: '竹框上挂着红青三只沙燕风筝，民俗墙饰', unlockRequirement: { level: 31 }, defaultScale: 0.95 },
  { id: 'folk_lion_head_stand', name: '醒狮头架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 60000, starValue: 7, icon: 'folk_lion_head_stand', desc: '金红醒狮头立在木架上，绒边大眼喜气洋洋', unlockRequirement: { level: 31 }, defaultScale: 0.85 },
  { id: 'ancient_landscape_screen', name: '山水屏风', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 37500, starValue: 7, icon: 'ancient_landscape_screen', desc: '四扇乌木框绢屏，水墨山水层峦叠瀑', unlockRequirement: { level: 32 }, defaultScale: 1.82 },
  { id: 'folk_dragon_bench', name: '龙纹长凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 10000, starValue: 11, icon: 'folk_dragon_bench', desc: '朱漆长凳龙脊靠背，金黄坐垫缀红穗', unlockRequirement: { level: 32 }, defaultScale: 1.75, decorationPanelTab: 'furniture' },
  { id: 'ancient_master_chair', name: '太师椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 38200, starValue: 8, icon: 'ancient_master_chair', desc: '深木官帽椅，靠背雕龙纹，正襟危坐位', unlockRequirement: { level: 33 }, defaultScale: 1.1, decorationPanelTab: 'furniture' },
  { id: 'ancient_bronze_ding', name: '三足鼎案', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 39200, starValue: 9, icon: 'ancient_bronze_ding', desc: '青铜三足鼎立于红木案，云纹绿锈古意盎然', unlockRequirement: { level: 33 }, defaultScale: 0.78 },
  { id: 'ancient_phoenix_rug', name: '凤纹地毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 90000, starValue: 9, icon: 'ancient_phoenix_rug', desc: '绛红织毯金线凤纹，青绿镶边铺地显贵', unlockRequirement: { level: 33 }, defaultScale: 1.65, depthSortYLift: 0, depthSortFloorMat: true },
  { id: 'ancient_jade_bi_stand', name: '礼璧展架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 41500, starValue: 10, icon: 'ancient_jade_bi_stand', desc: '乌木小案托着青玉礼璧，红绸垫承古器', unlockRequirement: { level: 34 }, defaultScale: 0.9 },
  { id: 'whimsy_geode_table', name: '晶洞茶几', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 40500, starValue: 9, icon: 'whimsy_geode_table', desc: '紫晶洞切片台面闪微光，铁架承住矿物奇观', unlockRequirement: { level: 34 }, defaultScale: 0.95 },
  { id: 'folk_pole_lantern', name: '灯杆宫灯', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 42800, starValue: 10, icon: 'folk_pole_lantern', desc: '木杆挑着朱红宫灯，石座稳立庭院夜宴', unlockRequirement: { level: 35 }, defaultScale: 1.8 },
  { id: 'ancient_stone_lantern', name: '石灯笼', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 41800, starValue: 9, icon: 'ancient_stone_lantern', desc: '花岗石灯笼四层塔身，灯室暖黄静立庭径', unlockRequirement: { level: 35 }, defaultScale: 1.0 },
  ...
  { id: 'cake_shelf_layered_display',     name: '分层蛋糕展示柜', slot: DecoSlot.SHELF,    rarity: DecoRarity.LIMITED, cost: 9300, starValue: 11, icon: 'cake_shelf_layered_display',     desc: '蜜木+黄铜玻璃三层柜，奶油蛋糕与马卡龙的招牌门面', unlockRequirement: { level: 16 }, defaultScale: 1.5,  decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_shelf_baking_pantry',       name: '烘焙原料架',     slot: DecoSlot.SHELF,    rarity: DecoRarity.FINE,    cost: 5000, starValue: 5,  icon: 'cake_shelf_baking_pantry',       desc: '蜜木双层架配奶油盖玻璃罐：面粉、糖、可可与彩糖', unlockRequirement: { level: 15 }, defaultScale: 1.25, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_shelf_chilled_cabinet',     name: '草莓冷藏甜品柜', slot: DecoSlot.SHELF,    rarity: DecoRarity.RARE,    cost: 8100, starValue: 8,  icon: 'cake_shelf_chilled_cabinet',     desc: '粉色立柜玻璃门内排着马卡龙慕斯与小蛋糕', unlockRequirement: { level: 17 }, defaultScale: 1.18, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_shelf_fondant_flowers',     name: '翻糖花展示架',   slot: DecoSlot.SHELF,    rarity: DecoRarity.FINE,    cost: 7500, starValue: 6,  icon: 'cake_shelf_fondant_flowers',     desc: '奶白杆配三层圆台，摆着多彩翻糖花与糖珠', unlockRequirement: { level: 16 }, defaultScale: 1.05, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_table_workstation',         name: '甜品制作工作台', slot: DecoSlot.TABLE,    rarity: DecoRarity.FINE,    cost: 5200, starValue: 6,  icon: 'cake_table_workstation',         desc: '蜜木大理石台，搅拌钵、挤花袋与翻糖小球一字排开', unlockRequirement: { level: 15 }, defaultScale: 1.30, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_table_register_counter',    name: '蛋糕收银台',     slot: DecoSlot.TABLE,    rarity: DecoRarity.RARE,    cost: 7950, starValue: 8,  icon: 'cake_table_register_counter',    desc: '草莓粉柜身配大理石面，复古收银机与玻璃钟罩马卡龙', unlockRequirement: { level: 16 }, defaultScale: 1.30, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_table_round_dessert',       name: '甜品分享小圆桌', slot: DecoSlot.TABLE,    rarity: DecoRarity.COMMON,  cost: 5000,  starValue: 3,  icon: 'cake_table_round_dessert',       desc: '奶白扇贝边圆桌，两份小蛋糕与单枝粉玫瑰', unlockRequirement: { level: 15 }, defaultScale: 1.05, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_table_gift_wrap',           name: '礼盒打包台',     slot: DecoSlot.TABLE,    rarity: DecoRarity.FINE,    cost: 7500, starValue: 6,  icon: 'cake_table_gift_wrap',           desc: '蜜木台面背靠多色缎带卷，奶油礼盒与黄铜剪刀', unlockRequirement: { level: 17 }, defaultScale: 1.18, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_table_dessert_island',      name: '甜点中岛长桌',   slot: DecoSlot.TABLE,    rarity: DecoRarity.RARE,    cost: 8550, starValue: 9,  icon: 'cake_table_dessert_island',      desc: '奶白长桌带粉色糖霜流挂，香槟金腿与一排小甜点', unlockRequirement: { level: 18 }, defaultScale: 1.40, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_light_pink_double_oven',    name: '草莓双门烤箱',   slot: DecoSlot.LIGHT,    rarity: DecoRarity.RARE,    cost: 8850, starValue: 10, icon: 'cake_light_pink_double_oven',    desc: '草莓粉立式双门烤箱，门内可见烤盘里的小蛋糕', unlockRequirement: { level: 16 }, defaultScale: 1.30, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_light_stand_mixer',         name: '粉色立式搅拌机', slot: DecoSlot.LIGHT,    rarity: DecoRarity.FINE,    cost: 5600, starValue: 5,  icon: 'cake_light_stand_mixer',         desc: '复古粉立式搅拌机，搅拌缸里堆着奶油尖', unlockRequirement: { level: 15 }, defaultScale: 0.65, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_light_pendant_macaron',     name: '马卡龙塔灯',     slot: DecoSlot.LIGHT,    rarity: DecoRarity.FINE,    cost: 7500, starValue: 6,  icon: 'cake_light_pendant_macaron',     desc: '奶白圆底盘配黄铜立柱，三层粉绿黄马卡龙灯罩柔光发亮', unlockRequirement: { level: 17 }, defaultScale: 1.25, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_light_chocolate_fountain',  name: '巧克力喷泉机',   slot: DecoSlot.LIGHT,    rarity: DecoRarity.RARE,    cost: 8100, starValue: 8,  icon: 'cake_light_chocolate_fountain',  desc: '黄铜螺旋柱与双层流挂巧克力，旁配草莓串与棉花糖', unlockRequirement: { level: 18 }, defaultScale: 0.95, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_orn_strawberry_stool_pair', name: '草莓坐墩组',     slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE,    cost: 5200, starValue: 4,  icon: 'cake_orn_strawberry_stool_pair', desc: '一红一粉两只草莓造型小坐墩，绿叶萼配奶白细腿', unlockRequirement: { level: 15 }, defaultScale: 0.85, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_orn_wedding_cake_centerpiece', name: '婚礼蛋糕台',  slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 17160, starValue: 18, icon: 'cake_orn_wedding_cake_centerpiece', desc: '三层奶白翻糖蛋糕配粉玫瑰与糖珠，瓷台金边', unlockRequirement: { level: 20 }, defaultScale: 1.10, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_orn_donut_cushion_pair',    name: '甜甜圈坐垫组',   slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON,  cost: 7500,  starValue: 3,  icon: 'cake_orn_donut_cushion_pair',    desc: '一大一小甜甜圈造型软垫，粉糖霜与巧克力两味', unlockRequirement: { level: 16 }, defaultScale: 1.00, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_orn_teddy_baker',           name: '烘焙小熊摆件',   slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE,    cost: 7500, starValue: 5,  icon: 'cake_orn_teddy_baker',           desc: '焦糖蜜熊戴厨师帽抱奶油碗，店铺萌系吉祥物', unlockRequirement: { level: 17 }, defaultScale: 0.85, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_wallart_menu_chalkboard',   name: '蛋糕菜单黑板',   slot: DecoSlot.WALLART,  rarity: DecoRarity.FINE,    cost: 5200, starValue: 4,  icon: 'cake_wallart_menu_chalkboard',   desc: '奶粉扇贝木框配森林绿黑板，粉笔画蛋糕剪影与缎带', unlockRequirement: { level: 15 }, defaultScale: 1.20, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_wallart_lollipop_clock',    name: '棒棒糖挂钟',     slot: DecoSlot.WALLART,  rarity: DecoRarity.FINE,    cost: 7500, starValue: 5,  icon: 'cake_wallart_lollipop_clock',    desc: '粉绿白糖纹圆盘配奶白糖棒，黄铜指针无数字', unlockRequirement: { level: 16 }, defaultScale: 0.95, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_garden_strawberry_arch',    name: '草莓藤拱门',     slot: DecoSlot.GARDEN,   rarity: DecoRarity.LIMITED, cost: 11700, starValue: 14, icon: 'cake_garden_strawberry_arch',    desc: '奶白拱门缠满草莓藤与白花，门下两盆小草莓', unlockRequirement: { level: 17 }, defaultScale: 2.00, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  ...
  { id: 'qinglian_scholar_rock', name: '粉晶山石', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 10870, starValue: 4, icon: 'qinglian_scholar_rock', desc: '粉晶玲珑石与祥云木座，案头清供', unlockRequirement: { level: 6 }, defaultScale: 1.25, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_guqin_stand', name: '古琴雅案', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 15030, starValue: 4, icon: 'qinglian_guqin_stand', desc: '古琴案几配云纹屏风，紫绿渐变琴身', unlockRequirement: { level: 7 }, defaultScale: 1.4, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_bamboo_window', name: '冰纹花窗', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 10400, starValue: 4, icon: 'qinglian_bamboo_window', desc: '八角冰裂纹花窗，框外淡竹与飞燕剪影', unlockRequirement: { level: 8 }, defaultScale: 1.30, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_wisteria_vanity', name: '紫藤绢屏梳妆台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 13000, starValue: 5, icon: 'qinglian_wisteria_vanity', desc: '浅木梳妆台配三扇紫藤绢屏，仙闺氛围', unlockRequirement: { level: 9 }, defaultScale: 1.55, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_cloud_book_desk', name: '祥云书案', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 11700, starValue: 4, icon: 'qinglian_cloud_book_desk', desc: '浅木书案配祥云腿雕，青瓷笔架与素卷', unlockRequirement: { level: 10 }, defaultScale: 1.30, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_moon_shelf', name: '月洞博古架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 14300, starValue: 6, icon: 'qinglian_moon_shelf', desc: '月洞门博古架，格内青瓷与粉牡丹小品', unlockRequirement: { level: 11 }, defaultScale: 1.85, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_peony_screen', name: '牡丹圆光屏风', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 15600, starValue: 6, icon: 'qinglian_peony_screen', desc: '三扇绢屏绘牡丹百合，圆光淡粉边', unlockRequirement: { level: 12 }, defaultScale: 2.02, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_cherry_wardrobe', name: '樱霞轻衣柜', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 26000, starValue: 5, icon: 'qinglian_cherry_wardrobe', desc: '奶油木衣柜配樱花板面，祥云形淡金拉手', unlockRequirement: { level: 13 }, defaultScale: 1.75, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_silk_daybed', name: '流纱罗汉榻', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 41600, starValue: 7, icon: 'qinglian_silk_daybed', desc: '浅木罗汉榻配薄荷珊瑚丝垫，流纱轻垂', unlockRequirement: { level: 14 }, defaultScale: 1.75, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_lotus_canopy_bed', name: '莲纱架子床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 57200, starValue: 8, icon: 'qinglian_lotus_canopy_bed', desc: '四柱架子床垂桃荷纱幔，莲纹床帏如梦', unlockRequirement: { level: 15 }, defaultScale: 2.5, decorationPanelTab: 'qinglian' },
