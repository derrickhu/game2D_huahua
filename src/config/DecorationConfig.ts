...
export const DECO_DEFS: DecoDef[] = [
  ...
  { id: 'villa_dining_chair_pair', name: '高背丝绒餐椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 41200, starValue: 6, icon: 'villa_dining_chair_pair', desc: '豆沙高背丝绒餐椅，金钉滚边，一把就撑起餐桌仪式感', unlockRequirement: { level: 36 }, defaultScale: 1.22, decorationPanelTab: 'furniture' },
