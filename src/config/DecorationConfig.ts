...
export const DECO_DEFS: DecoDef[] = [
  ...
  { id: 'deco_lv17_shelf_surfboard', name: '冲浪板花架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 6200, starValue: 10, icon: 'deco_lv17_shelf_surfboard', desc: '旧冲浪板改成竖向花架，薄荷蓝与珊瑚花盆呼应海滨套', unlockRequirement: { level: 17 }, defaultScale: 1.55, decorationPanelTab: 'garden' },
  { id: 'deco_lv17_table_terrace_bar', name: '露台折叠吧台', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 7200, starValue: 7, icon: 'deco_lv17_table_terrace_bar', desc: '浅柚木折叠吧台配冰饮托盘，适合海边露台角落', unlockRequirement: { level: 17 }, defaultScale: 1.22, decorationPanelTab: 'furniture' },
  { id: 'deco_lv17_orn_seabreeze_rug', name: '海风圆地毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 5000, starValue: 5, icon: 'deco_lv17_orn_seabreeze_rug', desc: '厚织物圆地毯，抬高软包边与流苏让休闲区更像坐垫', unlockRequirement: { level: 17 }, defaultScale: 1.22, depthSortFloorMat: true, decorationPanelTab: 'furniture' },
  { id: 'deco_lv18_shelf_moon_glasshouse', name: '月光玻璃温室柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 7200, starValue: 7, icon: 'deco_lv18_shelf_moon_glasshouse', desc: '香槟金玻璃小温室，月光蓝蝶影与水晶花盆陈列其中', unlockRequirement: { level: 18 }, defaultScale: 1.3, decorationPanelTab: 'furniture' },
  { id: 'deco_lv18_light_firefly_lamp', name: '星萤庭院灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 5800, starValue: 9, icon: 'deco_lv18_light_firefly_lamp', desc: '月蓝玻璃灯罩里闪着星萤光点，适合蝶屋夜色', unlockRequirement: { level: 18 }, defaultScale: 1.35 },
  { id: 'deco_lv18_garden_butterfly_arch', name: '蝶翼月光拱门', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 8600, starValue: 8, icon: 'deco_lv18_garden_butterfly_arch', desc: '香槟金拱门展开半透明蝶翼，月光蓝水晶点亮庭院入口', unlockRequirement: { level: 18 }, defaultScale: 2.02, decorationPanelTab: 'garden' },
  { id: 'deco_lv19_wall_crystal_specimen', name: '水晶标本墙', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 6600, starValue: 11, icon: 'deco_lv19_wall_crystal_specimen', desc: '香槟金展示框里封存蝶翼水晶与干花标本，精致但无文字', unlockRequirement: { level: 19 }, defaultScale: 0.78 },
  { id: 'deco_lv19_orn_crescent_chaise', name: '月牙贵妃榻', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 7800, starValue: 7, icon: 'deco_lv19_orn_crescent_chaise', desc: '月牙形软榻配淡紫丝绒靠垫，适合高级休息角', unlockRequirement: { level: 19 }, defaultScale: 1.18, decorationPanelTab: 'furniture' },
  { id: 'deco_lv19_table_stardust_aroma', name: '星砂香氛台', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 6000, starValue: 9, icon: 'deco_lv19_table_stardust_aroma', desc: '圆角香氛小台摆着星砂玻璃瓶、月白托盘与迷你花束', unlockRequirement: { level: 19 }, defaultScale: 0.98, decorationPanelTab: 'furniture' },
  ...
  { id: 'deco_lv20_shelf_star_observatory', name: '星月观景陈列柜', slot: DecoSlot.SHELF, rarity: DecoRarity.LIMITED, cost: 9200, starValue: 9, icon: 'deco_lv20_shelf_star_observatory', desc: '小型观景台式陈列柜，玻璃穹顶里摆着星月花器', unlockRequirement: { level: 20 }, defaultScale: 1.32, decorationPanelTab: 'furniture' },
  { id: 'deco_lv20_wall_moon_sheer_curtain', name: '月纱蝶影帘', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 7300, starValue: 13, icon: 'deco_lv20_wall_moon_sheer_curtain', desc: '挂墙半透明月光纱帘，香槟金帘杆与蝶影坠饰让墙面更轻盈', unlockRequirement: { level: 20 }, defaultScale: 1.8 },
  ...
  { id: 'deco_lv16_table_globe_writing_desk', name: '地球仪写字桌', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 6000, starValue: 9, icon: 'deco_lv16_table_globe_writing_desk', desc: '小巧胡桃木书桌，黄铜浑天仪、羽毛笔与压花玻璃罩', unlockRequirement: { level: 16 }, defaultScale: 1.08, decorationPanelTab: 'furniture' },
  { id: 'deco_lv17_orn_chesterfield_armchair', name: '切斯特皮扶手椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 6500, starValue: 6, icon: 'deco_lv17_orn_chesterfield_armchair', desc: '酒红绗缝皮扶手椅，配胡桃短腿与亚麻盖毯', unlockRequirement: { level: 17 }, defaultScale: 0.98, decorationPanelTab: 'furniture' },
  { id: 'deco_lv18_wallart_botanical_taxonomy', name: '植物标本框', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 5000, starValue: 6, icon: 'deco_lv18_wallart_botanical_taxonomy', desc: '胡桃画框配米色羊皮纸，六格压花标本无文字', unlockRequirement: { level: 18 }, defaultScale: 1.10 },

  // —— 极光晶莹套（镜面池+水晶球+落地灯；月光蝶园色系延伸）——
  { id: 'deco_lv17_garden_aurora_mirror_pond', name: '极光镜面池', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 8200, starValue: 8, icon: 'deco_lv17_garden_aurora_mirror_pond', desc: '奶白卵石围出极光水镜，浮叶莲与水晶星簇', unlockRequirement: { level: 17 }, defaultScale: 1.95, decorationPanelTab: 'garden' },
  { id: 'deco_lv18_orn_aurora_crystal_orb', name: '极光水晶球', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 5400, starValue: 7, icon: 'deco_lv18_orn_aurora_crystal_orb', desc: '玻璃球里漾着极光雾与小弦月，香槟金三脚架托起', unlockRequirement: { level: 18 }, defaultScale: 0.45 },
  { id: 'deco_lv19_light_aurora_floor_lantern', name: '极光落地灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 6200, starValue: 10, icon: 'deco_lv19_light_aurora_floor_lantern', desc: '香槟金细杆托起雾面玻璃灯罩，灯罩里流动极光蓝紫', unlockRequirement: { level: 19 }, defaultScale: 1.30 },

  // —— 云端漫游套（云朵软墩+棉花云中岛+云秋千；棉花糖粉蓝，适配粉蓝/月辉）——
  { id: 'deco_lv18_orn_cloud_pouf_set', name: '云朵软墩组', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 5200, starValue: 6, icon: 'deco_lv18_orn_cloud_pouf_set', desc: '一大一小云朵造型软墩，奶白与浅粉刺绣小星', unlockRequirement: { level: 18 }, defaultScale: 1.05, decorationPanelTab: 'furniture' },
  { id: 'deco_lv19_table_cloud_dessert_island', name: '棉花云中岛', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 6800, starValue: 6, icon: 'deco_lv19_table_cloud_dessert_island', desc: '云朵造型桌面带粉色糖霜流挂，香槟金弯腿与小甜点', unlockRequirement: { level: 19 }, defaultScale: 1, decorationPanelTab: 'furniture' },
  { id: 'deco_lv20_garden_cloud_swing', name: '云端长秋千', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 9500, starValue: 9, icon: 'deco_lv20_garden_cloud_swing', desc: '云朵长椅吊在香槟金 A 形架上，弦月坠与星形抱枕', unlockRequirement: { level: 20 }, defaultScale: 1.9, decorationPanelTab: 'garden' },
  ...
  { id: 'xianqi_maple_round_table', name: '枫影圆几', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 9800, starValue: 5, icon: 'xianqi_maple_round_table', desc: '桦木圆几嵌珊瑚枫叶纹，两只琥珀小茶杯', unlockRequirement: { level: 21 }, defaultScale: 0.88 },
  { id: 'xianqi_maple_incense_stand', name: '香云几', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 8800, starValue: 4, icon: 'xianqi_maple_incense_stand', desc: '双层浅木香案，青瓷香炉与轻烟', unlockRequirement: { level: 22 }, defaultScale: 1.27 },
  { id: 'xianqi_maple_folding_chair', name: '折扇游椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 10200, starValue: 5, icon: 'xianqi_maple_folding_chair', desc: '扇形靠背游椅，桃色坐垫与金扇骨', unlockRequirement: { level: 22 }, defaultScale: 0.98, decorationPanelTab: 'furniture' },
  { id: 'xianqi_plum_padded_stool', name: '暖绒绣墩', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 8600, starValue: 4, icon: 'xianqi_plum_padded_stool', desc: '梅粉绒面圆墩，白木底座配银流苏', unlockRequirement: { level: 23 }, defaultScale: 0.45, decorationPanelTab: 'furniture' },
  { id: 'xianqi_maple_landscape_screen', name: '秋山屏风', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 11200, starValue: 6, icon: 'xianqi_maple_landscape_screen', desc: '四扇绢屏绘珊瑚枫山，奶油木框无文字', unlockRequirement: { level: 23 }, defaultScale: 1.82 },
  { id: 'xianqi_plum_snow_window', name: '梅枝雪窗', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 9500, starValue: 5, icon: 'xianqi_plum_snow_window', desc: '圆月窗框，磨砂玻璃上梅枝与细雪', unlockRequirement: { level: 24 }, defaultScale: 1.28 },
  { id: 'xianqi_plum_snow_basin', name: '雪梅水钵', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 10800, starValue: 6, icon: 'xianqi_plum_snow_basin', desc: '白石水钵浮着淡蓝水面与梅瓣', unlockRequirement: { level: 24 }, defaultScale: 0.92 },
  { id: 'xianqi_plum_wardrobe', name: '雪白轻柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 11800, starValue: 6, icon: 'xianqi_plum_wardrobe', desc: '白漆衣柜嵌银梅枝，淡蓝云形拉手', unlockRequirement: { level: 25 }, defaultScale: 1.45 },
  { id: 'xianqi_plum_canopy_bed', name: '寒梅纱床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 18000, starValue: 8, icon: 'xianqi_plum_canopy_bed', desc: '白木四柱床垂冰蓝梅粉纱幔，雪花刺绣', unlockRequirement: { level: 25 }, defaultScale: 2.2, decorationPanelTab: 'furniture' },
  { id: 'xianqi_koi_twin_stone_seat', name: '双鲤石凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 9200, starValue: 5, icon: 'xianqi_koi_twin_stone_seat', desc: '一对石凳刻鲤纹，青绿软垫', unlockRequirement: { level: 26 }, defaultScale: 0.78, decorationPanelTab: 'furniture' },
  { id: 'xianqi_koi_scale_cabinet', name: '鱼鳞圆柜', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 11200, starValue: 6, icon: 'xianqi_koi_scale_cabinet', desc: '鼓形圆柜门绘青金鱼鳞纹', unlockRequirement: { level: 26 }, defaultScale: 0.92 },
  { id: 'xianqi_koi_wall_fountain', name: '壁泉游鳞', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 10500, starValue: 5, icon: 'xianqi_koi_wall_fountain', desc: '挂墙玉色泉板，金鲤浮雕与细流', unlockRequirement: { level: 27 }, defaultScale: 1.25 },
  { id: 'xianqi_koi_pond_tea_table', name: '临池茶台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 12200, starValue: 7, icon: 'xianqi_koi_pond_tea_table', desc: '矮茶台侧嵌小池，青瓷茶具与游鳞', unlockRequirement: { level: 27 }, defaultScale: 1.82 },
  { id: 'xianqi_orchid_pavilion_mirror', name: '兰月妆镜台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 11500, starValue: 6, icon: 'xianqi_orchid_pavilion_mirror', desc: '淡紫木妆台，圆银镜与兰紫绢屏', unlockRequirement: { level: 28 }, defaultScale: 1.4 },
  { id: 'xianqi_koi_stream_bridge', name: '游鳞小桥', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 14200, starValue: 8, icon: 'xianqi_koi_stream_bridge', desc: '青玉短桥金栏，拱下可见锦鲤', unlockRequirement: { level: 28 }, defaultScale: 1.6 },
  { id: 'xianqi_bamboo_mist_fence', name: '翠竹篱段', slot: DecoSlot.GARDEN, rarity: DecoRarity.COMMON, cost: 8800, starValue: 4, icon: 'xianqi_bamboo_mist_fence', desc: '短竹篱系雾灰丝带，清新庭院边栏', unlockRequirement: { level: 29 }, defaultScale: 1 },
  ...
  { id: 'jiangnan_rattan_daybed', name: '藤枕榻', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 12800, starValue: 7, icon: 'jiangnan_rattan_daybed', desc: '竹框卧榻配靛蓝垫与青花枕，午后小憩位', unlockRequirement: { level: 26 }, defaultScale: 1.55, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'gucha_tea_boat', name: '茶则舟', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 10800, starValue: 5, icon: 'gucha_tea_boat', desc: '竹茶船托盘上摆着盖碗与公道杯', unlockRequirement: { level: 27 }, defaultScale: 1.05, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'jiangnan_willow_cart', name: '柳编花车', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 11200, starValue: 6, icon: 'jiangnan_willow_cart', desc: '柳编小车木轮，桶里盛着牡丹与荷花', unlockRequirement: { level: 27 }, defaultScale: 1.22, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'gucha_tea_chest', name: '封箱茶仓', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 11800, starValue: 6, icon: 'gucha_tea_chest', desc: '双层木架堆着蜡封茶砖与纸包', unlockRequirement: { level: 28 }, defaultScale: 1.35, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  ...
  { id: 'ancient_inkstone_desk', name: '砚台书案', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 15500, starValue: 6, icon: 'ancient_inkstone_desk', desc: '红木矮案嵌砚台，青瓷水盂与笔搁一字排开', unlockRequirement: { level: 30 }, defaultScale: 1.2 },
  { id: 'ancient_scroll_rack', name: '经卷竹架', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 15200, starValue: 6, icon: 'ancient_scroll_rack', desc: '竹架三层悬着红绳束口的素卷', unlockRequirement: { level: 30 }, defaultScale: 1.5 },
  { id: 'ancient_dressing_case', name: '梳妆奁台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 16800, starValue: 6, icon: 'ancient_dressing_case', desc: '黑漆妆台配三折铜镜，玉簪盒与珠串小碟', unlockRequirement: { level: 31 }, defaultScale: 1.35 },
  { id: 'folk_kite_wall', name: '沙燕风筝墙', slot: DecoSlot.WALLART, rarity: DecoRarity.COMMON, cost: 15800, starValue: 5, icon: 'folk_kite_wall', desc: '竹框上挂着红青三只沙燕风筝，民俗墙饰', unlockRequirement: { level: 31 }, defaultScale: 0.95 },
  { id: 'folk_lion_head_stand', name: '醒狮头架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 16200, starValue: 6, icon: 'folk_lion_head_stand', desc: '金红醒狮头立在木架上，绒边大眼喜气洋洋', unlockRequirement: { level: 31 }, defaultScale: 0.85 },
  { id: 'ancient_landscape_screen', name: '山水屏风', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 17500, starValue: 6, icon: 'ancient_landscape_screen', desc: '四扇乌木框绢屏，水墨山水层峦叠瀑', unlockRequirement: { level: 32 }, defaultScale: 1.82 },
  { id: 'folk_dragon_bench', name: '龙纹长凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 32800, starValue: 10, icon: 'folk_dragon_bench', desc: '朱漆长凳龙脊靠背，金黄坐垫缀红穗', unlockRequirement: { level: 32 }, defaultScale: 1.75, decorationPanelTab: 'furniture' },
  { id: 'ancient_master_chair', name: '太师椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 18200, starValue: 7, icon: 'ancient_master_chair', desc: '深木官帽椅，靠背雕龙纹，正襟危坐位', unlockRequirement: { level: 33 }, defaultScale: 1.1, decorationPanelTab: 'furniture' },
  { id: 'ancient_bronze_ding', name: '三足鼎案', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 19200, starValue: 8, icon: 'ancient_bronze_ding', desc: '青铜三足鼎立于红木案，云纹绿锈古意盎然', unlockRequirement: { level: 33 }, defaultScale: 0.78 },
  { id: 'ancient_phoenix_rug', name: '凤纹地毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 22800, starValue: 8, icon: 'ancient_phoenix_rug', desc: '绛红织毯金线凤纹，青绿镶边铺地显贵', unlockRequirement: { level: 33 }, defaultScale: 1.65, depthSortYLift: 0, depthSortFloorMat: true },
  { id: 'ancient_jade_bi_stand', name: '礼璧展架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 21500, starValue: 9, icon: 'ancient_jade_bi_stand', desc: '乌木小案托着青玉礼璧，红绸垫承古器', unlockRequirement: { level: 34 }, defaultScale: 0.9 },
  { id: 'whimsy_geode_table', name: '晶洞茶几', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 20500, starValue: 8, icon: 'whimsy_geode_table', desc: '紫晶洞切片台面闪微光，铁架承住矿物奇观', unlockRequirement: { level: 34 }, defaultScale: 0.95 },
  { id: 'folk_pole_lantern', name: '灯杆宫灯', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 22800, starValue: 9, icon: 'folk_pole_lantern', desc: '木杆挑着朱红宫灯，石座稳立庭院夜宴', unlockRequirement: { level: 35 }, defaultScale: 1.8 },
  { id: 'ancient_stone_lantern', name: '石灯笼', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 21800, starValue: 8, icon: 'ancient_stone_lantern', desc: '花岗石灯笼四层塔身，灯室暖黄静立庭径', unlockRequirement: { level: 35 }, defaultScale: 1.0 },
  ...
  { id: 'cake_shelf_layered_display',     name: '分层蛋糕展示柜', slot: DecoSlot.SHELF,    rarity: DecoRarity.LIMITED, cost: 6200, starValue: 11, icon: 'cake_shelf_layered_display',     desc: '蜜木+黄铜玻璃三层柜，奶油蛋糕与马卡龙的招牌门面', unlockRequirement: { level: 16 }, defaultScale: 1.5,  decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  ...
  { id: 'cake_shelf_chilled_cabinet',     name: '草莓冷藏甜品柜', slot: DecoSlot.SHELF,    rarity: DecoRarity.RARE,    cost: 5400, starValue: 8,  icon: 'cake_shelf_chilled_cabinet',     desc: '粉色立柜玻璃门内排着马卡龙慕斯与小蛋糕', unlockRequirement: { level: 17 }, defaultScale: 1.18, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_shelf_fondant_flowers',     name: '翻糖花展示架',   slot: DecoSlot.SHELF,    rarity: DecoRarity.FINE,    cost: 5000, starValue: 6,  icon: 'cake_shelf_fondant_flowers',     desc: '奶白杆配三层圆台，摆着多彩翻糖花与糖珠', unlockRequirement: { level: 16 }, defaultScale: 1.05, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  ...
  { id: 'cake_table_register_counter',    name: '蛋糕收银台',     slot: DecoSlot.TABLE,    rarity: DecoRarity.RARE,    cost: 5300, starValue: 8,  icon: 'cake_table_register_counter',    desc: '草莓粉柜身配大理石面，复古收银机与玻璃钟罩马卡龙', unlockRequirement: { level: 16 }, defaultScale: 1.30, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  ...
  { id: 'cake_table_gift_wrap',           name: '礼盒打包台',     slot: DecoSlot.TABLE,    rarity: DecoRarity.FINE,    cost: 5000, starValue: 6,  icon: 'cake_table_gift_wrap',           desc: '蜜木台面背靠多色缎带卷，奶油礼盒与黄铜剪刀', unlockRequirement: { level: 17 }, defaultScale: 1.18, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_table_dessert_island',      name: '甜点中岛长桌',   slot: DecoSlot.TABLE,    rarity: DecoRarity.RARE,    cost: 5700, starValue: 9,  icon: 'cake_table_dessert_island',      desc: '奶白长桌带粉色糖霜流挂，香槟金腿与一排小甜点', unlockRequirement: { level: 18 }, defaultScale: 1.40, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_light_pink_double_oven',    name: '草莓双门烤箱',   slot: DecoSlot.LIGHT,    rarity: DecoRarity.RARE,    cost: 5900, starValue: 10, icon: 'cake_light_pink_double_oven',    desc: '草莓粉立式双门烤箱，门内可见烤盘里的小蛋糕', unlockRequirement: { level: 16 }, defaultScale: 1.30, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  ...
  { id: 'cake_light_pendant_macaron',     name: '马卡龙塔灯',     slot: DecoSlot.LIGHT,    rarity: DecoRarity.FINE,    cost: 5000, starValue: 6,  icon: 'cake_light_pendant_macaron',     desc: '奶白圆底盘配黄铜立柱，三层粉绿黄马卡龙灯罩柔光发亮', unlockRequirement: { level: 17 }, defaultScale: 1.25, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_light_chocolate_fountain',  name: '巧克力喷泉机',   slot: DecoSlot.LIGHT,    rarity: DecoRarity.RARE,    cost: 5400, starValue: 8,  icon: 'cake_light_chocolate_fountain',  desc: '黄铜螺旋柱与双层流挂巧克力，旁配草莓串与棉花糖', unlockRequirement: { level: 18 }, defaultScale: 0.95, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  ...
  { id: 'cake_orn_wedding_cake_centerpiece', name: '婚礼蛋糕台',  slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 8800, starValue: 18, icon: 'cake_orn_wedding_cake_centerpiece', desc: '三层奶白翻糖蛋糕配粉玫瑰与糖珠，瓷台金边', unlockRequirement: { level: 20 }, defaultScale: 1.10, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_orn_donut_cushion_pair',    name: '甜甜圈坐垫组',   slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON,  cost: 5000,  starValue: 3,  icon: 'cake_orn_donut_cushion_pair',    desc: '一大一小甜甜圈造型软垫，粉糖霜与巧克力两味', unlockRequirement: { level: 16 }, defaultScale: 1.00, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_orn_teddy_baker',           name: '烘焙小熊摆件',   slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE,    cost: 5000, starValue: 5,  icon: 'cake_orn_teddy_baker',           desc: '焦糖蜜熊戴厨师帽抱奶油碗，店铺萌系吉祥物', unlockRequirement: { level: 17 }, defaultScale: 0.85, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  ...
  { id: 'cake_wallart_lollipop_clock',    name: '棒棒糖挂钟',     slot: DecoSlot.WALLART,  rarity: DecoRarity.FINE,    cost: 5000, starValue: 5,  icon: 'cake_wallart_lollipop_clock',    desc: '粉绿白糖纹圆盘配奶白糖棒，黄铜指针无数字', unlockRequirement: { level: 16 }, defaultScale: 0.95, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_garden_strawberry_arch',    name: '草莓藤拱门',     slot: DecoSlot.GARDEN,   rarity: DecoRarity.LIMITED, cost: 7800, starValue: 14, icon: 'cake_garden_strawberry_arch',    desc: '奶白拱门缠满草莓藤与白花，门下两盆小草莓', unlockRequirement: { level: 17 }, defaultScale: 2.00, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
