...
export const DECO_DEFS: DecoDef[] = [
  ...
  { id: 'orn_floral_chest',   name: '花艺工具箱',   slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 230, starValue: 2, icon: 'orn_floral_chest',   desc: '剪刀麻绳小喷壶', unlockRequirement: { level: 4 }, defaultScale: 0.87, decorationPanelTab: 'flower_room' },
  ...
  { id: 'wallart_lace_curtain', name: '柔纱短帘', slot: DecoSlot.WALLART,  rarity: DecoRarity.FINE,   cost: 630, starValue: 3, icon: 'wallart_lace_curtain', desc: '蕾丝咖啡馆风情', unlockRequirement: { level: 6 }, defaultScale: 1.5 },
  ...
  // ═══════ ⑫ 熟客主题家具（AffinityConfig.milestones[4] decoUnlockId 解锁；非花愿购买，cost=0；questId 门由 AffinityManager 达 Lv4 时 grantQuest + gmUnlockDeco 发放）
  // 注：starValue 必须为 0 — 这些是免费赠予的稀有家具，若计星会被「摆放→拆除→重摆」刷分；星星统一来自购买行为。
  { id: 'affinity_student_desk',         name: '校园书桌',     slot: DecoSlot.TABLE,    rarity: DecoRarity.LIMITED, cost: 0, starValue: 0, icon: 'affinity_student_desk',         desc: '小诗赠：法式田园奶白漆木 + 薰衣草荷叶边，黄铜鹅颈灯与薄荷玻璃罩，诗稿与压花静静摆开', defaultScale: 1.05, decorationPanelTab: 'furniture',   unlockRequirement: { questId: 'affinity_student_bond4',  conditionText: '熟客 Lv.4', questDetailText: '与小诗达到 Lv.4「校园书桌」即可解锁' } },
  { id: 'affinity_worker_coffee_corner', name: '通勤咖啡角',   slot: DecoSlot.LIGHT,    rarity: DecoRarity.LIMITED, cost: 0, starValue: 0, icon: 'affinity_worker_coffee_corner', desc: '阿凯赠：深胡桃木台 + 紫铜意式机与磨豆机，悬一盏爱迪生灯泡，深夜加班的工业咖啡角',     defaultScale: 0.85, decorationPanelTab: 'furniture',   unlockRequirement: { questId: 'affinity_worker_bond4',   conditionText: '熟客 Lv.4', questDetailText: '与阿凯达到 Lv.4「通勤咖啡角」即可解锁' } },
  { id: 'affinity_mom_balcony_rack',     name: '阳台花架',     slot: DecoSlot.SHELF,    rarity: DecoRarity.LIMITED, cost: 0, starValue: 0, icon: 'affinity_mom_balcony_rack',     desc: '林姐赠：维多利亚白色雕花铁艺三层架，玻璃斜顶小温室，兰、薰衣草与玫瑰随蝶起舞',         defaultScale: 1.20, decorationPanelTab: 'flower_room', unlockRequirement: { questId: 'affinity_mom_bond4',      conditionText: '熟客 Lv.4', questDetailText: '与林姐达到 Lv.4「阳台花架」即可解锁' } },
  { id: 'affinity_youth_book_rack',      name: '诗意书架',     slot: DecoSlot.SHELF,    rarity: DecoRarity.LIMITED, cost: 0, starValue: 0, icon: 'affinity_youth_book_rack',      desc: '小景赠：Dark academia 老胡桃书架，烫金牛血红诗集、古董相机、绿罩黄铜台灯与玻璃罩干花', defaultScale: 1.10, decorationPanelTab: 'furniture',   unlockRequirement: { questId: 'affinity_youth_bond4',    conditionText: '熟客 Lv.4', questDetailText: '与小景达到 Lv.4「诗意书架」即可解锁' } },
  { id: 'affinity_athlete_trophy_case',  name: '冠军奖杯柜',   slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 0, icon: 'affinity_athlete_trophy_case',  desc: '小翼赠：学院 Varsity 浅枫木弧面玻璃柜，海军蓝呢绒衬底，铬银奖杯、奖牌与三角校旗',     defaultScale: 1.10, decorationPanelTab: 'furniture',   unlockRequirement: { questId: 'affinity_athlete_bond4',  conditionText: '熟客 Lv.4', questDetailText: '与小翼达到 Lv.4「冠军奖杯柜」即可解锁' } },
];
