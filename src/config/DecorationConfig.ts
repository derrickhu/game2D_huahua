...
export const ROOM_STYLES: RoomStyleDef[] = [
  ...
  { id: 'style_forest_treehouse_spring_bloom_nb2', name: '春花藤巢', cost: 34500, starValue: 8, rarity: DecoRarity.FINE, bgTexture: 'bg_room_forest_treehouse_spring_bloom_nb2', desc: '春日换色壳：巨橡抽新芽，粉黄紫爬藤绕干，薄荷春花瓦檐与屋顶鸟巢', unlockRequirement: { level: 36 }, allowedSceneIds: ['forest_treehouse'] },
  ...
  { id: 'style_dream_cloud_purple_mooncradle_nb2', name: '紫月云台', cost: 66666, starValue: 8, rarity: DecoRarity.FINE, bgTexture: 'bg_room_dream_cloud_purple_mooncradle_nb2', desc: '梦云小屋换色壳：粉紫月云双层空壳，月石地面、星月吊饰与云梯围栏更梦幻', unlockRequirement: { level: 22 }, allowedSceneIds: ['dream_cloud_house'] },
];
...
export const DECO_DEFS: DecoDef[] = [
  ...
  { id: 'deco_lv20_garden_moon_fountain', name: '月辉喷泉雕塑', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 10800, starValue: 10, icon: 'deco_lv20_garden_moon_fountain', desc: '月牙水晶喷泉与蝶翼雕塑组成庭院压轴大件', unlockRequirement: { level: 20 }, defaultScale: 1.4, decorationPanelTab: 'garden' },
  { id: 'deco_lv20_shelf_star_observatory', name: '星月观景陈列柜', slot: DecoSlot.SHELF, rarity: DecoRarity.LIMITED, cost: 13800, starValue: 9, icon: 'deco_lv20_shelf_star_observatory', desc: '小型观景台式陈列柜，玻璃穹顶里摆着星月花器', unlockRequirement: { level: 20 }, defaultScale: 1.32, decorationPanelTab: 'furniture' },
  { id: 'deco_lv20_wall_moon_sheer_curtain', name: '月纱蝶影帘', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 10950, starValue: 13, icon: 'deco_lv20_wall_moon_sheer_curtain', desc: '挂墙半透明月光纱帘，香槟金帘杆与蝶影坠饰让墙面更轻盈', unlockRequirement: { level: 20 }, defaultScale: 1.8 },
  ...
  { id: 'deco_lv20_garden_cloud_swing', name: '云端长秋千', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 14250, starValue: 9, icon: 'deco_lv20_garden_cloud_swing', desc: '云朵长椅吊在香槟金 A 形架上，弦月坠与星形抱枕', unlockRequirement: { level: 20 }, defaultScale: 1.9, decorationPanelTab: 'garden' },
  ...
  { id: 'jiangnan_wash_bench', name: '临河浣衣凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 5400, starValue: 1, icon: 'jiangnan_wash_bench', desc: '旧木矮凳叠着白布，底下藤篮装着浣衣日常', unlockRequirement: { level: 20 }, defaultScale: 0.95, decorationPanelTab: 'furniture' },

  // ═══════ ⑭ 仙气古风扩展 Lv21–30（batch53 · 全场景通用 · 家具/摆件/墙饰/庭院 Tab）
  { id: 'xianqi_maple_tier_shelf', name: '果篮层架', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 10120, starValue: 4, icon: 'xianqi_maple_tier_shelf', desc: '三层原木架配藤篮与柿子梨，顶栏枫叶花饰', unlockRequirement: { level: 21 }, defaultScale: 1.75 },
  { id: 'xianqi_maple_round_table', name: '枫影圆几', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 10780, starValue: 5, icon: 'xianqi_maple_round_table', desc: '桦木圆几嵌珊瑚枫叶纹，两只琥珀小茶杯', unlockRequirement: { level: 21 }, defaultScale: 0.88 },
  { id: 'xianqi_maple_incense_stand', name: '香云几', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 9680, starValue: 4, icon: 'xianqi_maple_incense_stand', desc: '双层浅木香案，青瓷香炉与轻烟', unlockRequirement: { level: 22 }, defaultScale: 1.27 },
  { id: 'xianqi_maple_folding_chair', name: '折扇游椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 11220, starValue: 5, icon: 'xianqi_maple_folding_chair', desc: '扇形靠背游椅，桃色坐垫与金扇骨', unlockRequirement: { level: 22 }, defaultScale: 0.98, decorationPanelTab: 'furniture' },
  { id: 'xianqi_plum_padded_stool', name: '暖绒绣墩', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 9460, starValue: 4, icon: 'xianqi_plum_padded_stool', desc: '梅粉绒面圆墩，白木底座配银流苏', unlockRequirement: { level: 23 }, defaultScale: 0.45, decorationPanelTab: 'furniture' },
  { id: 'xianqi_maple_landscape_screen', name: '秋山屏风', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 12320, starValue: 6, icon: 'xianqi_maple_landscape_screen', desc: '四扇绢屏绘珊瑚枫山，奶油木框无文字', unlockRequirement: { level: 23 }, defaultScale: 1.82 },
  { id: 'xianqi_plum_snow_window', name: '梅枝雪窗', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 10450, starValue: 5, icon: 'xianqi_plum_snow_window', desc: '圆月窗框，磨砂玻璃上梅枝与细雪', unlockRequirement: { level: 24 }, defaultScale: 1.28 },
  { id: 'xianqi_plum_snow_basin', name: '雪梅水钵', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 11880, starValue: 6, icon: 'xianqi_plum_snow_basin', desc: '白石水钵浮着淡蓝水面与梅瓣', unlockRequirement: { level: 24 }, defaultScale: 0.92 },
  { id: 'xianqi_plum_wardrobe', name: '雪白轻柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 12980, starValue: 6, icon: 'xianqi_plum_wardrobe', desc: '白漆衣柜嵌银梅枝，淡蓝云形拉手', unlockRequirement: { level: 25 }, defaultScale: 1.45 },
  { id: 'xianqi_plum_canopy_bed', name: '寒梅纱床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 19800, starValue: 8, icon: 'xianqi_plum_canopy_bed', desc: '白木四柱床垂冰蓝梅粉纱幔，雪花刺绣', unlockRequirement: { level: 25 }, defaultScale: 2.2, decorationPanelTab: 'furniture' },
  { id: 'xianqi_koi_twin_stone_seat', name: '双鲤石凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 10120, starValue: 5, icon: 'xianqi_koi_twin_stone_seat', desc: '一对石凳刻鲤纹，青绿软垫', unlockRequirement: { level: 26 }, defaultScale: 0.78, decorationPanelTab: 'furniture' },
  { id: 'xianqi_koi_scale_cabinet', name: '鱼鳞圆柜', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 12320, starValue: 6, icon: 'xianqi_koi_scale_cabinet', desc: '鼓形圆柜门绘青金鱼鳞纹', unlockRequirement: { level: 26 }, defaultScale: 0.92 },
  { id: 'xianqi_koi_wall_fountain', name: '壁泉游鳞', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 11550, starValue: 5, icon: 'xianqi_koi_wall_fountain', desc: '挂墙玉色泉板，金鲤浮雕与细流', unlockRequirement: { level: 27 }, defaultScale: 1.25 },
  { id: 'xianqi_koi_pond_tea_table', name: '临池茶台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 13420, starValue: 7, icon: 'xianqi_koi_pond_tea_table', desc: '矮茶台侧嵌小池，青瓷茶具与游鳞', unlockRequirement: { level: 27 }, defaultScale: 1.82 },
  { id: 'xianqi_orchid_pavilion_mirror', name: '兰月妆镜台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 12650, starValue: 6, icon: 'xianqi_orchid_pavilion_mirror', desc: '淡紫木妆台，圆银镜与兰紫绢屏', unlockRequirement: { level: 28 }, defaultScale: 1.4 },
  { id: 'xianqi_koi_stream_bridge', name: '游鳞小桥', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 15620, starValue: 8, icon: 'xianqi_koi_stream_bridge', desc: '青玉短桥金栏，拱下可见锦鲤', unlockRequirement: { level: 28 }, defaultScale: 1.6 },
  ...
  { id: 'xianqi_bamboo_joint_desk', name: '竹节书案', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 11220, starValue: 5, icon: 'xianqi_bamboo_joint_desk', desc: '竹节腿书案，淡绿纸卷与玉镇纸', unlockRequirement: { level: 29 }, defaultScale: 1.18 },
  { id: 'xianqi_bamboo_book_tower', name: '竹筒书塔', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 12100, starValue: 6, icon: 'xianqi_bamboo_book_tower', desc: '竹筒螺旋书塔，素卷与兰芽点缀', unlockRequirement: { level: 30 }, defaultScale: 1.55 },
  { id: 'xianqi_bamboo_mist_daybed', name: '竹影卧榻', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 14080, starValue: 7, icon: 'xianqi_bamboo_mist_daybed', desc: '竹框卧榻配鼠尾草垫，一端垂雾灰纱', unlockRequirement: { level: 30 }, defaultScale: 1.55, decorationPanelTab: 'furniture' },

  // ═══════ ⑭.4 现代生活扩展 Lv25–35（高价常驻 · 电器 / 露营 / 软装 / 店铺小设备）
  { id: 'modern_folding_laundry_rack', name: '阳台折叠晾衣架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 18315, starValue: 4, icon: 'modern_folding_laundry_rack', desc: '白管折叠架挂满柔色衣物，带来阳台生活气', unlockRequirement: { level: 25 }, defaultScale: 1.15, decorationPanelTab: 'furniture' },
  { id: 'modern_kitchen_base_counter', name: '奶油蓝长厨柜', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 26532, starValue: 4, icon: 'modern_kitchen_base_counter', desc: '淡蓝拱形柜门连成一排，奶油台面空无一物，方便摆小家电与摆件', unlockRequirement: { level: 25 }, defaultScale: 1.98, decorationPanelTab: 'furniture' },
  { id: 'modern_hotdog_roller', name: '迷你烤肠机', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 20295, starValue: 5, icon: 'modern_hotdog_roller', desc: '透明罩小烤肠机，银色滚轴与面包托盘，可摆在厨柜台面', unlockRequirement: { level: 21 }, defaultScale: 0.92, depthSortFeetYFudge: 130 },
  { id: 'modern_glass_drink_dispenser', name: '玻璃饮料机', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 21285, starValue: 5, icon: 'modern_glass_drink_dispenser', desc: '双缸水果饮料机，柠檬茶与莓果茶清爽并排，适合厨柜台面', unlockRequirement: { level: 21 }, defaultScale: 0.72, depthSortFeetYFudge: 130 },
  { id: 'modern_camping_tent', name: '奶油露营帐篷', slot: DecoSlot.GARDEN, rarity: DecoRarity.RARE, cost: 24255, starValue: 6, icon: 'modern_camping_tent', desc: '奶油帆布小帐篷配串灯与花盆，庭院立刻有露营感', unlockRequirement: { level: 27 }, defaultScale: 1.65, decorationPanelTab: 'garden' },
  { id: 'modern_picnic_cooler_cart', name: '野餐冰桶推车', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 21780, starValue: 5, icon: 'modern_picnic_cooler_cart', desc: '薄荷冰桶小推车，饮料水果与格纹毯准备好出发', unlockRequirement: { level: 22 }, defaultScale: 1.05, decorationPanelTab: 'furniture' },
  { id: 'modern_plush_cloud_pile', name: '毛绒云朵玩具堆', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 22275, starValue: 5, icon: 'modern_plush_cloud_pile', desc: '云朵、兔兔、小熊与柠檬抱枕叠成软乎乎角落', unlockRequirement: { level: 28 }, defaultScale: 0.9 },
  { id: 'modern_wall_fairy_lights', name: '节日星星串灯', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 20790, starValue: 4, icon: 'modern_wall_fairy_lights', desc: '星星月亮小挂灯串，墙面多一点节日暖光', unlockRequirement: { level: 28 }, defaultScale: 1.25 },
  { id: 'modern_tall_flower_vase', name: '高身鲜花陶瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 22770, starValue: 5, icon: 'modern_tall_flower_vase', desc: '高身奶油陶瓶插满郁金香与小雏菊，清新但有体量', unlockRequirement: { level: 28 }, defaultScale: 0.85 },
  { id: 'modern_capsule_drink_fridge', name: '胶囊饮料冰柜', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 9702, starValue: 4, icon: 'modern_capsule_drink_fridge', desc: '圆角胶囊冰柜排满彩色饮品，可摆在厨柜或台面上', unlockRequirement: { level: 22 }, defaultScale: 0.85, depthSortFeetYFudge: 130 },
  { id: 'modern_waffle_snack_cart', name: '华夫点心小车', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 24552, starValue: 6, icon: 'modern_waffle_snack_cart', desc: '暖橙棚顶小车摆着华夫饼、浆果与糖浆瓶', unlockRequirement: { level: 21 }, defaultScale: 1.05, decorationPanelTab: 'furniture' },
  ...
  { id: 'modern_balcony_drying_cabinet', name: '暖风烘衣柜', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 27225, starValue: 6, icon: 'modern_balcony_drying_cabinet', desc: '透明小烘衣柜挂着柔色衣物，顶部一盆薰衣草压住生活感', unlockRequirement: { level: 30 }, defaultScale: 1.35 },
  ...
  { id: 'modern_citrus_soda_machine', name: '柑橘气泡饮料机', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 27720, starValue: 6, icon: 'modern_citrus_soda_machine', desc: '橙黄色气泡饮料机，玻璃缸里冒着柑橘泡泡，适合厨柜台面', unlockRequirement: { level: 22 }, defaultScale: 0.72, depthSortFeetYFudge: 130 },
  { id: 'modern_pegboard_hobby_wall', name: '软木洞洞板', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 26550, starValue: 7, icon: 'modern_pegboard_hobby_wall', desc: '粉色洞洞板收纳丝带、剪刀、小花瓶与便签色块', unlockRequirement: { level: 31 }, defaultScale: 0.9 },
  { id: 'modern_countertop_icecream_machine', name: '软冰淇淋机', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 31185, starValue: 7, icon: 'modern_countertop_icecream_machine', desc: '薄荷奶油色冰淇淋机，两个小甜筒刚好接住软雪糕，适合厨柜台面', unlockRequirement: { level: 24 }, defaultScale: 0.72, depthSortFeetYFudge: 130 },
  { id: 'modern_aquarium_side_table', name: '水族小边桌', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 30150, starValue: 9, icon: 'modern_aquarium_side_table', desc: '圆鼓水族箱托起小边桌，鱼儿与水草在桌下发光', unlockRequirement: { level: 33 }, defaultScale: 0.9, decorationPanelTab: 'furniture' },
  { id: 'modern_plush_display_ladder', name: '毛绒梯形陈列架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 29520, starValue: 8, icon: 'modern_plush_display_ladder', desc: '梯形木架陈列云朵、小熊与花朵毛绒，边上还绕着细灯', unlockRequirement: { level: 33 }, defaultScale: 1.2, decorationPanelTab: 'furniture' },
  { id: 'modern_patio_swing_sofa', name: '露台吊椅沙发', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 34200, starValue: 10, icon: 'modern_patio_swing_sofa', desc: '奶油金属架吊起珊瑚软垫双人椅，花藤把露台变成小假日', unlockRequirement: { level: 35 }, defaultScale: 1.65, decorationPanelTab: 'furniture' },
  { id: 'modern_plush_capybara', name: '卡皮玩偶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 31500, starValue: 6, icon: 'modern_plush_capybara', desc: '圆滚滚卡皮巴拉毛绒，头顶还平衡着一片小橙片，懒萌到犯规', unlockRequirement: { level: 35 }, defaultScale: 0.75 },
  { id: 'modern_plush_clownfish', name: '小丑鱼玩偶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 32400, starValue: 6, icon: 'modern_plush_clownfish', desc: '橙白条纹小丑鱼毛绒，圆眼睛与短鳍摇摇晃晃，像从水族箱跳出来的', unlockRequirement: { level: 36 }, defaultScale: 0.7 },
  { id: 'modern_plush_tree_spirit', name: '树人玩偶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 33300, starValue: 7, icon: 'modern_plush_tree_spirit', desc: '苔藓绿小树人毛绒，叶子头发与胸前花苞，森林精灵也软乎乎', unlockRequirement: { level: 37 }, defaultScale: 0.75 },

  // ═══════ ⑭.4b 海蓝慵懒夏日 Lv38–45（参考地中海阳台蓝系软装）
  { id: 'azure_lazy_wicker_loveseat', name: '海蓝藤编双人沙发', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 29520, starValue: 6, icon: 'azure_lazy_wicker_loveseat', desc: '浅藤编低沙发配天蓝坐垫，星图毯与柠檬片抱枕，慵懒午后标配', unlockRequirement: { level: 38 }, defaultScale: 1.35, decorationPanelTab: 'furniture' },
  { id: 'azure_lazy_wicker_armchair', name: '海蓝藤编单椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 20520, starValue: 6, icon: 'azure_lazy_wicker_armchair', desc: '圆角藤编单椅搭粉蓝猫脸抱枕，一个人也能窝着发呆', unlockRequirement: { level: 39 }, defaultScale: 1.05, decorationPanelTab: 'furniture' },
  { id: 'azure_lazy_ladder_towel_rack', name: '海蓝梯式毛巾架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 11880, starValue: 5, icon: 'azure_lazy_ladder_towel_rack', desc: '天蓝木梯挂着柔色毛巾与海星小挂饰，像迷你阳台角落', unlockRequirement: { level: 40 }, defaultScale: 1.3, decorationPanelTab: 'furniture' },
  { id: 'azure_lazy_glass_shell_table', name: '玻璃海星小边桌', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 22140, starValue: 7, icon: 'azure_lazy_glass_shell_table', desc: '透明玻璃圆缸边桌，水底贝壳与海星轻轻晃，清凉又有趣', unlockRequirement: { level: 41 }, defaultScale: 0.85, decorationPanelTab: 'furniture' },
  { id: 'azure_lazy_star_border_rug', name: '星纹蓝海地毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 10620, starValue: 5, icon: 'azure_lazy_star_border_rug', desc: '牛仔蓝长毯配奶油星纹边与流苏，光脚踩上去就慢下来', unlockRequirement: { level: 42 }, defaultScale: 2.05, depthSortYLift: 0, depthSortFloorMat: true, decorationPanelTab: 'furniture' },
  { id: 'azure_lazy_barrel_stool', name: '木纹海蓝圆凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 9450, starValue: 5, icon: 'azure_lazy_barrel_stool', desc: '短木桶造型圆凳，浅木条与蔚蓝环带，随手一放就是座位', unlockRequirement: { level: 43 }, defaultScale: 0.55, decorationPanelTab: 'furniture' },
  { id: 'azure_lazy_star_lantern_string', name: '星月蓝串灯', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 13140, starValue: 6, icon: 'azure_lazy_star_lantern_string', desc: '星形与圆球串灯暖黄点亮，把夏夜阳台挂成小小银河', unlockRequirement: { level: 44 }, defaultScale: 1.5 },
  { id: 'azure_lazy_lemon_tree_pot', name: '柠檬蓝海花盆', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 16650, starValue: 7, icon: 'azure_lazy_lemon_tree_pot', desc: '蔚蓝陶盆种着小柠檬树，黄果实与绿叶把夏天留在店里', unlockRequirement: { level: 45 }, defaultScale: 1.15, decorationPanelTab: 'furniture' },

  // ═══════ ⑭.4c 慵懒客厅 Lv41–43（豆袋沙发 · 大提琴）
  { id: 'modern_lazy_bean_bag_coral', name: '珊瑚懒人豆袋', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 29520, starValue: 6, icon: 'modern_lazy_bean_bag_coral', desc: '南瓜分段珊瑚粉豆袋，顶上有小提环，一屁股陷进去就不想起来', unlockRequirement: { level: 41 }, defaultScale: 1.08, decorationPanelTab: 'furniture' },
  { id: 'azure_lazy_bean_bag', name: '海蓝懒人豆袋', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 30420, starValue: 6, icon: 'azure_lazy_bean_bag', desc: '同款豆袋换成天蓝面料，软乎乎像一朵云，适合窝着看投影', unlockRequirement: { level: 42 }, defaultScale: 1.08, decorationPanelTab: 'furniture' },
  { id: 'modern_floor_cello', name: '立式大提琴', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 31320, starValue: 7, icon: 'modern_floor_cello', desc: '蜂蜜色木身大提琴斜靠而立，四弦与琴头卷纹把客厅变成小音乐厅', unlockRequirement: { level: 43 }, defaultScale: 1.25, decorationPanelTab: 'furniture' },

  // ═══════ ⑭.5 茶香小院专属家具（tea_house Lv25 解锁；decorationPanelTab=flower_room → 左侧「茶香小院」Tab）
  { id: 'gucha_tea_bench', name: '茶寮长凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 3740, starValue: 1, icon: 'gucha_tea_bench', desc: '素木长凳磨得发亮，台面留着一圈茶渍印', unlockRequirement: { level: 25 }, defaultScale: 1.1, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'jiangnan_lattice_window', name: '花窗栏', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 10780, starValue: 5, icon: 'jiangnan_lattice_window', desc: '冰裂纹花窗格，淡蓝天空映在磨砂玻璃上', unlockRequirement: { level: 25 }, defaultScale: 1.28, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'gucha_water_jar', name: '陶瓮水缸', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 10120, starValue: 4, icon: 'gucha_water_jar', desc: '粗陶大水瓮配竹勺，茶寮取水必备', unlockRequirement: { level: 25 }, defaultScale: 0.82, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'gucha_charcoal_brazier', name: '竹风炉', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 11220, starValue: 5, icon: 'gucha_charcoal_brazier', desc: '竹编风炉炭火微红，陶壶上袅袅茶烟', unlockRequirement: { level: 26 }, defaultScale: 0.88, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'jiangnan_rattan_daybed', name: '藤枕榻', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 14080, starValue: 7, icon: 'jiangnan_rattan_daybed', desc: '竹框卧榻配靛蓝垫与青花枕，午后小憩位', unlockRequirement: { level: 26 }, defaultScale: 1.55, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'gucha_tea_boat', name: '茶则舟', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 11880, starValue: 5, icon: 'gucha_tea_boat', desc: '竹茶船托盘上摆着盖碗与公道杯', unlockRequirement: { level: 27 }, defaultScale: 1.05, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'jiangnan_willow_cart', name: '柳编花车', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 12320, starValue: 6, icon: 'jiangnan_willow_cart', desc: '柳编小车木轮，桶里盛着牡丹与荷花', unlockRequirement: { level: 27 }, defaultScale: 1.22, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'gucha_tea_chest', name: '封箱茶仓', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 12980, starValue: 6, icon: 'gucha_tea_chest', desc: '双层木架堆着蜡封茶砖与纸包', unlockRequirement: { level: 28 }, defaultScale: 1.35, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'xianxia_herb_rack', name: '悬索晒药架', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 12650, starValue: 6, icon: 'xianxia_herb_rack', desc: '竹架悬着干花束与草药纸包，茶香伴药香', unlockRequirement: { level: 28 }, defaultScale: 1.68, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'jiangnan_blue_cabinet', name: '青花博古柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 14520, starValue: 7, icon: 'jiangnan_blue_cabinet', desc: '红木博古架陈列青花瓶盏与折扇', unlockRequirement: { level: 29 }, defaultScale: 1.65, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'xianxia_meditation_platform', name: '蒲团云台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 11880, starValue: 5, icon: 'xianxia_meditation_platform', desc: '云纹矮台配草编蒲团，抹茶粉与小花点缀', unlockRequirement: { level: 30 }, defaultScale: 1.12, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },

  // ═══════ ⑭.6 橡树小屋专属家具（forest_treehouse Lv35–38 · 航海奇遇套）
  { id: 'sea_wheel_wall', name: '舵轮墙挂', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 13800, starValue: 6, icon: 'sea_wheel_wall', desc: '旧木舵轮悬在麻绳上，黄铜毂心闪着冒险光泽', unlockRequirement: { level: 35 }, defaultScale: 0.92, decorationPanelTab: 'flower_room', allowedSceneIds: ['forest_treehouse'] },
  { id: 'sea_anchor_bench', name: '船锚绳凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 14200, starValue: 6, icon: 'sea_anchor_bench', desc: '锈色船锚作靠背，麻绳缠腿托着木纹坐板', unlockRequirement: { level: 36 }, defaultScale: 1.28, decorationPanelTab: 'flower_room', allowedSceneIds: ['forest_treehouse'] },
  { id: 'sea_treasure_chest', name: '珍珠藏箱', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 14800, starValue: 7, icon: 'sea_treasure_chest', desc: '橡木宝箱半开，珍珠珊瑚与黄铜罗盘满溢而出', unlockRequirement: { level: 37 }, defaultScale: 1.02, decorationPanelTab: 'flower_room', allowedSceneIds: ['forest_treehouse'] },
  ...
  { id: 'ancient_brush_mountain', name: '笔架山', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 16280, starValue: 5, icon: 'ancient_brush_mountain', desc: '青玉笔山插着数支毛笔，案头文房小景', unlockRequirement: { level: 30 }, defaultScale: 0.55 },
  { id: 'ancient_inkstone_desk', name: '砚台书案', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 17050, starValue: 6, icon: 'ancient_inkstone_desk', desc: '红木矮案嵌砚台，青瓷水盂与笔搁一字排开', unlockRequirement: { level: 30 }, defaultScale: 1.2 },
  { id: 'ancient_scroll_rack', name: '经卷竹架', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 16720, starValue: 6, icon: 'ancient_scroll_rack', desc: '竹架三层悬着红绳束口的素卷', unlockRequirement: { level: 30 }, defaultScale: 1.5 },
  { id: 'ancient_dressing_case', name: '梳妆奁台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 16800, starValue: 7, icon: 'ancient_dressing_case', desc: '黑漆妆台配三折铜镜，玉簪盒与珠串小碟', unlockRequirement: { level: 31 }, defaultScale: 1.35 },
  { id: 'folk_kite_wall', name: '沙燕风筝墙', slot: DecoSlot.WALLART, rarity: DecoRarity.COMMON, cost: 15800, starValue: 6, icon: 'folk_kite_wall', desc: '竹框上挂着红青三只沙燕风筝，民俗墙饰', unlockRequirement: { level: 31 }, defaultScale: 0.95 },
  { id: 'folk_lion_head_stand', name: '醒狮头架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 16200, starValue: 7, icon: 'folk_lion_head_stand', desc: '金红醒狮头立在木架上，绒边大眼喜气洋洋', unlockRequirement: { level: 31 }, defaultScale: 0.85 },
  { id: 'ancient_landscape_screen', name: '山水屏风', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 17500, starValue: 7, icon: 'ancient_landscape_screen', desc: '四扇乌木框绢屏，水墨山水层峦叠瀑', unlockRequirement: { level: 32 }, defaultScale: 1.82 },
  { id: 'folk_dragon_bench', name: '龙纹长凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 32800, starValue: 11, icon: 'folk_dragon_bench', desc: '朱漆长凳龙脊靠背，金黄坐垫缀红穗', unlockRequirement: { level: 32 }, defaultScale: 1.75, decorationPanelTab: 'furniture' },
  { id: 'ancient_master_chair', name: '太师椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 18200, starValue: 8, icon: 'ancient_master_chair', desc: '深木官帽椅，靠背雕龙纹，正襟危坐位', unlockRequirement: { level: 33 }, defaultScale: 1.1, decorationPanelTab: 'furniture' },
  { id: 'ancient_bronze_ding', name: '三足鼎案', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 19200, starValue: 9, icon: 'ancient_bronze_ding', desc: '青铜三足鼎立于红木案，云纹绿锈古意盎然', unlockRequirement: { level: 33 }, defaultScale: 0.78 },
  { id: 'ancient_phoenix_rug', name: '凤纹地毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 22800, starValue: 9, icon: 'ancient_phoenix_rug', desc: '绛红织毯金线凤纹，青绿镶边铺地显贵', unlockRequirement: { level: 33 }, defaultScale: 1.65, depthSortYLift: 0, depthSortFloorMat: true },
  { id: 'ancient_jade_bi_stand', name: '礼璧展架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 21500, starValue: 10, icon: 'ancient_jade_bi_stand', desc: '乌木小案托着青玉礼璧，红绸垫承古器', unlockRequirement: { level: 34 }, defaultScale: 0.9 },
  { id: 'whimsy_geode_table', name: '晶洞茶几', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 20500, starValue: 9, icon: 'whimsy_geode_table', desc: '紫晶洞切片台面闪微光，铁架承住矿物奇观', unlockRequirement: { level: 34 }, defaultScale: 0.95 },
  { id: 'folk_pole_lantern', name: '灯杆宫灯', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 22800, starValue: 10, icon: 'folk_pole_lantern', desc: '木杆挑着朱红宫灯，石座稳立庭院夜宴', unlockRequirement: { level: 35 }, defaultScale: 1.8 },
  { id: 'ancient_stone_lantern', name: '石灯笼', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 21800, starValue: 9, icon: 'ancient_stone_lantern', desc: '花岗石灯笼四层塔身，灯室暖黄静立庭径', unlockRequirement: { level: 35 }, defaultScale: 1.0 },
  ...
  { id: 'cake_orn_wedding_cake_centerpiece', name: '婚礼蛋糕台',  slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 13200, starValue: 18, icon: 'cake_orn_wedding_cake_centerpiece', desc: '三层奶白翻糖蛋糕配粉玫瑰与糖珠，瓷台金边', unlockRequirement: { level: 20 }, defaultScale: 1.10, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  ...
  { id: 'qinglian_tea_shelf', name: '清涟茶架', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 2580, starValue: 3, icon: 'qinglian_tea_shelf', desc: '三层 mint 茶具架，紫纱垂帘与盖碗套组', unlockRequirement: { level: 4 }, defaultScale: 1.55, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_lantern_frame', name: '宫灯花架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 5000, starValue: 3, icon: 'qinglian_lantern_frame', desc: '木架悬挂 pastel 宫灯，夜宴花坊氛围', unlockRequirement: { level: 5 }, defaultScale: 2.58, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_scholar_rock', name: '粉晶山石', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 4180, starValue: 4, icon: 'qinglian_scholar_rock', desc: '粉晶玲珑石与祥云木座，案头清供', unlockRequirement: { level: 6 }, defaultScale: 1.25, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_guqin_stand', name: '古琴雅案', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 5780, starValue: 4, icon: 'qinglian_guqin_stand', desc: '古琴案几配云纹屏风，紫绿渐变琴身', unlockRequirement: { level: 7 }, defaultScale: 1.4, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_bamboo_window', name: '冰纹花窗', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 4000, starValue: 4, icon: 'qinglian_bamboo_window', desc: '八角冰裂纹花窗，框外淡竹与飞燕剪影', unlockRequirement: { level: 8 }, defaultScale: 1.30, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_wisteria_vanity', name: '紫藤绢屏梳妆台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 5000, starValue: 5, icon: 'qinglian_wisteria_vanity', desc: '浅木梳妆台配三扇紫藤绢屏，仙闺氛围', unlockRequirement: { level: 9 }, defaultScale: 1.55, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_cloud_book_desk', name: '祥云书案', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 4500, starValue: 4, icon: 'qinglian_cloud_book_desk', desc: '浅木书案配祥云腿雕，青瓷笔架与素卷', unlockRequirement: { level: 10 }, defaultScale: 1.30, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_moon_shelf', name: '月洞博古架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 5500, starValue: 6, icon: 'qinglian_moon_shelf', desc: '月洞门博古架，格内青瓷与粉牡丹小品', unlockRequirement: { level: 11 }, defaultScale: 1.85, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_peony_screen', name: '牡丹圆光屏风', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 6000, starValue: 6, icon: 'qinglian_peony_screen', desc: '三扇绢屏绘牡丹百合，圆光淡粉边', unlockRequirement: { level: 12 }, defaultScale: 2.02, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_cherry_wardrobe', name: '樱霞轻衣柜', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 10000, starValue: 5, icon: 'qinglian_cherry_wardrobe', desc: '奶油木衣柜配樱花板面，祥云形淡金拉手', unlockRequirement: { level: 13 }, defaultScale: 1.75, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_silk_daybed', name: '流纱罗汉榻', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 16000, starValue: 7, icon: 'qinglian_silk_daybed', desc: '浅木罗汉榻配薄荷珊瑚丝垫，流纱轻垂', unlockRequirement: { level: 14 }, defaultScale: 1.75, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_lotus_canopy_bed', name: '莲纱架子床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 22000, starValue: 8, icon: 'qinglian_lotus_canopy_bed', desc: '四柱架子床垂桃荷纱幔，莲纹床帏如梦', unlockRequirement: { level: 15 }, defaultScale: 2.5, decorationPanelTab: 'qinglian' },
