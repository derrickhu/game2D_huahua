...
export const ROOM_STYLES: RoomStyleDef[] = [
  ...
  { id: 'style_garden_villa_lilac_dusk_nb2', name: '丁香暮色', cost: 128000, starValue: 20, rarity: DecoRarity.FINE, bgTexture: 'bg_room_garden_villa_lilac_dusk_nb2', desc: '换色壳：丁香淡紫墙、淡紫细绒地毯与灰玫屋檐，同款错层房型更冷调雅致', unlockRequirement: { level: 36 }, allowedSceneIds: ['garden_villa'] },
...
export const DECO_DEFS: DecoDef[] = [
  ...
  { id: 'shelf_wood',    name: '简约木花架',  slot: DecoSlot.SHELF, rarity: DecoRarity.COMMON, cost: 5, starValue: 2, icon: 'shelf_wood',   desc: '三层原木架，朴素实用', defaultScale: 1.6, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_shop'] },
  { id: 'shelf_step',    name: '阶梯花架',    slot: DecoSlot.SHELF, rarity: DecoRarity.COMMON, cost: 355, starValue: 3, icon: 'shelf_step',   desc: '层层叠叠，像小山丘', unlockRequirement: { level: 1 }, defaultScale: 1.55 },
  { id: 'shelf_long',    name: '长条花台',    slot: DecoSlot.SHELF, rarity: DecoRarity.FINE,   cost: 752, starValue: 3, icon: 'shelf_long',   desc: '靠墙摆放的温馨花台', unlockRequirement: { level: 5 }, defaultScale: 1.25, decorationPanelTab: 'garden' },
  ...
  { id: 'shelf_glass',   name: '玻璃展示柜',  slot: DecoSlot.SHELF, rarity: DecoRarity.RARE,   cost: 3170, starValue: 6, icon: 'shelf_glass',  desc: '高端玻璃门展示柜', unlockRequirement: { level: 10 }, defaultScale: 1.45 },

  // ═══════ ② 桌台 / 工作台 (table) ═══════
  { id: 'table_counter',  name: '木质收银台',  slot: DecoSlot.TABLE, rarity: DecoRarity.COMMON, cost: 260, starValue: 3, icon: 'table_counter', desc: '温暖的原木收银台', defaultScale: 1.53 },
  ...
  { id: 'table_work',     name: '花艺工作台',  slot: DecoSlot.TABLE, rarity: DecoRarity.FINE,   cost: 800, starValue: 2, icon: 'table_work',    desc: '蜜木双层台，瓶瓶罐罐都是好看的花', unlockRequirement: { level: 6 }, defaultScale: 1.28 },
  ...
  // ═══════ ③ 灯具 (light) ═══════
  { id: 'light_desk',     name: '台灯',        slot: DecoSlot.LIGHT, rarity: DecoRarity.COMMON, cost: 395, starValue: 2,  icon: 'light_desk',    desc: '简约台灯，温暖光芒', unlockRequirement: { level: 4 }, defaultScale: 0.73 },
  { id: 'light_floor',    name: '晶石立灯',    slot: DecoSlot.LIGHT, rarity: DecoRarity.COMMON, cost: 360, starValue: 2, icon: 'light_floor',   desc: '淡蓝晶石立灯，实心乳白质感易抠图', unlockRequirement: { level: 3 }, defaultScale: 1.25 },
  { id: 'light_pendant',  name: '花式立灯',    slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE,   cost: 789, starValue: 2, icon: 'light_pendant', desc: '花朵造型的精美立灯', unlockRequirement: { level: 6 }, defaultScale: 1.05 },
  { id: 'light_crystal',  name: '水晶灯',      slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE,   cost: 3040, starValue: 4, icon: 'light_crystal', desc: '华丽的水晶折射光芒', unlockRequirement: { level: 10 }, defaultScale: 1.1 },

  // ═══════ ④ 摆件 / 装饰品 (ornament) ═══════
  { id: 'orn_pot',        name: '藤编收纳篮',  slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 365, starValue: 2,  icon: 'orn_pot',       desc: '手编篮配干花丝带，非盆栽', unlockRequirement: { level: 3 }, defaultScale: 0.63 },
  ...
  { id: 'wallart_window_meadow_arch', name: '拱窗花野景', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 3225, starValue: 4, icon: 'wallart_window_meadow_arch', desc: '奶油木拱窗里收进一片花野与蝶影', unlockRequirement: { level: 10 }, defaultScale: 1.32 },
  { id: 'wallart_window_lake_round',  name: '圆窗湖雾景', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 4320, starValue: 6, icon: 'wallart_window_lake_round',  desc: '复古圆窗映着薄雾湖景，像温室外的安静清晨', unlockRequirement: { level: 12 }, defaultScale: 1.28 },
  ...
  { id: 'garden_arbor',    name: '藤蔓凉亭',   slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE,   cost: 1362, starValue: 3, icon: 'garden_arbor',    desc: '紫藤木亭轻线稿，自然草边', unlockRequirement: { level: 5 }, defaultScale: 2.7 },
  { id: 'garden_arch',     name: '玫瑰花廊',   slot: DecoSlot.GARDEN, rarity: DecoRarity.RARE,   cost: 6770, starValue: 9, icon: 'garden_arch',     desc: '双拱玫瑰廊轻线稿，无菱形草皮', unlockRequirement: { level: 7 }, defaultScale: 2.53 },
  ...
  { id: 'shelf_terracotta',   name: '陶盆阶梯花架', slot: DecoSlot.SHELF,    rarity: DecoRarity.FINE,   cost: 450,  starValue: 2, icon: 'shelf_terracotta',   desc: '粉陶盆叠成阶梯，小清新绿植', unlockRequirement: { level: 5 },  defaultScale: 0.68 },
  { id: 'table_wrap_station', name: '花艺包装台',   slot: DecoSlot.TABLE,    rarity: DecoRarity.FINE,   cost: 480,  starValue: 3, icon: 'table_wrap_station', desc: '粉点彩纸卷、花束与丝带，包装角一眼能认', unlockRequirement: { level: 4 },  defaultScale: 1.3 },
  { id: 'table_rattan_twoset', name: '藤编边桌凳组', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE,   cost: 699,  starValue: 3, icon: 'table_rattan_twoset', desc: '圆几配双凳，度假风下午茶', unlockRequirement: { level: 4 }, defaultScale: 1.13, decorationPanelTab: 'furniture' },
  ...
  { id: 'orn_window_garden',  name: '窗台花园组',   slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 600,  starValue: 2, icon: 'orn_window_garden',  desc: '三盆小花排排站', unlockRequirement: { level: 6 }, defaultScale: 0.87 },
  { id: 'orn_awaken_bucket',  name: '金属醒花桶',   slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 390, starValue: 2, icon: 'orn_awaken_bucket',  desc: '深水养花，把花叫醒', unlockRequirement: { level: 5 }, defaultScale: 0.77, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_shop'] },
  { id: 'orn_floral_chest',   name: '花艺工具箱',   slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 376, starValue: 2, icon: 'orn_floral_chest',   desc: '剪刀麻绳小喷壶', unlockRequirement: { level: 3 }, defaultScale: 0.87, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_shop'] },
  { id: 'orn_pastel_bench',   name: '马卡龙长凳',   slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE,   cost: 400, starValue: 4, icon: 'orn_pastel_bench',   desc: '薄荷木色配珊瑚软垫', unlockRequirement: { level: 4 }, defaultScale: 1.1, decorationPanelTab: 'furniture' },

  // ═══════ ④.5 鲜花摆件批次 11（全场景「摆件」Tab，7 级起每级解锁一件）═══════
  { id: 'orn_flora_blooming_cactus', name: '开花仙人球', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 1030, starValue: 2, icon: 'orn_flora_blooming_cactus', desc: '陶盆里的圆滚滚仙人掌，顶着一朵艳粉花', unlockRequirement: { level: 7 }, defaultScale: 0.52 },
  { id: 'orn_flora_fern_terrarium', name: '蕨类生态瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 920, starValue: 2, icon: 'orn_flora_fern_terrarium', desc: '软木塞玻璃罐里迷你苔藓与蕨叶', unlockRequirement: { level: 8 }, defaultScale: 0.48 },
  { id: 'orn_flora_hyacinth_glass_vase', name: '风信子水培瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 1560, starValue: 2, icon: 'orn_flora_hyacinth_glass_vase', desc: '球形玻璃瓶里紫粉风信子簇', unlockRequirement: { level: 9 }, defaultScale: 0.62 },
  { id: 'orn_flora_wildflower_mason_jar', name: '野花花束罐', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 1920, starValue: 2, icon: 'orn_flora_wildflower_mason_jar', desc: '蓝色梅森罐扎着虞美人与矢车菊', unlockRequirement: { level: 10 }, defaultScale: 0.76 },
  { id: 'orn_flora_lavender_window_box', name: '薰衣草长条盆', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 6480, starValue: 2, icon: 'orn_flora_lavender_window_box', desc: '白漆木窗盒里一排紫色薰衣草', unlockRequirement: { level: 11 }, defaultScale: 1.18, depthSortFeetYFudge: 0, depthSortYLift: 0 },
  { id: 'orn_flora_hanging_spider_plant', name: '吊兰挂盆', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 3000, starValue: 3, icon: 'orn_flora_hanging_spider_plant', desc: '白绳编织吊盆，斑纹吊兰垂下来', unlockRequirement: { level: 12 }, defaultScale: 1.12 },
  { id: 'orn_flora_cherry_branch_vase', name: '樱花折枝瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 6120, starValue: 4, icon: 'orn_flora_cherry_branch_vase', desc: '青瓷高瓶插一枝盛放的樱花', unlockRequirement: { level: 13 }, defaultScale: 0.98 },
  { id: 'orn_flora_hanging_petunia', name: '矮牵牛吊篮', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 3000, starValue: 3, icon: 'orn_flora_hanging_petunia', desc: '藤编吊篮里粉紫矮牵牛瀑布般垂落', unlockRequirement: { level: 14 }, defaultScale: 0.95 },
  { id: 'orn_flora_wall_ivy_trellis', name: '爬墙常春藤架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 6120, starValue: 7, icon: 'orn_flora_wall_ivy_trellis', desc: '木格栅上攀着翠藤与小紫花', unlockRequirement: { level: 15 }, defaultScale: 1.15 },
  ...
  { id: 'workshop_petal_oval_rug', name: '花边流苏地毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 5, icon: 'workshop_petal_oval_rug', desc: '工坊入门：扁平贴地的樱粉花边流苏地毯，一眼看出是毯子', workshopExclusive: true, defaultScale: 1.9, depthSortFloorMat: true, depthSortYLift: 0, decorationPanelTab: 'furniture' },
  { id: 'workshop_petal_oval_rug_moon', name: '天蓝花边流苏地毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 5, icon: 'workshop_petal_oval_rug_moon', desc: '工坊染色：天蓝花边流苏地毯，同款扁平贴地造型', workshopExclusive: true, defaultScale: 1.9, depthSortFloorMat: true, depthSortYLift: 0, decorationPanelTab: 'furniture' },
  { id: 'workshop_petal_oval_rug_honey', name: '蜜黄花边流苏地毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 5, icon: 'workshop_petal_oval_rug_honey', desc: '工坊染色：蜜黄花边流苏地毯，同款扁平贴地造型', workshopExclusive: true, defaultScale: 1.9, depthSortFloorMat: true, depthSortYLift: 0, decorationPanelTab: 'furniture' },
  ...
  { id: 'workshop_giant_rose_bouquet', name: '大捧玫瑰', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 8, icon: 'workshop_giant_rose_bouquet', desc: '工坊匠心：瓷瓶超大捧红玫瑰，满天星与飞燕草点缀，单击含苞与盛放切换', workshopExclusive: true, defaultScale: 0.95, depthSortFeetYFudge: 110, depthSortYLift: 140 },
  { id: 'workshop_bougainvillea_bonsai', name: '三角梅古桩', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 9, icon: 'workshop_bougainvillea_bonsai', desc: '工坊匠心：白陶盆巨型三角梅古桩，单击绿叶与深粉浅粉盛放切换', workshopExclusive: true, defaultScale: 1.72, decorationPanelTab: 'furniture' },
  ...
  { id: 'workshop_moon_sheer_window', name: '月纱长窗', slot: DecoSlot.WALLART, rarity: DecoRarity.LIMITED, cost: 0, starValue: 11, icon: 'workshop_moon_sheer_window', desc: '工坊匠心：高挑暖木长窗，单击切换半透纱帘遮月与纱帘拉到一边见夜景', workshopExclusive: true, defaultScale: 2.72, decorationPanelTab: 'furniture' },
  ...
  { id: 'workshop_cottage_wing_chair', name: '奶油木框沙发椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 8, icon: 'workshop_cottage_wing_chair', desc: '工坊匠心：胡桃木高背配奶油软垫与薄荷菱格抱枕，可四面旋转，最多制作 2 件', workshopExclusive: true, stackable: true, maxOwned: 2, defaultScale: 1.08, decorationPanelTab: 'furniture' },
  { id: 'workshop_round_nest_bed', name: '圆窝软床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 10, icon: 'workshop_round_nest_bed', desc: '工坊匠心：奶白圆形软窝床配正红抱枕，低趴慵懒可染色', workshopExclusive: true, defaultScale: 1.85, decorationPanelTab: 'furniture' },
  { id: 'workshop_round_nest_bed_honey', name: '蜜黄圆窝软床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 10, icon: 'workshop_round_nest_bed_honey', desc: '工坊染色：奶白圆窝配蜜黄抱枕，同款圆形软床', workshopExclusive: true, defaultScale: 1.85, decorationPanelTab: 'furniture' },
  { id: 'workshop_round_nest_bed_sakura', name: '樱粉圆窝软床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 10, icon: 'workshop_round_nest_bed_sakura', desc: '工坊染色：奶油圆窝配樱粉抱枕，同款圆形软床', workshopExclusive: true, defaultScale: 1.85, decorationPanelTab: 'furniture' },
  { id: 'workshop_arc_floor_lamp', name: '弧光落地灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 8, icon: 'workshop_arc_floor_lamp', desc: '工坊匠心：黑弧灯杆配正红灯罩，可染色换罩', workshopExclusive: true, defaultScale: 1.35 },
  { id: 'workshop_arc_floor_lamp_mint', name: '薄荷弧光落地灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 8, icon: 'workshop_arc_floor_lamp_mint', desc: '工坊染色：黑弧灯杆配薄荷绿灯罩，同款弧光造型', workshopExclusive: true, defaultScale: 1.35 },
  { id: 'workshop_blossom_tub', name: '花漾圆浴盆', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 11, icon: 'workshop_blossom_tub', desc: '工坊匠心：奶油圆浴盆，单击切换满水花瓣与空盆搭毛巾', workshopExclusive: true, defaultScale: 1.35, decorationPanelTab: 'furniture' },
  { id: 'workshop_buttercup_daybed', name: '蜜语软床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 9, icon: 'workshop_buttercup_daybed', desc: '工坊匠心：奶油框蜜黄床品，可染色成天蓝色', workshopExclusive: true, defaultScale: 1.75, decorationPanelTab: 'furniture' },
  { id: 'workshop_buttercup_daybed_sky', name: '天空蜜语软床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 9, icon: 'workshop_buttercup_daybed_sky', desc: '工坊染色：奶油框天蓝床品，同款蜜语软床造型', workshopExclusive: true, defaultScale: 1.75, decorationPanelTab: 'furniture' },
  { id: 'workshop_parfait_lounge', name: '霜糖软座', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 10, icon: 'workshop_parfait_lounge', desc: '工坊匠心：丁香蓝双人沙发配粉边条，落地可四面旋转', workshopExclusive: true, defaultScale: 1.68, decorationPanelTab: 'furniture' },
  { id: 'workshop_atelier_bouquet_vase', name: '红袖花艺瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 6, icon: 'workshop_atelier_bouquet_vase', desc: '工坊匠心：鲜红褶瓶插灯笼果与红掌，台面高端花艺摆件', workshopExclusive: true, defaultScale: 0.98, depthSortFeetYFudge: 95, depthSortYLift: 140 },
  { id: 'workshop_atelier_bouquet_vase_blue', name: '青花蓝橙瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 6, icon: 'workshop_atelier_bouquet_vase_blue', desc: '工坊染色：青花执壶插蓝橙撞色花束，同款艺廊花艺造型', workshopExclusive: true, defaultScale: 0.88, depthSortFeetYFudge: 95, depthSortYLift: 140 },
  { id: 'workshop_atelier_bouquet_vase_honey', name: '金紫晨光瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 6, icon: 'workshop_atelier_bouquet_vase_honey', desc: '工坊染色：藕粉瓷瓶插黄紫花束，同款艺廊花艺造型', workshopExclusive: true, defaultScale: 0.88, depthSortFeetYFudge: 95, depthSortYLift: 140 },
  { id: 'workshop_atelier_bouquet_vase_sakura', name: '荷韵青粉瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 6, icon: 'workshop_atelier_bouquet_vase_sakura', desc: '工坊染色：米白瓷瓶插粉荷与青绿花材，同款艺廊花艺造型', workshopExclusive: true, defaultScale: 0.88, depthSortFeetYFudge: 95, depthSortYLift: 140 },

  { id: 'promo_wood_tea_table', name: '原木花茶几', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 359, starValue: 2, icon: 'promo_wood_tea_table', desc: '厚木板小茶几，摆一杯花茶就有午后感', defaultScale: 1.28, decorationPanelTab: 'furniture' },
  ...
  { id: 'early_blush_vine_sofa', name: '藤蔓粉沙发', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 1200, starValue: 6, icon: 'early_blush_vine_sofa', desc: '樱粉软绒双人沙发，奶油坐垫与绿藤点缀，休息角立刻变精致', unlockRequirement: { level: 3 }, defaultScale: 1.58, decorationPanelTab: 'furniture' },
  { id: 'early_oak_island', name: '蜜木岛台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 1499, starValue: 6, icon: 'early_oak_island', desc: '空台面蜜色原木岛台，干净好摆，和初级木作很搭', unlockRequirement: { level: 5 }, defaultScale: 1.28, decorationPanelTab: 'furniture' },
  { id: 'early_sky_vine_tea_table', name: '晴空茶几', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 1280, starValue: 6, icon: 'early_sky_vine_tea_table', desc: '天蓝双层圆角茶几，奶油台面留白，适合配藤蔓粉沙发', unlockRequirement: { level: 4 }, defaultScale: 0.85, decorationPanelTab: 'furniture' },
  { id: 'early_sage_sink_cabinet', name: '青木水池柜', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 2412, starValue: 6, icon: 'early_sage_sink_cabinet', desc: '豆沙绿柜身配暖木台面与白瓷水槽，台面干净无杂物', unlockRequirement: { level: 6 }, defaultScale: 1.22, decorationPanelTab: 'furniture' },
  { id: 'early_ruby_tall_fridge', name: '红宝石冰箱', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 2952, starValue: 6, icon: 'early_ruby_tall_fridge', desc: '高挑酒红双门冰箱，金把手与小花磁贴，比迷你冰箱气派得多', unlockRequirement: { level: 7 }, defaultScale: 1.55, depthSortTopSurfaceHost: true },
  ...
  // 注：starValue 必须为 0 — 月满中秋转盘免费赠予，若计星会被「摆放→拆除→重摆」刷分。
  {
    id: 'event_mid_autumn_mooncake_gift_box',
    name: '月饼礼盒',
    slot: DecoSlot.ORNAMENT,
    rarity: DecoRarity.LIMITED,
    cost: 0,
    starValue: 0,
    icon: 'event_mid_autumn_mooncake_gift_box',
    desc: '朱红金纹天地盖月饼礼盒，转盘抽中即可摆到台面',
    unlockRequirement: {
      questId: 'mid_autumn_reward_mooncake_gift_box',
      conditionText: '活动解锁',
      questDetailText: '月满中秋转盘抽中后解锁',
    },
    defaultScale: 0.62,
    decorationPanelTab: 'furniture',
  },
  {
    id: 'event_mid_autumn_reunion_dining_table',
    name: '团圆餐桌',
    slot: DecoSlot.TABLE,
    rarity: DecoRarity.LIMITED,
    cost: 0,
    starValue: 0,
    icon: 'event_mid_autumn_reunion_dining_table',
    desc: '中秋团圆圆桌，桌上摆满月饼与时令美食',
    unlockRequirement: {
      questId: 'mid_autumn_reward_reunion_dining_table',
      conditionText: '活动解锁',
      questDetailText: '月满中秋转盘抽中后解锁',
    },
    defaultScale: 1.28,
  ...
  {
    id: 'event_mid_autumn_jade_rabbit_doll',
    name: '玉兔玩偶',
    slot: DecoSlot.ORNAMENT,
    rarity: DecoRarity.LIMITED,
    cost: 0,
    starValue: 0,
    icon: 'event_mid_autumn_jade_rabbit_doll',
    desc: '转盘中心同款白绒玉兔玩偶，金如意项圈，可摆上台面',
    unlockRequirement: {
      questId: 'mid_autumn_reward_jade_rabbit_doll',
      conditionText: '活动解锁',
      questDetailText: '月满中秋转盘抽中后解锁',
    },
    defaultScale: 0.72,
  },
  { id: 'wallart_lace_curtain', name: '柔纱短帘', slot: DecoSlot.WALLART,  rarity: DecoRarity.FINE,   cost: 300, starValue: 3, icon: 'wallart_lace_curtain', desc: '蕾丝咖啡馆风情', unlockRequirement: { level: 4 }, defaultScale: 1.8 },
  { id: 'wallart_cream_lace_rod_curtain', name: '奶白蕾丝短帘', slot: DecoSlot.WALLART, rarity: DecoRarity.COMMON, cost: 100, starValue: 2, icon: 'wallart_cream_lace_rod_curtain', desc: '暖木帘杆配奶白蕾丝短帘，绣花边温柔贴墙', unlockRequirement: { level: 1 }, defaultScale: 1.8 },
  { id: 'wallart_rose_swag_drape', name: '玫瑰垂幔墙帘', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 1100, starValue: 4, icon: 'wallart_rose_swag_drape', desc: '暖木帘杆配樱粉垂幔与玫瑰扎饰，等距墙面透视', unlockRequirement: { level: 6 }, defaultScale: 1.85 },
  { id: 'garden_wood_trough', name: '木质长花箱',   slot: DecoSlot.GARDEN,   rarity: DecoRarity.COMMON, cost: 252, starValue: 3, icon: 'garden_wood_trough', desc: '一长条春天开在门口', unlockRequirement: { level: 2 }, defaultScale: 0.97 },

  // ═══════ ⑧ 家具 / 家电扩展（NB2 批次：躺椅、桌凳、收音机风扇等）═══════
  { id: 'orn_lounge_chaise',    name: '布艺躺椅',     slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE,   cost: 4055,  starValue: 9, icon: 'orn_lounge_chaise',    desc: '花店里偷个懒的贵妃榻', unlockRequirement: { level: 9 },  defaultScale: 1.13, decorationPanelTab: 'furniture' },
  { id: 'table_round_cafe',     name: '小圆桌',       slot: DecoSlot.TABLE,    rarity: DecoRarity.COMMON, cost: 534,  starValue: 3, icon: 'table_round_cafe',     desc: '一杯花茶刚好', unlockRequirement: { level: 3 },  defaultScale: 1.05,  decorationPanelTab: 'furniture' },
  { id: 'table_square_bistro',  name: '方桌',         slot: DecoSlot.TABLE,    rarity: DecoRarity.COMMON, cost: 648,  starValue: 3, icon: 'table_square_bistro',  desc: '方正好用的边角桌', unlockRequirement: { level: 4 },  defaultScale: 1.1,  decorationPanelTab: 'furniture' },
  { id: 'orn_wood_stools_pair', name: '原木双凳',     slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 398,  starValue: 2, icon: 'orn_wood_stools_pair', desc: '两把圆凳排排坐', unlockRequirement: { level: 3 },  defaultScale: 0.73, decorationPanelTab: 'furniture' },
  { id: 'orn_rocking_chair',    name: '摇椅',         slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE,   cost: 3645,  starValue: 5, icon: 'orn_rocking_chair',    desc: '慢慢摇，闻花香', unlockRequirement: { level: 9 },  defaultScale: 0.98, decorationPanelTab: 'furniture' },
  ...
  { id: 'light_kettle_pastel',  name: '电热水壶',     slot: DecoSlot.LIGHT,   rarity: DecoRarity.COMMON, cost: 430,  starValue: 2, icon: 'light_kettle_pastel',  desc: '泡茶泡咖啡都靠它', unlockRequirement: { level: 5 },  defaultScale: 0.36 },
  { id: 'light_humidifier_cute', name: '桌面加湿器',  slot: DecoSlot.LIGHT,   rarity: DecoRarity.FINE,   cost: 500,  starValue: 2, icon: 'light_humidifier_cute', desc: '给小花加一点湿润', unlockRequirement: { level: 6 },  defaultScale: 0.36 },

  // ═══════ ⑨ 花房主题（贴图批次：软木板 / 园艺工具 / 地毯 / 衣帽架 / 花车 / 小黑板 / 小盆栽等；面板固定「花房」Tab）═══════
  { id: 'wallart_greenhouse_chalkboard', name: '花房小黑板', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 630, starValue: 2, icon: 'wallart_greenhouse_chalkboard', desc: '户外落地 A 字招牌架，黑白板粉笔「花花」，小花饰点缀', unlockRequirement: { level: 6 }, defaultScale: 1.02, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_shop'] },
  { id: 'orn_greenhouse_cart', name: '软木留言板', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 295, starValue: 1, icon: 'orn_greenhouse_cart', desc: '浅木框软木板，钉着备忘与便签', unlockRequirement: { level: 3 }, defaultScale: 0.78, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_shop'] },
  { id: 'garden_flower_stall', name: '浇水壶与花铲', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 345, starValue: 2, icon: 'garden_flower_stall', desc: '浅蓝壶与木柄铲，精致柔线稿', unlockRequirement: { level: 4 }, defaultScale: 0.65, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_shop'] },
  { id: 'orn_greenhouse_rug', name: '粉色碎花地毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 200, starValue: 3, icon: 'orn_greenhouse_rug', desc: '粉地白花图案的小地垫', unlockRequirement: { level: 2 }, defaultScale: 1.12, depthSortFloorMat: true, decorationPanelTab: 'furniture' },
  { id: 'orn_greenhouse_coat_rack', name: '木轨衣帽挂钩', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 245, starValue: 2, icon: 'orn_greenhouse_coat_rack', desc: '蜜木轨挂着樱粉风衣、薄荷小包与草帽', unlockRequirement: { level: 1 }, defaultScale: 1, decorationPanelTab: 'furniture' },
  { id: 'orn_greenhouse_flower_cart', name: '木轮鲜花推车', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 1500, starValue: 4, icon: 'orn_greenhouse_flower_cart', desc: '装满蔷薇与郁金香的双轮木推车', unlockRequirement: { level: 6 }, defaultScale: 1.05, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_shop'] },
  ...
  { id: 'greenhouse_pot_carnation', name: '康乃馨小盆栽', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 480, starValue: 2, icon: 'greenhouse_pot_carnation', desc: '温柔粉瓣', unlockRequirement: { flowerCollectionItemId: 'flower_fresh_5' }, defaultScale: 0.6, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_shop'] },
  ...
  { id: 'butterfly_house_display_case',  name: '观蝶玻璃柜', slot: DecoSlot.SHELF,    rarity: DecoRarity.RARE,   cost: 3600, starValue: 5, icon: 'butterfly_house_display_case',  desc: '木框玻璃柜里陈列蝶影与枝叶', unlockRequirement: { level: 13 }, defaultScale: 1.78, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_writing_desk',  name: '观蝶书写桌', slot: DecoSlot.TABLE,    rarity: DecoRarity.FINE,   cost: 3600,  starValue: 4, icon: 'butterfly_house_writing_desk',  desc: '记录观察笔记的小书桌，静静贴着墙角', unlockRequirement: { level: 12 }, defaultScale: 1.12, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_sofa',          name: '蝶翼双人沙发', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 4320, starValue: 6, icon: 'butterfly_house_sofa',          desc: '柔软靠背像展开的蝶翼，适合小憩', unlockRequirement: { level: 12 }, defaultScale: 1.38, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  ...
  { id: 'butterfly_house_study_field_stool', name: '野趣折叠凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 2200, starValue: 2, icon: 'butterfly_house_study_field_stool', desc: '木架帆布折叠凳，侧挂小布包，适合温室野趣角', unlockRequirement: { level: 10 }, defaultScale: 0.68, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  ...
  { id: 'butterfly_house_study_microscope_desk', name: '显微镜观察台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 2930, starValue: 3, icon: 'butterfly_house_study_microscope_desk', desc: '浅木桌上摆着黄铜显微镜、蝶类图鉴与彩铅', unlockRequirement: { level: 12 }, defaultScale: 1.62, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_moon_specimen_shelf', name: '蝶标标本柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 3400, starValue: 4, icon: 'butterfly_house_moon_specimen_shelf', desc: '浅木陈列柜分层展示框装蝶标，下层玻璃门收纳册', unlockRequirement: { level: 13 }, defaultScale: 1.65, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_aurora_terrarium', name: '幻彩蝴蝶温室', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 3855, starValue: 4, icon: 'butterfly_house_aurora_terrarium', desc: '幻彩玻璃罩温室里长着发光小花，一只蝶影停驻', unlockRequirement: { level: 13 }, defaultScale: 1.68, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_moon_crescent_rug', name: '新月针织毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 3970, starValue: 3, icon: 'butterfly_house_moon_crescent_rug', desc: '奶油针织毯卷着淡紫新月边，铺出柔软阅读角', unlockRequirement: { level: 14 }, defaultScale: 1.25, depthSortYLift: 0, depthSortFloorMat: true, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_moon_star_chair', name: '星纹观蝶椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 4420, starValue: 4, icon: 'butterfly_house_moon_star_chair', desc: '浅木扶手椅配雾蓝软垫与星形抱枕，月辉小憩位', unlockRequirement: { level: 14 }, defaultScale: 1.38, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },

  // 花店/庭院通用 — 奶油别墅风（Lv10-14，花坊家具 Tab）
  { id: 'villa_planter_urn', name: '玫瑰花卉瓮', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 3295, starValue: 4, icon: 'villa_planter_urn', desc: '陶瓮盛满浅粉玫瑰，摆在庭院或门廊都很体面', unlockRequirement: { level: 10 }, defaultScale: 1.32, decorationPanelTab: 'garden' },
  ...
  { id: 'villa_gilded_mirror', name: '鎏金玫瑰镜', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 2835, starValue: 3, icon: 'villa_gilded_mirror', desc: '椭圆鎏金框镜顶缀三朵玫瑰，墙面立刻贵气起来', unlockRequirement: { level: 12 }, defaultScale: 1.22 },
  { id: 'villa_rose_armoire', name: '玫瑰顶衣柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 3325, starValue: 4, icon: 'villa_rose_armoire', desc: '奶油白立柜顶饰粉玫瑰，单门单屉收纳花艺杂物', unlockRequirement: { level: 13 }, defaultScale: 1.78, decorationPanelTab: 'furniture' },
  { id: 'villa_chester_sofa', name: '豆沙切斯特沙发', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 35000, starValue: 7, icon: 'villa_chester_sofa', desc: '豆沙粉绗缝双人沙发，金钉滚边与深木短腿，客厅立刻贵气', unlockRequirement: { level: 36 }, defaultScale: 1.75, decorationPanelTab: 'furniture' },

  // ═══════ ⑩.5 奶油轻奢厨餐（通用场景 · Lv35–37；冰箱/烤箱灶进家电 LIGHT）═══════
  { id: 'villa_kitchen_island', name: '奶油中岛橱柜', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 58000, starValue: 8, icon: 'villa_kitchen_island', desc: '奶油柜身配淡石台面与金龙头，开放厨房的中心岛', unlockRequirement: { level: 35 }, defaultScale: 1.55, decorationPanelTab: 'furniture' },
  { id: 'villa_kitchen_fridge', name: '高柜双门冰箱', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 54000, starValue: 8, icon: 'villa_kitchen_fridge', desc: '奶油双门冰箱配香槟金把手，轻奢厨房标配家电', unlockRequirement: { level: 35 }, defaultScale: 1.62, depthSortTopSurfaceHost: true },
  { id: 'villa_dining_long_table', name: '橡木长餐桌', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 56000, starValue: 8, icon: 'villa_dining_long_table', desc: '蜂蜜橡木长桌铺奶油桌旗，四人餐位立刻像样', unlockRequirement: { level: 36 }, defaultScale: 1.48, decorationPanelTab: 'furniture' },
  { id: 'villa_dining_chair_pair', name: '高背丝绒餐椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 41200, starValue: 6, icon: 'villa_dining_chair_pair', desc: '豆沙高背丝绒餐椅，金钉滚边，一把就撑起餐桌仪式感', unlockRequirement: { level: 36 }, defaultScale: 1.12, decorationPanelTab: 'furniture' },
  { id: 'villa_kitchen_pendant', name: '奶油双炉烤箱灶', slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE, cost: 43800, starValue: 7, icon: 'villa_kitchen_pendant', desc: '奶油双层烤箱配四眼灶台与金旋钮，厨房烟火核心', unlockRequirement: { level: 37 }, defaultScale: 1.48 },
  { id: 'villa_kitchen_sideboard', name: '餐边收纳柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 52500, starValue: 8, icon: 'villa_kitchen_sideboard', desc: '奶油餐边柜配浅木台面，碗碟与花瓶都有了归宿', unlockRequirement: { level: 37 }, defaultScale: 1.52, decorationPanelTab: 'furniture' },

  // ═══════ ⑩.6 花园别墅专属家具（garden_villa · ≥Lv36 · 法式沙龙 / 月光卧室）═══════
  { id: 'villa_salon_curved_sofa', name: '弧形玫瑰沙发', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 52000, starValue: 8, icon: 'villa_salon_curved_sofa', desc: '豆沙玫瑰弧形双人沙发，奶油滚边与深木短腿，沙龙客厅焦点', unlockRequirement: { level: 36 }, defaultScale: 1.78, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  { id: 'villa_salon_marble_tea', name: '玫瑰花座茶几', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 42000, starValue: 7, icon: 'villa_salon_marble_tea', desc: '玫瑰浮雕花座托起粉纹大理石面，沙龙客厅一眼认出的贵气茶几', unlockRequirement: { level: 36 }, defaultScale: 1.28, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  { id: 'villa_salon_armchair', name: '金钉丝绒单椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 38600, starValue: 6, icon: 'villa_salon_armchair', desc: '豆沙丝绒单人椅，金钉滚边与圆润靠背，配沙发刚刚好', unlockRequirement: { level: 36 }, defaultScale: 1.22, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  { id: 'villa_salon_floor_lamp', name: '玫瑰花柱落地灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE, cost: 39500, starValue: 6, icon: 'villa_salon_floor_lamp', desc: '大理石柱缠金玫瑰藤，顶端盛开玻璃花罩，客厅雕塑感照明', unlockRequirement: { level: 36 }, defaultScale: 1.42, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  { id: 'villa_salon_rose_rug', name: '玫瑰花瓣圆毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 35800, starValue: 6, icon: 'villa_salon_rose_rug', desc: '奶油绒毯配玫瑰花瓣边，铺出沙龙客厅的柔软焦点', unlockRequirement: { level: 37 }, defaultScale: 1.85, depthSortFloorMat: true, depthSortYLift: 0, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  { id: 'villa_salon_console', name: '玫瑰玄关柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 55500, starValue: 8, icon: 'villa_salon_console', desc: '奶油立柜顶饰粉玫瑰，香槟金把手收纳进门杂物', unlockRequirement: { level: 37 }, defaultScale: 1.55, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  { id: 'villa_salon_crystal_chandelier', name: '水晶落地烛台', slot: DecoSlot.LIGHT, rarity: DecoRarity.LIMITED, cost: 98000, starValue: 12, icon: 'villa_salon_crystal_chandelier', desc: '大理石座托起多层水晶枝臂与暖烛，落地可摆的沙龙镇宅灯火', unlockRequirement: { level: 38 }, defaultScale: 1.55, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  { id: 'villa_moon_nightstand', name: '月纹床头柜', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 38800, starValue: 7, icon: 'villa_moon_nightstand', desc: '淡紫奶油床头柜，月牙拉手闪着睡前微光', unlockRequirement: { level: 36 }, defaultScale: 1.12, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  { id: 'villa_moon_bedside_lamp', name: '月华水晶球灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE, cost: 39200, starValue: 6, icon: 'villa_moon_bedside_lamp', desc: '新月托着发光水晶球，珍珠垂饰，床头柜上的月光雕塑', unlockRequirement: { level: 37 }, defaultScale: 0.78, depthSortFeetYFudge: 110, depthSortYLift: 140, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  { id: 'villa_moon_wardrobe', name: '高挑丝绒衣柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 62000, starValue: 9, icon: 'villa_moon_wardrobe', desc: '高挑双门衣柜缀淡紫丝绒嵌板，卧室收纳也贵气', unlockRequirement: { level: 38 }, defaultScale: 1.72, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  { id: 'villa_moon_vanity', name: '星光好莱坞妆台', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 58500, starValue: 8, icon: 'villa_moon_vanity', desc: '拱形灯泡镜框配淡紫丝绒妆台与单凳，现代别墅梳妆角', unlockRequirement: { level: 38 }, defaultScale: 1.52, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  { id: 'villa_moon_floor_mirror', name: '拱形全身镜', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 40800, starValue: 7, icon: 'villa_moon_floor_mirror', desc: '香槟金拱形落地镜，照出整套月光卧室造型', unlockRequirement: { level: 37 }, defaultScale: 1.55, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  { id: 'villa_moon_canopy_bed', name: '丝绒靠背大床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 128000, starValue: 14, icon: 'villa_moon_canopy_bed', desc: '宽厚云翼丝绒床头配低矮平台床体，现代别墅卧室王座', unlockRequirement: { level: 38 }, defaultScale: 1.95, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  { id: 'villa_pearl_grand_piano', name: '珍珠白贵妃榻', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 150000, starValue: 15, icon: 'villa_pearl_grand_piano', desc: '珍珠白绗缝贵妃榻配玫瑰抱枕，别墅卧室最昂贵的一处慵懒', unlockRequirement: { level: 38 }, defaultScale: 1.75, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },

  // ═══════ ⑩ 高星主题珍藏（常驻；id 沿用旧季节套以兼容存档）═══════

  { id: 'season_spring_shelf', name: '樱花花架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 4690, starValue: 10, icon: 'shelf_spring', desc: '樱花藤架纸灯笼，轻线稿卵石底', unlockRequirement: { level: 8 }, defaultScale: 2.05, decorationPanelTab: 'garden' },
  ...
  { id: 'season_summer_light', name: '向日葵灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.COMMON, cost: 290, starValue: 1, icon: 'light_summer', desc: '阳光感的向日葵造型灯具', unlockRequirement: { level: 3 }, defaultScale: 0.53 },
  { id: 'season_summer_garden', name: '花园喷泉', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 4680, starValue: 6, icon: 'garden_summer', desc: '三层石喷泉，自然草边无菱形草皮', unlockRequirement: { level: 9 }, defaultScale: 1.68 },
  {
  ...
  { id: 'season_autumn_table', name: '枫叶柜台', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 3360, starValue: 5, icon: 'table_autumn', desc: '铺满红叶的木质柜台', unlockRequirement: { level: 10 }, defaultScale: 1.48 },
  ...
  { id: 'season_winter_orn', name: '节庆壁炉', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 3205, starValue: 6, icon: 'orn_christmas', desc: '圣诞袜花环灯串，精致柔线稿', unlockRequirement: { level: 10 }, defaultScale: 1.3, decorationPanelTab: 'furniture' },
  ...
  { id: 'deco_late_lv8_shelf_01', name: '迷你冷藏柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 936, starValue: 4, icon: 'deco_late_lv8_shelf_01', desc: '樱粉圆角双门小冷柜，里面是冰饮和小花瓶', unlockRequirement: { level: 5 }, defaultScale: 1.22 },
  ...
  { id: 'deco_late_lv9_wall_01', name: '青柠水彩画', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 3055, starValue: 7, icon: 'deco_late_lv9_wall_01', desc: '黄绿青柠切片与水彩晕染长幅，无文字', unlockRequirement: { level: 9 }, defaultScale: 1.6 },
  { id: 'deco_late_lv9_table_01', name: '礼品中岛台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 799, starValue: 4, icon: 'deco_late_lv9_table_01', desc: '背板彩纸卷与丝带，台面花束和礼盒摆得清爽好看', unlockRequirement: { level: 5 }, defaultScale: 1.12, decorationPanelTab: 'furniture' },
  ...
  { id: 'deco_late_lv10_orn_01', name: '迷你洗手台', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 3915, starValue: 5, icon: 'deco_late_lv10_orn_01', desc: '半高柜+小椭圆镜+陶瓷盆与古铜龙头，角落实用', unlockRequirement: { level: 10 }, defaultScale: 1.2, decorationPanelTab: 'furniture' },
  ...
  { id: 'deco_lv14_wall_butterfly_clock', name: '月蝶壁钟', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 3025, starValue: 5, icon: 'deco_lv14_wall_butterfly_clock', desc: '淡紫蝶翼外框的小壁钟，没有数字，像月光停在墙上', unlockRequirement: { level: 14 }, defaultScale: 0.7 },
  { id: 'deco_lv14_light_blossom_sconce', name: '花露壁灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE, cost: 3025, starValue: 6, icon: 'deco_lv14_light_blossom_sconce', desc: '玫瑰金花枝托起露珠灯罩，给蝶园套做温柔过渡', unlockRequirement: { level: 14 }, defaultScale: 0.62 },
  { id: 'deco_lv15_garden_pool', name: '海盐小泳池', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 6200, starValue: 15, icon: 'deco_lv15_garden_pool', desc: '奶油白浅池配海盐蓝水面，像把夏天摆进庭院', unlockRequirement: { level: 15 }, defaultScale: 2.22, decorationPanelTab: 'garden' },
  { id: 'deco_lv15_garden_parasol', name: '海风遮阳伞', slot: DecoSlot.GARDEN, rarity: DecoRarity.RARE, cost: 5760, starValue: 8, icon: 'deco_lv15_garden_parasol', desc: '海盐蓝条纹大伞，浅柚木伞柄与小花盆底座', unlockRequirement: { level: 12 }, defaultScale: 1.65, decorationPanelTab: 'garden' },
  { id: 'deco_lv15_light_drink_cooler', name: '海盐饮品冰柜', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 5040, starValue: 7, icon: 'deco_lv15_light_drink_cooler', desc: '薄荷蓝小冰柜，玻璃门里排着清爽瓶饮与花冰块', unlockRequirement: { level: 11 }, defaultScale: 0.85 },
  { id: 'deco_lv16_orn_hanging_chair', name: '藤编吊篮秋千', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 8315, starValue: 6, icon: 'deco_lv16_orn_hanging_chair', desc: '柚木支架吊起藤编篮椅，珊瑚抱枕带来度假感', unlockRequirement: { level: 16 }, defaultScale: 1.58, decorationPanelTab: 'furniture' },
  { id: 'deco_lv16_wall_shell_mirror', name: '贝壳壁挂镜', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 6300, starValue: 6, icon: 'deco_lv16_wall_shell_mirror', desc: '贝壳弧形镜框点缀小珍珠，墙面多了一点海风', unlockRequirement: { level: 16 }, defaultScale: 0.85 },
  { id: 'deco_lv16_garden_coral_planter', name: '珊瑚花箱', slot: DecoSlot.GARDEN, rarity: DecoRarity.RARE, cost: 6805, starValue: 8, icon: 'deco_lv16_garden_coral_planter', desc: '珊瑚色长花箱盛着海风小花，和泳池伞组自然成套', unlockRequirement: { level: 16 }, defaultScale: 1.22, decorationPanelTab: 'garden' },
  { id: 'deco_lv17_shelf_surfboard', name: '冲浪板花架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 7810, starValue: 10, icon: 'deco_lv17_shelf_surfboard', desc: '旧冲浪板改成竖向花架，薄荷蓝与珊瑚花盆呼应海滨套', unlockRequirement: { level: 17 }, defaultScale: 1.55, decorationPanelTab: 'garden' },
  { id: 'deco_lv17_table_terrace_bar', name: '露台折叠吧台', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 9070, starValue: 7, icon: 'deco_lv17_table_terrace_bar', desc: '浅柚木折叠吧台配冰饮托盘，适合海边露台角落', unlockRequirement: { level: 17 }, defaultScale: 1.22, decorationPanelTab: 'furniture' },
  { id: 'deco_lv17_orn_seabreeze_rug', name: '海风圆地毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 6300, starValue: 5, icon: 'deco_lv17_orn_seabreeze_rug', desc: '厚织物圆地毯，抬高软包边与流苏让休闲区更像坐垫', unlockRequirement: { level: 17 }, defaultScale: 1.22, depthSortFloorMat: true, decorationPanelTab: 'furniture' },
  { id: 'deco_lv18_shelf_moon_glasshouse', name: '月光玻璃温室柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 9070, starValue: 7, icon: 'deco_lv18_shelf_moon_glasshouse', desc: '香槟金玻璃小温室，月光蓝蝶影与水晶花盆陈列其中', unlockRequirement: { level: 18 }, defaultScale: 1.3, decorationPanelTab: 'furniture' },
  { id: 'deco_lv18_light_firefly_lamp', name: '星萤庭院灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 7310, starValue: 9, icon: 'deco_lv18_light_firefly_lamp', desc: '月蓝玻璃灯罩里闪着星萤光点，适合蝶屋夜色', unlockRequirement: { level: 18 }, defaultScale: 1.35 },
  { id: 'deco_lv18_garden_butterfly_arch', name: '蝶翼月光拱门', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 10835, starValue: 8, icon: 'deco_lv18_garden_butterfly_arch', desc: '香槟金拱门展开半透明蝶翼，月光蓝水晶点亮庭院入口', unlockRequirement: { level: 18 }, defaultScale: 2.02, decorationPanelTab: 'garden' },
  { id: 'deco_lv19_wall_crystal_specimen', name: '水晶标本墙', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 8315, starValue: 12, icon: 'deco_lv19_wall_crystal_specimen', desc: '香槟金展示框里封存蝶翼水晶与干花标本，精致但无文字', unlockRequirement: { level: 19 }, defaultScale: 0.78 },
  { id: 'deco_lv19_orn_crescent_chaise', name: '月牙贵妃榻', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 9830, starValue: 8, icon: 'deco_lv19_orn_crescent_chaise', desc: '月牙形软榻配淡紫丝绒靠垫，适合高级休息角', unlockRequirement: { level: 19 }, defaultScale: 1.18, decorationPanelTab: 'furniture' },
  { id: 'orn_mint_utility_cart', name: '薄荷绿双层推车', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 6800, starValue: 3, icon: 'orn_mint_utility_cart', desc: '薄荷绿金属架配木板下层与白线筐，收纳小物很方便', unlockRequirement: { level: 19 }, defaultScale: 1.05 },
  // ═══════ Lv19/21/23/24 补档（该段家具偏少；价位对齐同级花店向）═══════
  { id: 'orn_mint_tea_tray', name: '薄荷茶盘组', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 5200, starValue: 4, icon: 'orn_mint_tea_tray', desc: '木纹茶盘配白瓷壶杯与小扇，台面立刻有午后茶香', unlockRequirement: { level: 19 }, defaultScale: 0.68, depthSortFeetYFudge: 95, depthSortYLift: 140 },
  { id: 'orn_scroll_blossom_vase', name: '卷轴花纹瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 4860, starValue: 4, icon: 'orn_scroll_blossom_vase', desc: '奶油瓷瓶插着粉彩卷轴，书桌与柜台都好看', unlockRequirement: { level: 21 }, defaultScale: 0.72, depthSortFeetYFudge: 95, depthSortYLift: 140 },
  { id: 'light_cream_globe_sconce', name: '奶油云灯壁挂', slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE, cost: 6420, starValue: 5, icon: 'light_cream_globe_sconce', desc: '暖木臂托着发光奶油灯笼，粉流苏轻轻晃', unlockRequirement: { level: 23 }, defaultScale: 1.12 },
  { id: 'wallart_tall_ice_lattice_partition', name: '冰裂纹窄隔断', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 8960, starValue: 7, icon: 'wallart_tall_ice_lattice_partition', desc: '窄高暖木冰裂纹格扇，空月洞透光，比矮屏风更高挑', unlockRequirement: { level: 23 }, defaultScale: 2.2 },
  { id: 'light_retro_pastel_radio', name: '粉彩复古收音机', slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE, cost: 6780, starValue: 5, icon: 'light_retro_pastel_radio', desc: '豆沙粉机身配蜜黄提手，卡带窗与彩色小按钮很俏皮', unlockRequirement: { level: 24 }, defaultScale: 0.68, depthSortFeetYFudge: 120 },
  // ═══════ 奶油云灯同风格套装（密度偏低的中前段：Lv13/14/18/19）═══════
  { id: 'wallart_cottage_cream_wall_shelf', name: '奶油花串壁架', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 4280, starValue: 4, icon: 'wallart_cottage_cream_wall_shelf', desc: '暖木单层壁架，小花瓶与豆沙粉流苏花串，墙上立刻有下午茶感', unlockRequirement: { level: 13 }, defaultScale: 1.05 },
  { id: 'light_cottage_cream_floor_lamp', name: '奶油弧木落地灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE, cost: 5120, starValue: 5, icon: 'light_cottage_cream_floor_lamp', desc: '蜜木弧臂挂着暖光奶油灯球，豆沙粉流苏轻轻晃', unlockRequirement: { level: 14 }, defaultScale: 1.52 },
  { id: 'table_cottage_cream_side_table', name: '奶油扇贝侧几', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 5860, starValue: 5, icon: 'table_cottage_cream_side_table', desc: '鼓形奶油软包侧几，扇贝台沿上搁一只小花瓶，最配同款单人椅', unlockRequirement: { level: 18 }, defaultScale: 0.95, decorationPanelTab: 'furniture' },
  { id: 'orn_cottage_cream_armchair', name: '奶油软包单人椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 7240, starValue: 6, icon: 'orn_cottage_cream_armchair', desc: '圆润奶油软椅配豆沙粉靠垫与薄荷绿钮扣小枕，蜜木短脚很稳', unlockRequirement: { level: 19 }, defaultScale: 1.18, decorationPanelTab: 'furniture' },
  { id: 'deco_lv19_table_stardust_aroma', name: '星砂香氛台', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 7560, starValue: 10, icon: 'deco_lv19_table_stardust_aroma', desc: '圆角香氛小台摆着星砂玻璃瓶、月白托盘与迷你花束', unlockRequirement: { level: 19 }, defaultScale: 0.98, decorationPanelTab: 'furniture' },
  { id: 'deco_lv20_garden_moon_fountain', name: '月辉喷泉雕塑', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 10610, starValue: 11, icon: 'deco_lv20_garden_moon_fountain', desc: '月牙水晶喷泉与蝶翼雕塑组成庭院压轴大件', unlockRequirement: { level: 20 }, defaultScale: 1.4, decorationPanelTab: 'garden' },
  { id: 'deco_lv20_shelf_star_observatory', name: '星月观景陈列柜', slot: DecoSlot.SHELF, rarity: DecoRarity.LIMITED, cost: 13560, starValue: 10, icon: 'deco_lv20_shelf_star_observatory', desc: '小型观景台式陈列柜，玻璃穹顶里摆着星月花器', unlockRequirement: { level: 20 }, defaultScale: 1.32, decorationPanelTab: 'furniture' },
  { id: 'deco_lv20_wall_moon_sheer_curtain', name: '月纱蝶影帘', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 10760, starValue: 14, icon: 'deco_lv20_wall_moon_sheer_curtain', desc: '挂墙半透明月光纱帘，香槟金帘杆与蝶影坠饰让墙面更轻盈', unlockRequirement: { level: 20 }, defaultScale: 1.8 },
  ...
  { id: 'deco_lv11_wallart_zen_ink_scroll', name: '水墨竹影挂轴', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 3600, starValue: 4, icon: 'deco_lv11_wallart_zen_ink_scroll', desc: '宣纸卷轴绘水墨竹与一点粉梅，配暖木轴头', unlockRequirement: { level: 11 }, defaultScale: 1.40 },

  // —— 蘑菇精灵套（坐墩+圆桌+陈列屋+精灵丛；童话森林感，适配蝶屋竹影房）——
  { id: 'deco_lv12_orn_mushroom_stool_pair', name: '蘑菇坐墩组', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 3600, starValue: 4, icon: 'deco_lv12_orn_mushroom_stool_pair', desc: '一红一米双蘑菇坐墩，森系小客座', unlockRequirement: { level: 12 }, defaultScale: 0.85, decorationPanelTab: 'furniture' },
  { id: 'deco_lv12_orn_petal_oval_rug_honey', name: '蜜黄花瓣椭圆地毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 3980, starValue: 5, icon: 'deco_lv12_orn_petal_oval_rug_honey', desc: '奶油底蜜黄花瓣边椭圆毯，暖暖铺一角下午茶', unlockRequirement: { level: 12 }, defaultScale: 1.35, depthSortFloorMat: true, depthSortYLift: 0, decorationPanelTab: 'furniture' },
  { id: 'deco_lv13_table_mushroom_round', name: '蘑菇圆茶桌', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 3600, starValue: 5, icon: 'deco_lv13_table_mushroom_round', desc: '粉色蘑菇伞盖做桌面，奶白菌柄做底座', unlockRequirement: { level: 13 }, defaultScale: 0.9, decorationPanelTab: 'furniture' },
  { id: 'deco_lv14_shelf_mushroom_cottage', name: '蘑菇小屋陈列架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 3325, starValue: 8, icon: 'deco_lv14_shelf_mushroom_cottage', desc: '蘑菇屋造型陈列架，三层拱形格放小花盆', unlockRequirement: { level: 14 }, defaultScale: 1.35 },
  { id: 'deco_lv15_garden_mushroom_grove', name: '蘑菇精灵丛', slot: DecoSlot.GARDEN, rarity: DecoRarity.RARE, cost: 6480, starValue: 9, icon: 'deco_lv15_garden_mushroom_grove', desc: '三色蘑菇与苔藓丛，配萤火虫提灯', unlockRequirement: { level: 12 }, defaultScale: 1.60, decorationPanelTab: 'garden' },

  // —— 法式咖啡烘焙套（甜品柜+手冲架+复古烤箱+马卡龙塔；适配复古花坊 confetti）——
  { id: 'deco_lv13_table_french_pastry_counter', name: '法式甜品玻璃柜', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 4320, starValue: 6, icon: 'deco_lv13_table_french_pastry_counter', desc: '奶薄荷柜身配玻璃罩，里面摆着马卡龙与小塔', unlockRequirement: { level: 13 }, defaultScale: 1.30, decorationPanelTab: 'furniture' },
  { id: 'deco_lv14_shelf_handbrew_coffee_bar', name: '手冲咖啡架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 3175, starValue: 7, icon: 'deco_lv14_shelf_handbrew_coffee_bar', desc: '蜜木双层架配手冲套与豆罐，店里多一个咖啡角', unlockRequirement: { level: 14 }, defaultScale: 1.30 },
  { id: 'deco_lv15_light_vintage_oven', name: '奶黄复古烤箱', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 5760, starValue: 8, icon: 'deco_lv15_light_vintage_oven', desc: '圆胖奶黄烤箱，玻璃门里看见可颂在烤', unlockRequirement: { level: 12 }, defaultScale: 0.65 },
  { id: 'deco_lv16_orn_macaron_tower', name: '马卡龙塔', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 6300, starValue: 5, icon: 'deco_lv16_orn_macaron_tower', desc: '三层瓷盘配粉黄紫蓝马卡龙，下午茶担当', unlockRequirement: { level: 16 }, defaultScale: 0.78 },

  // —— 古董图书套（书架+地球仪桌+切斯特皮椅+植物标本；dark academia，适配复古/月辉）——
  { id: 'deco_lv15_shelf_antique_library', name: '复古胡桃书架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 6480, starValue: 9, icon: 'deco_lv15_shelf_antique_library', desc: '维多利亚胡桃木书架，皮革精装书与黄铜地球仪', unlockRequirement: { level: 12 }, defaultScale: 1.45 },
  { id: 'deco_lv16_table_globe_writing_desk', name: '地球仪写字桌', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 7560, starValue: 9, icon: 'deco_lv16_table_globe_writing_desk', desc: '小巧胡桃木书桌，黄铜浑天仪、羽毛笔与压花玻璃罩', unlockRequirement: { level: 16 }, defaultScale: 1.08, decorationPanelTab: 'furniture' },
  { id: 'deco_lv17_orn_chesterfield_armchair', name: '切斯特皮扶手椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 8190, starValue: 6, icon: 'deco_lv17_orn_chesterfield_armchair', desc: '酒红绗缝皮扶手椅，配胡桃短腿与亚麻盖毯', unlockRequirement: { level: 17 }, defaultScale: 0.98, decorationPanelTab: 'furniture' },
  { id: 'deco_lv18_wallart_botanical_taxonomy', name: '植物标本框', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 6300, starValue: 6, icon: 'deco_lv18_wallart_botanical_taxonomy', desc: '胡桃画框配米色羊皮纸，六格压花标本无文字', unlockRequirement: { level: 18 }, defaultScale: 1.10 },

  // —— 极光晶莹套（镜面池+水晶球+落地灯；月光蝶园色系延伸）——
  { id: 'deco_lv17_garden_aurora_mirror_pond', name: '极光镜面池', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 10330, starValue: 8, icon: 'deco_lv17_garden_aurora_mirror_pond', desc: '奶白卵石围出极光水镜，浮叶莲与水晶星簇', unlockRequirement: { level: 17 }, defaultScale: 1.95, decorationPanelTab: 'garden' },
  { id: 'deco_lv18_orn_aurora_crystal_orb', name: '极光水晶球', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 6805, starValue: 7, icon: 'deco_lv18_orn_aurora_crystal_orb', desc: '玻璃球里漾着极光雾与小弦月，香槟金三脚架托起', unlockRequirement: { level: 18 }, defaultScale: 0.45 },
  { id: 'deco_lv19_light_aurora_floor_lantern', name: '极光落地灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 7810, starValue: 11, icon: 'deco_lv19_light_aurora_floor_lantern', desc: '香槟金细杆托起雾面玻璃灯罩，灯罩里流动极光蓝紫', unlockRequirement: { level: 19 }, defaultScale: 1.30 },

  // —— 云端漫游套（云朵软墩+棉花云中岛+云秋千；棉花糖粉蓝，适配粉蓝/月辉）——
  { id: 'deco_lv18_orn_cloud_pouf_set', name: '云朵软墩组', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 6550, starValue: 6, icon: 'deco_lv18_orn_cloud_pouf_set', desc: '一大一小云朵造型软墩，奶白与浅粉刺绣小星', unlockRequirement: { level: 18 }, defaultScale: 1.05, decorationPanelTab: 'furniture' },
  { id: 'deco_lv19_table_cloud_dessert_island', name: '棉花云中岛', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 8570, starValue: 7, icon: 'deco_lv19_table_cloud_dessert_island', desc: '云朵造型桌面带粉色糖霜流挂，香槟金弯腿与小甜点', unlockRequirement: { level: 19 }, defaultScale: 1, decorationPanelTab: 'furniture' },
  { id: 'deco_lv20_garden_cloud_swing', name: '云端长秋千', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 14005, starValue: 10, icon: 'deco_lv20_garden_cloud_swing', desc: '云朵长椅吊在香槟金 A 形架上，弦月坠与星形抱枕', unlockRequirement: { level: 20 }, defaultScale: 1.9, decorationPanelTab: 'garden' },
  ...
  { id: 'deco_lv10_orn_petal_oval_rug', name: '樱粉花瓣椭圆地毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 2680, starValue: 4, icon: 'deco_lv10_orn_petal_oval_rug', desc: '奶油底樱粉花瓣边椭圆毯，温柔铺出客厅焦点', unlockRequirement: { level: 10 }, defaultScale: 1.35, depthSortFloorMat: true, depthSortYLift: 0, decorationPanelTab: 'furniture' },
  { id: 'deco_lv11_orn_cat_tower', name: '樱桃猫爬架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 3600, starValue: 4, icon: 'deco_lv11_orn_cat_tower', desc: '蜜木立柱+缠绳+樱桃形顶台与粉色软垫', unlockRequirement: { level: 11 }, defaultScale: 0.9, decorationPanelTab: 'furniture' },
  { id: 'deco_lv11_orn_petal_oval_rug_sky', name: '天蓝花瓣椭圆地毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 3280, starValue: 4, icon: 'deco_lv11_orn_petal_oval_rug_sky', desc: '奶油底天蓝花瓣边椭圆毯，清爽一铺就亮堂', unlockRequirement: { level: 11 }, defaultScale: 1.35, depthSortFloorMat: true, depthSortYLift: 0, decorationPanelTab: 'furniture' },
  { id: 'deco_lv11_light_phonograph_vintage', name: '古董留声机', slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE, cost: 3600, starValue: 4, icon: 'deco_lv11_light_phonograph_vintage', desc: '胡桃木底座配黄铜花喇叭，唱针架在黑胶上', unlockRequirement: { level: 11 }, defaultScale: 0.65 },
  { id: 'deco_lv12_orn_pastel_postbox', name: '草莓邮筒', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 3000, starValue: 3, icon: 'deco_lv12_orn_pastel_postbox', desc: '草莓粉立式邮筒，圆胖身段与小信件露出', unlockRequirement: { level: 12 }, defaultScale: 1.1 },
  { id: 'deco_lv13_orn_teddy_armchair', name: '泰迪熊扶手椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 3600, starValue: 5, icon: 'deco_lv13_orn_teddy_armchair', desc: '小熊造型椅背，焦糖蜜色绒面，配奶色小毯', unlockRequirement: { level: 13 }, defaultScale: 0.85, decorationPanelTab: 'furniture' },
  { id: 'deco_lv14_orn_carousel_music_box', name: '旋转木马音乐盒', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 3100, starValue: 7, icon: 'deco_lv14_orn_carousel_music_box', desc: '奶粉色基座配香槟金螺旋柱与三匹粉绿玫瑰木马', unlockRequirement: { level: 14 }, defaultScale: 0.65 },
  { id: 'deco_lv15_light_terrarium_lamp', name: '玻璃花房灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 5040, starValue: 7, icon: 'deco_lv15_light_terrarium_lamp', desc: '尖顶玻璃罩做小温室，里面有暖黄灯泡与小花苔藓', unlockRequirement: { level: 11 }, defaultScale: 0.65 },
  { id: 'modern_pastel_capsule_shelf', name: '马卡龙胶囊柜', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 5040, starValue: 6, icon: 'modern_pastel_capsule_shelf', desc: '拱顶奶油柜格里摆满玻璃罩小物，薄荷底座抽屉很治愈', unlockRequirement: { level: 15 }, defaultScale: 1.45, decorationPanelTab: 'furniture' },
  { id: 'deco_lv16_wallart_harbor_arch_window', name: '海港拱窗景', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 6930, starValue: 8, icon: 'deco_lv16_wallart_harbor_arch_window', desc: '奶白拱窗框里收着金色海港落日，有小帆船与玫瑰窗台', unlockRequirement: { level: 16 }, defaultScale: 1.30 },
  { id: 'tree_canopy_bed', name: '树冠小床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 19800, starValue: 8, icon: 'tree_canopy_bed', desc: '枝桠四柱床垂着奶油纱幔，苔绿叶纹被窝软乎乎', unlockRequirement: { level: 32 }, defaultScale: 1.85, decorationPanelTab: 'flower_room', allowedSceneIds: ['forest_treehouse'] },
  { id: 'deco_lv20_orn_white_grand_piano', name: '白色三角钢琴', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 49895, starValue: 13, icon: 'deco_lv20_orn_white_grand_piano', desc: '奶白漆三角钢琴，香槟金腿与玫瑰花束、水晶烛台', unlockRequirement: { level: 20 }, defaultScale: 1.5, decorationPanelTab: 'furniture' },
  { id: 'jiangnan_wash_bench', name: '临河浣衣凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 5310, starValue: 2, icon: 'jiangnan_wash_bench', desc: '旧木矮凳叠着白布，底下藤篮装着浣衣日常', unlockRequirement: { level: 20 }, defaultScale: 0.95, decorationPanelTab: 'furniture' },
  ...
  { id: 'modern_wall_fairy_lights', name: '节日星星串灯', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 27065, starValue: 6, icon: 'modern_wall_fairy_lights', desc: '星星月亮小挂灯串，墙面多一点节日暖光', unlockRequirement: { level: 28 }, defaultScale: 1.25 },
  ...
  // ═══════ 明亮浴室生活线（浴缸/地毯/马桶/隔断 + 少见生活件，Lv28–32）═══════
  { id: 'modern_sakura_clawfoot_tub', name: '樱粉爪足浴缸', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 36800, starValue: 8, icon: 'modern_sakura_clawfoot_tub', desc: '樱粉陶瓷爪足浴缸，水面漂着泡沫与花瓣，泡澡角立刻变精致', unlockRequirement: { level: 28 }, defaultScale: 1.32, decorationPanelTab: 'furniture' },
  { id: 'modern_mint_blossom_toilet', name: '薄荷绿花盖马桶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 24600, starValue: 5, icon: 'modern_mint_blossom_toilet', desc: '薄荷绿瓷身配蜜桃盖，盖面小花浮雕，浴室必备萌系洁具', unlockRequirement: { level: 28 }, defaultScale: 0.98, decorationPanelTab: 'furniture' },
  { id: 'modern_lemon_stripe_bath_rug', name: '柠檬条纹浴室毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 18800, starValue: 4, icon: 'modern_lemon_stripe_bath_rug', desc: '柠檬黄与奶油条纹椭圆地垫，薄荷滚边点缀小雏菊', unlockRequirement: { level: 28 }, defaultScale: 1.55, depthSortFloorMat: true, depthSortYLift: 0, decorationPanelTab: 'furniture' },
  { id: 'modern_coral_glass_bath_screen', name: '珊瑚玻璃浴屏', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 31200, starValue: 7, icon: 'modern_coral_glass_bath_screen', desc: '珊瑚粉金属框配磨砂玻璃双扇屏，淡花影隔出清爽浴区', unlockRequirement: { level: 29 }, defaultScale: 1.42 },
  { id: 'modern_peach_vanity_sink', name: '蜜桃洗手台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 27800, starValue: 6, icon: 'modern_peach_vanity_sink', desc: '蜜桃粉柜身配奶白台面与金龙头，上方薄荷小圆镜', unlockRequirement: { level: 29 }, defaultScale: 1.35, decorationPanelTab: 'furniture' },
  { id: 'modern_sky_front_washer', name: '天蓝滚筒洗衣机', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 33500, starValue: 7, icon: 'modern_sky_front_washer', desc: '明亮天蓝前开滚筒，门内透出柔色衣物，洗衣角生活感满满', unlockRequirement: { level: 30 }, defaultScale: 1.12, depthSortTopSurfaceHost: true },
  { id: 'modern_sunshine_towel_warmer', name: '暖阳毛巾架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 25600, starValue: 5, icon: 'modern_sunshine_towel_warmer', desc: '蜜金管状落地毛巾加热架，挂着珊瑚与薄荷绿蓬松毛巾', unlockRequirement: { level: 30 }, defaultScale: 1.25, decorationPanelTab: 'furniture' },
  { id: 'modern_cloud_standing_mirror', name: '云朵落地镜', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 29800, starValue: 6, icon: 'modern_cloud_standing_mirror', desc: '淡紫奶油云朵镜框配暖木支架，全身镜也软萌可爱', unlockRequirement: { level: 31 }, defaultScale: 1.38, decorationPanelTab: 'furniture' },
  { id: 'modern_berry_laundry_hamper', name: '浆果藤编洗衣篮', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 16200, starValue: 4, icon: 'modern_berry_laundry_hamper', desc: '浆果粉藤编圆篮配薄荷绿盖，盖缝透出柔软毛巾', unlockRequirement: { level: 31 }, defaultScale: 0.95, decorationPanelTab: 'furniture' },
  { id: 'modern_rainbow_umbrella_stand', name: '花盆雨伞架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 21400, starValue: 5, icon: 'modern_rainbow_umbrella_stand', desc: '珊瑚陶瓷花盆造型伞架，插着天蓝蜜黄淡紫三把收起的伞', unlockRequirement: { level: 32 }, defaultScale: 0.85, decorationPanelTab: 'furniture' },
  ...
  { id: 'modern_balcony_drying_cabinet', name: '暖风烘衣柜', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 25150, starValue: 7, icon: 'modern_balcony_drying_cabinet', desc: '透明小烘衣柜挂着柔色衣物，顶部一盆薰衣草压住生活感', unlockRequirement: { level: 30 }, defaultScale: 1.35 },
  ...
  { id: 'modern_countertop_icecream_machine', name: '软冰淇淋机', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 26485, starValue: 8, icon: 'modern_countertop_icecream_machine', desc: '薄荷奶油色冰淇淋机，两个小甜筒刚好接住软雪糕，适合厨柜台面', unlockRequirement: { level: 24 }, defaultScale: 0.72, depthSortFeetYFudge: 130 },
  ...
  { id: 'tea_paper_lantern', name: '和纸行灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE, cost: 4500, starValue: 4, icon: 'tea_paper_lantern', desc: '竹骨和纸落地行灯，暖黄柔光把茶寮照得静静的', unlockRequirement: { level: 15 }, defaultScale: 1 },
  ...
  // ═══════ ⑭.6b 橡树小屋森系家具（forest_treehouse Lv32–38 · 树洞客厅/卧眠）
  { id: 'tree_bookshelf_hollow', name: '空心树书架', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 28800, starValue: 7, icon: 'tree_bookshelf_hollow', desc: '掏空树干里塞满彩色书脊，中间还蹲着一只小猫头鹰', unlockRequirement: { level: 32 }, defaultScale: 1.65, decorationPanelTab: 'flower_room', allowedSceneIds: ['forest_treehouse'] },
  { id: 'tree_stump_table', name: '木桩茶几', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 24500, starValue: 6, icon: 'tree_stump_table', desc: '年轮桌面托着小花茶壶与两只茶杯，树屋下午茶角', unlockRequirement: { level: 33 }, defaultScale: 1.15, decorationPanelTab: 'flower_room', allowedSceneIds: ['forest_treehouse'] },
  { id: 'tree_hammock_chair', name: '藤绳吊篮椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 26800, starValue: 7, icon: 'tree_hammock_chair', desc: '麻绳编织的圆吊椅配鼠尾草绿垫，挂在枝桠上轻轻晃', unlockRequirement: { level: 34 }, defaultScale: 1.55, decorationPanelTab: 'flower_room', allowedSceneIds: ['forest_treehouse'] },
  { id: 'tree_star_lamp', name: '藤星吊灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE, cost: 19800, starValue: 6, icon: 'tree_star_lamp', desc: '藤枝编成的圆笼吊灯，暖黄星串垂下来像萤火虫', unlockRequirement: { level: 35 }, defaultScale: 1.45, decorationPanelTab: 'flower_room', allowedSceneIds: ['forest_treehouse'] },
  { id: 'tree_moon_window', name: '年轮星空窗', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 17600, starValue: 5, icon: 'tree_moon_window', desc: '厚木圆窗框里映着深蓝星空，树屋夜里最安静的一角', unlockRequirement: { level: 36 }, defaultScale: 1.48, decorationPanelTab: 'flower_room', allowedSceneIds: ['forest_treehouse'] },
  { id: 'tree_wardrobe_round', name: '蘑菇圆衣柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 31200, starValue: 8, icon: 'tree_wardrobe_round', desc: '木桶身顶着红棕蘑菇盖，小蘑菇把手一拧就能开柜', unlockRequirement: { level: 37 }, defaultScale: 1.45, decorationPanelTab: 'flower_room', allowedSceneIds: ['forest_treehouse'] },
  { id: 'tree_nightstand', name: '树洞床头柜', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 22800, starValue: 6, icon: 'tree_nightstand', desc: '矮树桩抽屉柜，台上放着橡果小灯与一本睡前书', unlockRequirement: { level: 38 }, defaultScale: 1.05, decorationPanelTab: 'flower_room', allowedSceneIds: ['forest_treehouse'] },

  // ═══════ ⑭.7 梦云小屋专属家具（dream_cloud_house Lv20–24 · 梦幻卧室休闲套）
  { id: 'dream_cloud_bed', name: '月云大软床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 49140, starValue: 9, icon: 'dream_cloud_bed', desc: '云朵床框托起浅紫绗缝被，月亮与星星抱枕软乎乎地窝在床头', unlockRequirement: { level: 20 }, defaultScale: 1.95, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },
  { id: 'dream_cloud_sofa', name: '星月转角沙发', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 41275, starValue: 9, icon: 'dream_cloud_sofa', desc: '奶油白大转角沙发配粉紫蓝抱枕，像睡前云朵客厅一样柔软', unlockRequirement: { level: 20 }, defaultScale: 2.18, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },
  ...
  { id: 'cake_shelf_layered_display',     name: '分层蛋糕展示柜', slot: DecoSlot.SHELF,    rarity: DecoRarity.LIMITED, cost: 7810, starValue: 11, icon: 'cake_shelf_layered_display',     desc: '蜜木+黄铜玻璃三层柜，奶油蛋糕与马卡龙的招牌门面', unlockRequirement: { level: 16 }, defaultScale: 1.5,  decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_shelf_baking_pantry',       name: '烘焙原料架',     slot: DecoSlot.SHELF,    rarity: DecoRarity.FINE,    cost: 3780, starValue: 5,  icon: 'cake_shelf_baking_pantry',       desc: '蜜木双层架配奶油盖玻璃罐：面粉、糖、可可与彩糖', unlockRequirement: { level: 15 }, defaultScale: 1.25, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_shelf_chilled_cabinet',     name: '草莓冷藏甜品柜', slot: DecoSlot.SHELF,    rarity: DecoRarity.RARE,    cost: 6805, starValue: 8,  icon: 'cake_shelf_chilled_cabinet',     desc: '粉色立柜玻璃门内排着马卡龙慕斯与小蛋糕', unlockRequirement: { level: 17 }, defaultScale: 1.18, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_shelf_fondant_flowers',     name: '翻糖花展示架',   slot: DecoSlot.SHELF,    rarity: DecoRarity.FINE,    cost: 6300, starValue: 6,  icon: 'cake_shelf_fondant_flowers',     desc: '奶白杆配三层圆台，摆着多彩翻糖花与糖珠', unlockRequirement: { level: 16 }, defaultScale: 1.05, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_table_workstation',         name: '甜品制作工作台', slot: DecoSlot.TABLE,    rarity: DecoRarity.FINE,    cost: 3935, starValue: 6,  icon: 'cake_table_workstation',         desc: '蜜木大理石台，搅拌钵、挤花袋与翻糖小球一字排开', unlockRequirement: { level: 15 }, defaultScale: 1.30, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_table_register_counter',    name: '蛋糕收银台',     slot: DecoSlot.TABLE,    rarity: DecoRarity.RARE,    cost: 6680, starValue: 8,  icon: 'cake_table_register_counter',    desc: '草莓粉柜身配大理石面，复古收银机与玻璃钟罩马卡龙', unlockRequirement: { level: 16 }, defaultScale: 1.30, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_table_round_dessert',       name: '甜品分享小圆桌', slot: DecoSlot.TABLE,    rarity: DecoRarity.COMMON,  cost: 3780,  starValue: 3,  icon: 'cake_table_round_dessert',       desc: '奶白扇贝边圆桌，两份小蛋糕与单枝粉玫瑰', unlockRequirement: { level: 15 }, defaultScale: 1.05, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_table_gift_wrap',           name: '礼盒打包台',     slot: DecoSlot.TABLE,    rarity: DecoRarity.FINE,    cost: 6300, starValue: 6,  icon: 'cake_table_gift_wrap',           desc: '蜜木台面背靠多色缎带卷，奶油礼盒与黄铜剪刀', unlockRequirement: { level: 17 }, defaultScale: 1.18, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_table_dessert_island',      name: '甜点中岛长桌',   slot: DecoSlot.TABLE,    rarity: DecoRarity.RARE,    cost: 7185, starValue: 9,  icon: 'cake_table_dessert_island',      desc: '奶白长桌带粉色糖霜流挂，香槟金腿与一排小甜点', unlockRequirement: { level: 18 }, defaultScale: 1.40, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_light_pink_double_oven',    name: '草莓双门烤箱',   slot: DecoSlot.LIGHT,    rarity: DecoRarity.RARE,    cost: 7430, starValue: 10, icon: 'cake_light_pink_double_oven',    desc: '草莓粉立式双门烤箱，门内可见烤盘里的小蛋糕', unlockRequirement: { level: 16 }, defaultScale: 1.30, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_light_stand_mixer',         name: '粉色立式搅拌机', slot: DecoSlot.LIGHT,    rarity: DecoRarity.FINE,    cost: 4235, starValue: 5,  icon: 'cake_light_stand_mixer',         desc: '复古粉立式搅拌机，搅拌缸里堆着奶油尖', unlockRequirement: { level: 15 }, defaultScale: 0.65, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_light_pendant_macaron',     name: '马卡龙塔灯',     slot: DecoSlot.LIGHT,    rarity: DecoRarity.FINE,    cost: 6300, starValue: 6,  icon: 'cake_light_pendant_macaron',     desc: '奶白圆底盘配黄铜立柱，三层粉绿黄马卡龙灯罩柔光发亮', unlockRequirement: { level: 17 }, defaultScale: 1.25, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_light_chocolate_fountain',  name: '巧克力喷泉机',   slot: DecoSlot.LIGHT,    rarity: DecoRarity.RARE,    cost: 6805, starValue: 8,  icon: 'cake_light_chocolate_fountain',  desc: '黄铜螺旋柱与双层流挂巧克力，旁配草莓串与棉花糖', unlockRequirement: { level: 18 }, defaultScale: 0.95, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_orn_strawberry_stool_pair', name: '草莓坐墩组',     slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE,    cost: 3935, starValue: 4,  icon: 'cake_orn_strawberry_stool_pair', desc: '一红一粉两只草莓造型小坐墩，绿叶萼配奶白细腿', unlockRequirement: { level: 15 }, defaultScale: 0.85, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_orn_wedding_cake_centerpiece', name: '婚礼蛋糕台',  slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 12970, starValue: 19, icon: 'cake_orn_wedding_cake_centerpiece', desc: '三层奶白翻糖蛋糕配粉玫瑰与糖珠，瓷台金边', unlockRequirement: { level: 20 }, defaultScale: 1.10, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_orn_donut_cushion_pair',    name: '甜甜圈坐垫组',   slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON,  cost: 6300,  starValue: 3,  icon: 'cake_orn_donut_cushion_pair',    desc: '一大一小甜甜圈造型软垫，粉糖霜与巧克力两味', unlockRequirement: { level: 16 }, defaultScale: 1.00, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_orn_teddy_baker',           name: '烘焙小熊摆件',   slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE,    cost: 6300, starValue: 5,  icon: 'cake_orn_teddy_baker',           desc: '焦糖蜜熊戴厨师帽抱奶油碗，店铺萌系吉祥物', unlockRequirement: { level: 17 }, defaultScale: 0.85, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_wallart_menu_chalkboard',   name: '蛋糕菜单黑板',   slot: DecoSlot.WALLART,  rarity: DecoRarity.FINE,    cost: 3935, starValue: 4,  icon: 'cake_wallart_menu_chalkboard',   desc: '奶粉扇贝木框配森林绿黑板，粉笔画蛋糕剪影与缎带', unlockRequirement: { level: 15 }, defaultScale: 1.20, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_wallart_lollipop_clock',    name: '棒棒糖挂钟',     slot: DecoSlot.WALLART,  rarity: DecoRarity.FINE,    cost: 6300, starValue: 5,  icon: 'cake_wallart_lollipop_clock',    desc: '粉绿白糖纹圆盘配奶白糖棒，黄铜指针无数字', unlockRequirement: { level: 16 }, defaultScale: 0.95, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  { id: 'cake_garden_strawberry_arch',    name: '草莓藤拱门',     slot: DecoSlot.GARDEN,   rarity: DecoRarity.LIMITED, cost: 9830, starValue: 14, icon: 'cake_garden_strawberry_arch',    desc: '奶白拱门缠满草莓藤与白花，门下两盆小草莓', unlockRequirement: { level: 17 }, defaultScale: 2.00, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  ...
  { id: 'qinglian_tea_shelf', name: '清涟茶架', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 1680, starValue: 4, icon: 'qinglian_tea_shelf', desc: '三层 mint 茶具架，紫纱垂帘与盖碗套组', unlockRequirement: { level: 4 }, defaultScale: 1.55, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_lantern_frame', name: '宫灯花架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 3010, starValue: 4, icon: 'qinglian_lantern_frame', desc: '木架悬挂 pastel 宫灯，夜宴花坊氛围', unlockRequirement: { level: 5 }, defaultScale: 2.58, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_scholar_rock', name: '粉晶山石', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 3520, starValue: 5, icon: 'qinglian_scholar_rock', desc: '粉晶玲珑石与祥云木座，案头清供', unlockRequirement: { level: 6 }, defaultScale: 1.25, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_guqin_stand', name: '古琴雅案', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 5010, starValue: 5, icon: 'qinglian_guqin_stand', desc: '古琴案几配云纹屏风，紫绿渐变琴身', unlockRequirement: { level: 7 }, defaultScale: 1.4, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_bamboo_window', name: '冰纹花窗', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 7780, starValue: 6, icon: 'qinglian_bamboo_window', desc: '八角冰裂纹花窗，框外淡竹与飞燕剪影', unlockRequirement: { level: 8 }, defaultScale: 1.30, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_wisteria_vanity', name: '紫藤绢屏梳妆台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 11980, starValue: 7, icon: 'qinglian_wisteria_vanity', desc: '浅木梳妆台配三扇紫藤绢屏，仙闺氛围', unlockRequirement: { level: 9 }, defaultScale: 1.55, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_cloud_book_desk', name: '祥云书案', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 12880, starValue: 7, icon: 'qinglian_cloud_book_desk', desc: '浅木书案配祥云腿雕，青瓷笔架与素卷', unlockRequirement: { level: 10 }, defaultScale: 1.30, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_moon_shelf', name: '月洞博古架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 14400, starValue: 8, icon: 'qinglian_moon_shelf', desc: '月洞门博古架，格内青瓷与粉牡丹小品', unlockRequirement: { level: 11 }, defaultScale: 1.85, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_peony_screen', name: '牡丹圆光屏风', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 15120, starValue: 8, icon: 'qinglian_peony_screen', desc: '三扇绢屏绘牡丹百合，圆光淡粉边', unlockRequirement: { level: 12 }, defaultScale: 2.02, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_cherry_wardrobe', name: '樱霞轻衣柜', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 15520, starValue: 8, icon: 'qinglian_cherry_wardrobe', desc: '奶油木衣柜配樱花板面，祥云形淡金拉手', unlockRequirement: { level: 13 }, defaultScale: 1.75, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_silk_daybed', name: '流纱罗汉榻', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 15880, starValue: 9, icon: 'qinglian_silk_daybed', desc: '浅木罗汉榻配薄荷珊瑚丝垫，流纱轻垂', unlockRequirement: { level: 14 }, defaultScale: 1.75, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_lotus_canopy_bed', name: '莲纱架子床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 18380, starValue: 10, icon: 'qinglian_lotus_canopy_bed', desc: '四柱架子床垂桃荷纱幔，莲纹床帏如梦', unlockRequirement: { level: 15 }, defaultScale: 2.5, decorationPanelTab: 'qinglian' },
