...
export const DECO_DEFS: DecoDef[] = [
  ...
  { id: 'orn_flora_lavender_window_box', name: '薰衣草长条盆', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 7200, starValue: 2, icon: 'orn_flora_lavender_window_box', desc: '白漆木窗盒里一排紫色薰衣草', unlockRequirement: { level: 11 }, defaultScale: 1.18, depthSortFeetYFudge: 0, depthSortYLift: 0 },
  ...
  { id: 'orn_flora_cherry_branch_vase', name: '樱花折枝瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 6800, starValue: 4, icon: 'orn_flora_cherry_branch_vase', desc: '青瓷高瓶插一枝盛放的樱花', unlockRequirement: { level: 13 }, defaultScale: 0.98 },
  ...
  { id: 'orn_flora_wall_ivy_trellis', name: '爬墙常春藤架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 6800, starValue: 7, icon: 'orn_flora_wall_ivy_trellis', desc: '木格栅上攀着翠藤与小紫花', unlockRequirement: { level: 15 }, defaultScale: 1.15 },
  ...
  { id: 'butterfly_house_display_case',  name: '观蝶玻璃柜', slot: DecoSlot.SHELF,    rarity: DecoRarity.RARE,   cost: 4000, starValue: 5, icon: 'butterfly_house_display_case',  desc: '木框玻璃柜里陈列蝶影与枝叶', unlockRequirement: { level: 13 }, defaultScale: 1.78, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  ...
  { id: 'butterfly_house_sofa',          name: '蝶翼双人沙发', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 4800, starValue: 6, icon: 'butterfly_house_sofa',          desc: '柔软靠背像展开的蝶翼，适合小憩', unlockRequirement: { level: 12 }, defaultScale: 1.38, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  ...
  { id: 'butterfly_house_moon_specimen_shelf', name: '蝶标标本柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 3780, starValue: 4, icon: 'butterfly_house_moon_specimen_shelf', desc: '浅木陈列柜分层展示框装蝶标，下层玻璃门收纳册', unlockRequirement: { level: 13 }, defaultScale: 1.65, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_aurora_terrarium', name: '幻彩蝴蝶温室', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 4285, starValue: 4, icon: 'butterfly_house_aurora_terrarium', desc: '幻彩玻璃罩温室里长着发光小花，一只蝶影停驻', unlockRequirement: { level: 13 }, defaultScale: 1.68, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_moon_crescent_rug', name: '新月针织毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 4410, starValue: 3, icon: 'butterfly_house_moon_crescent_rug', desc: '奶油针织毯卷着淡紫新月边，铺出柔软阅读角', unlockRequirement: { level: 14 }, defaultScale: 1.25, depthSortYLift: 0, depthSortFloorMat: true, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_moon_star_chair', name: '星纹观蝶椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 4910, starValue: 4, icon: 'butterfly_house_moon_star_chair', desc: '浅木扶手椅配雾蓝软垫与星形抱枕，月辉小憩位', unlockRequirement: { level: 14 }, defaultScale: 1.38, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },

  // 花店/庭院通用 — 奶油别墅风（Lv10-14，花坊家具 Tab）
  { id: 'villa_planter_urn', name: '玫瑰花卉瓮', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 3660, starValue: 4, icon: 'villa_planter_urn', desc: '陶瓮盛满浅粉玫瑰，摆在庭院或门廊都很体面', unlockRequirement: { level: 10 }, defaultScale: 1.32, decorationPanelTab: 'garden' },
  ...
  { id: 'villa_rose_armoire', name: '玫瑰顶衣柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 3695, starValue: 4, icon: 'villa_rose_armoire', desc: '奶油白立柜顶饰粉玫瑰，单门单屉收纳花艺杂物', unlockRequirement: { level: 13 }, defaultScale: 1.78, decorationPanelTab: 'furniture' },
  ...
  { id: 'season_autumn_table', name: '枫叶柜台', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 3735, starValue: 5, icon: 'table_autumn', desc: '铺满红叶的木质柜台', unlockRequirement: { level: 10 }, defaultScale: 1.48 },
  ...
  { id: 'season_winter_orn', name: '节庆壁炉', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 3560, starValue: 6, icon: 'orn_christmas', desc: '圣诞袜花环灯串，精致柔线稿', unlockRequirement: { level: 10 }, defaultScale: 1.3, decorationPanelTab: 'furniture' },
  ...
  { id: 'deco_late_lv10_orn_01', name: '迷你洗手台', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 4350, starValue: 5, icon: 'deco_late_lv10_orn_01', desc: '半高柜+小椭圆镜+陶瓷盆与古铜龙头，角落实用', unlockRequirement: { level: 10 }, defaultScale: 1.2, decorationPanelTab: 'furniture' },
  ...
  { id: 'deco_lv14_wall_butterfly_clock', name: '月蝶壁钟', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 3360, starValue: 5, icon: 'deco_lv14_wall_butterfly_clock', desc: '淡紫蝶翼外框的小壁钟，没有数字，像月光停在墙上', unlockRequirement: { level: 14 }, defaultScale: 0.7 },
  { id: 'deco_lv14_light_blossom_sconce', name: '花露壁灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE, cost: 3360, starValue: 6, icon: 'deco_lv14_light_blossom_sconce', desc: '玫瑰金花枝托起露珠灯罩，给蝶园套做温柔过渡', unlockRequirement: { level: 14 }, defaultScale: 0.62 },
  { id: 'deco_lv15_garden_pool', name: '海盐小泳池', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 6890, starValue: 15, icon: 'deco_lv15_garden_pool', desc: '奶油白浅池配海盐蓝水面，像把夏天摆进庭院', unlockRequirement: { level: 15 }, defaultScale: 2.22, decorationPanelTab: 'garden' },
  { id: 'deco_lv15_garden_parasol', name: '海风遮阳伞', slot: DecoSlot.GARDEN, rarity: DecoRarity.RARE, cost: 6400, starValue: 8, icon: 'deco_lv15_garden_parasol', desc: '海盐蓝条纹大伞，浅柚木伞柄与小花盆底座', unlockRequirement: { level: 12 }, defaultScale: 1.65, decorationPanelTab: 'garden' },
  { id: 'deco_lv15_light_drink_cooler', name: '海盐饮品冰柜', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 5600, starValue: 7, icon: 'deco_lv15_light_drink_cooler', desc: '薄荷蓝小冰柜，玻璃门里排着清爽瓶饮与花冰块', unlockRequirement: { level: 11 }, defaultScale: 0.85 },
  ...
  { id: 'deco_lv13_table_mushroom_round', name: '蘑菇圆茶桌', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 4000, starValue: 5, icon: 'deco_lv13_table_mushroom_round', desc: '粉色蘑菇伞盖做桌面，奶白菌柄做底座', unlockRequirement: { level: 13 }, defaultScale: 0.9, decorationPanelTab: 'furniture' },
  { id: 'deco_lv14_shelf_mushroom_cottage', name: '蘑菇小屋陈列架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 3695, starValue: 8, icon: 'deco_lv14_shelf_mushroom_cottage', desc: '蘑菇屋造型陈列架，三层拱形格放小花盆', unlockRequirement: { level: 14 }, defaultScale: 1.35 },
  { id: 'deco_lv15_garden_mushroom_grove', name: '蘑菇精灵丛', slot: DecoSlot.GARDEN, rarity: DecoRarity.RARE, cost: 7200, starValue: 9, icon: 'deco_lv15_garden_mushroom_grove', desc: '三色蘑菇与苔藓丛，配萤火虫提灯', unlockRequirement: { level: 12 }, defaultScale: 1.60, decorationPanelTab: 'garden' },

  // —— 法式咖啡烘焙套（甜品柜+手冲架+复古烤箱+马卡龙塔；适配复古花坊 confetti）——
  { id: 'deco_lv13_table_french_pastry_counter', name: '法式甜品玻璃柜', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 4800, starValue: 6, icon: 'deco_lv13_table_french_pastry_counter', desc: '奶薄荷柜身配玻璃罩，里面摆着马卡龙与小塔', unlockRequirement: { level: 13 }, defaultScale: 1.30, decorationPanelTab: 'furniture' },
  { id: 'deco_lv14_shelf_handbrew_coffee_bar', name: '手冲咖啡架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 3530, starValue: 7, icon: 'deco_lv14_shelf_handbrew_coffee_bar', desc: '蜜木双层架配手冲套与豆罐，店里多一个咖啡角', unlockRequirement: { level: 14 }, defaultScale: 1.30 },
  { id: 'deco_lv15_light_vintage_oven', name: '奶黄复古烤箱', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 6400, starValue: 8, icon: 'deco_lv15_light_vintage_oven', desc: '圆胖奶黄烤箱，玻璃门里看见可颂在烤', unlockRequirement: { level: 12 }, defaultScale: 0.65 },
  ...
  { id: 'deco_lv15_shelf_antique_library', name: '复古胡桃书架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 7200, starValue: 9, icon: 'deco_lv15_shelf_antique_library', desc: '维多利亚胡桃木书架，皮革精装书与黄铜地球仪', unlockRequirement: { level: 12 }, defaultScale: 1.45 },
  ...
  { id: 'deco_lv13_orn_teddy_armchair', name: '泰迪熊扶手椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 4000, starValue: 5, icon: 'deco_lv13_orn_teddy_armchair', desc: '小熊造型椅背，焦糖蜜色绒面，配奶色小毯', unlockRequirement: { level: 13 }, defaultScale: 0.85, decorationPanelTab: 'furniture' },
  { id: 'deco_lv14_orn_carousel_music_box', name: '旋转木马音乐盒', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 3445, starValue: 7, icon: 'deco_lv14_orn_carousel_music_box', desc: '奶粉色基座配香槟金螺旋柱与三匹粉绿玫瑰木马', unlockRequirement: { level: 14 }, defaultScale: 0.65 },
  { id: 'deco_lv15_light_terrarium_lamp', name: '玻璃花房灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 5600, starValue: 7, icon: 'deco_lv15_light_terrarium_lamp', desc: '尖顶玻璃罩做小温室，里面有暖黄灯泡与小花苔藓', unlockRequirement: { level: 11 }, defaultScale: 0.65 },
  { id: 'modern_pastel_capsule_shelf', name: '马卡龙胶囊柜', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 5600, starValue: 6, icon: 'modern_pastel_capsule_shelf', desc: '拱顶奶油柜格里摆满玻璃罩小物，薄荷底座抽屉很治愈', unlockRequirement: { level: 15 }, defaultScale: 1.45, decorationPanelTab: 'furniture' },
  ...
  { id: 'tea_paper_lantern', name: '和纸行灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE, cost: 5000, starValue: 4, icon: 'tea_paper_lantern', desc: '竹骨和纸落地行灯，暖黄柔光把茶寮照得静静的', unlockRequirement: { level: 15 }, defaultScale: 1 },
  ...
  { id: 'cake_shelf_baking_pantry',       name: '烘焙原料架',     slot: DecoSlot.SHELF,    rarity: DecoRarity.FINE,    cost: 4200, starValue: 5,  icon: 'cake_shelf_baking_pantry',       desc: '蜜木双层架配奶油盖玻璃罐：面粉、糖、可可与彩糖', unlockRequirement: { level: 15 }, defaultScale: 1.25, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  ...
  { id: 'cake_table_workstation',         name: '甜品制作工作台', slot: DecoSlot.TABLE,    rarity: DecoRarity.FINE,    cost: 4370, starValue: 6,  icon: 'cake_table_workstation',         desc: '蜜木大理石台，搅拌钵、挤花袋与翻糖小球一字排开', unlockRequirement: { level: 15 }, defaultScale: 1.30, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  ...
  { id: 'cake_table_round_dessert',       name: '甜品分享小圆桌', slot: DecoSlot.TABLE,    rarity: DecoRarity.COMMON,  cost: 4200,  starValue: 3,  icon: 'cake_table_round_dessert',       desc: '奶白扇贝边圆桌，两份小蛋糕与单枝粉玫瑰', unlockRequirement: { level: 15 }, defaultScale: 1.05, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  ...
  { id: 'cake_light_stand_mixer',         name: '粉色立式搅拌机', slot: DecoSlot.LIGHT,    rarity: DecoRarity.FINE,    cost: 4705, starValue: 5,  icon: 'cake_light_stand_mixer',         desc: '复古粉立式搅拌机，搅拌缸里堆着奶油尖', unlockRequirement: { level: 15 }, defaultScale: 0.65, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  ...
  { id: 'cake_orn_strawberry_stool_pair', name: '草莓坐墩组',     slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE,    cost: 4370, starValue: 4,  icon: 'cake_orn_strawberry_stool_pair', desc: '一红一粉两只草莓造型小坐墩，绿叶萼配奶白细腿', unlockRequirement: { level: 15 }, defaultScale: 0.85, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
  ...
  { id: 'cake_wallart_menu_chalkboard',   name: '蛋糕菜单黑板',   slot: DecoSlot.WALLART,  rarity: DecoRarity.FINE,    cost: 4370, starValue: 4,  icon: 'cake_wallart_menu_chalkboard',   desc: '奶粉扇贝木框配森林绿黑板，粉笔画蛋糕剪影与缎带', unlockRequirement: { level: 15 }, defaultScale: 1.20, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
