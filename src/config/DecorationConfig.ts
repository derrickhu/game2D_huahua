...
export const DECO_DEFS: DecoDef[] = [
  ...
  { id: 'folk_dragon_bench', name: '龙纹长凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 9000, starValue: 12, icon: 'folk_dragon_bench', desc: '朱漆长凳龙脊靠背，金黄坐垫缀红穗', unlockRequirement: { level: 32 }, defaultScale: 1.75, decorationPanelTab: 'furniture' },
