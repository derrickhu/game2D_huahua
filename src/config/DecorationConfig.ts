...
export const DECO_DEFS: DecoDef[] = [
  ...
  { id: 'workshop_atelier_bouquet_vase', name: '红袖花艺瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 6, icon: 'workshop_atelier_bouquet_vase', desc: '工坊匠心：鲜红褶瓶插灯笼果与红掌，台面高端花艺摆件', workshopExclusive: true, defaultScale: 0.98, decorationPanelTab: 'furniture', depthSortFeetYFudge: 95, depthSortYLift: 140 },
  { id: 'workshop_atelier_bouquet_vase_blue', name: '青花蓝橙瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 6, icon: 'workshop_atelier_bouquet_vase_blue', desc: '工坊染色：青花执壶插蓝橙撞色花束，同款艺廊花艺造型', workshopExclusive: true, defaultScale: 0.88, decorationPanelTab: 'furniture', depthSortFeetYFudge: 95, depthSortYLift: 140 },
  { id: 'workshop_atelier_bouquet_vase_honey', name: '金紫晨光瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 6, icon: 'workshop_atelier_bouquet_vase_honey', desc: '工坊染色：藕粉瓷瓶插黄紫花束，同款艺廊花艺造型', workshopExclusive: true, defaultScale: 0.88, decorationPanelTab: 'furniture', depthSortFeetYFudge: 95, depthSortYLift: 140 },
  { id: 'workshop_atelier_bouquet_vase_sakura', name: '荷韵青粉瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 6, icon: 'workshop_atelier_bouquet_vase_sakura', desc: '工坊染色：米白瓷瓶插粉荷与青绿花材，同款艺廊花艺造型', workshopExclusive: true, defaultScale: 0.88, decorationPanelTab: 'furniture', depthSortFeetYFudge: 95, depthSortYLift: 140 },
