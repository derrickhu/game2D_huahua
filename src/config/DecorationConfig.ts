...
export const DECO_DEFS: DecoDef[] = [
  ...
  { id: 'farm_fu_sticker_wall', name: '福字贴纸', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 20280, starValue: 7, icon: 'farm_fu_sticker_wall', desc: '菱形大红福字贴纸，贴在院墙添年味', unlockRequirement: { level: 34 }, defaultScale: 0.92, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_farm_house'] },
