...
export const DECO_DEFS: DecoDef[] = [
  ...
  { id: 'qinglian_bamboo_window', name: '冰纹花窗', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 3000, starValue: 4, icon: 'qinglian_bamboo_window', desc: '八角冰裂纹花窗，框外淡竹与飞燕剪影', unlockRequirement: { level: 8 }, defaultScale: 1.30, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_wisteria_vanity', name: '紫藤绢屏梳妆台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 4000, starValue: 5, icon: 'qinglian_wisteria_vanity', desc: '浅木梳妆台配三扇紫藤绢屏，仙闺氛围', unlockRequirement: { level: 9 }, defaultScale: 1.55, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_cloud_book_desk', name: '祥云书案', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 3500, starValue: 4, icon: 'qinglian_cloud_book_desk', desc: '浅木书案配祥云腿雕，青瓷笔架与素卷', unlockRequirement: { level: 10 }, defaultScale: 1.30, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_moon_shelf', name: '月洞博古架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 4500, starValue: 6, icon: 'qinglian_moon_shelf', desc: '月洞门博古架，格内青瓷与粉牡丹小品', unlockRequirement: { level: 11 }, defaultScale: 1.85, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_peony_screen', name: '牡丹圆光屏风', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 5000, starValue: 6, icon: 'qinglian_peony_screen', desc: '三扇绢屏绘牡丹百合，圆光淡粉边', unlockRequirement: { level: 12 }, defaultScale: 2.02, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_cherry_wardrobe', name: '樱霞轻衣柜', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 5000, starValue: 5, icon: 'qinglian_cherry_wardrobe', desc: '奶油木衣柜配樱花板面，祥云形淡金拉手', unlockRequirement: { level: 13 }, defaultScale: 1.75, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_silk_daybed', name: '流纱罗汉榻', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 8000, starValue: 7, icon: 'qinglian_silk_daybed', desc: '浅木罗汉榻配薄荷珊瑚丝垫，流纱轻垂', unlockRequirement: { level: 14 }, defaultScale: 1.75, decorationPanelTab: 'qinglian' },
  { id: 'qinglian_lotus_canopy_bed', name: '莲纱架子床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 13000, starValue: 8, icon: 'qinglian_lotus_canopy_bed', desc: '四柱架子床垂桃荷纱幔，莲纹床帏如梦', unlockRequirement: { level: 15 }, defaultScale: 2.5, decorationPanelTab: 'qinglian' },
