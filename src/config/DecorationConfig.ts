...
export const DECO_DEFS: DecoDef[] = [
  ...
  { id: 'shelf_iron',    name: '铁艺旋转架',  slot: DecoSlot.SHELF, rarity: DecoRarity.COMMON, cost: 1002, starValue: 4, icon: 'shelf_iron',   desc: '优雅的法式铁艺风格', unlockRequirement: { level: 7 }, defaultScale: 1.5 },
  { id: 'shelf_glass',   name: '玻璃展示柜',  slot: DecoSlot.SHELF, rarity: DecoRarity.RARE,   cost: 2430, starValue: 6, icon: 'shelf_glass',  desc: '高端玻璃门展示柜', unlockRequirement: { level: 10 }, defaultScale: 1.45 },
  ...
  { id: 'table_drawer',   name: '抽屉式柜台',  slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 1440, starValue: 4, icon: 'table_drawer',  desc: '带抽屉的实用柜台', unlockRequirement: { level: 9 }, defaultScale: 1.23 },
  { id: 'table_work',     name: '花艺工作台',  slot: DecoSlot.TABLE, rarity: DecoRarity.FINE,   cost: 1253, starValue: 3, icon: 'table_work',    desc: '专业的花艺操作台', unlockRequirement: { level: 6 }, defaultScale: 1.38 },
  { id: 'table_marble',   name: '大理石桌',    slot: DecoSlot.TABLE, rarity: DecoRarity.RARE,   cost: 2028, starValue: 7, icon: 'table_marble',  desc: '冷峻优雅的大理石面', unlockRequirement: { level: 9 }, defaultScale: 1.38, decorationPanelTab: 'furniture' },
  ...
  { id: 'light_pendant',  name: '花式吊灯',    slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE,   cost: 950, starValue: 2, icon: 'light_pendant', desc: '花朵造型的精美吊灯', unlockRequirement: { level: 6 }, defaultScale: 1.05 },
  { id: 'light_crystal',  name: '水晶灯',      slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE,   cost: 2328, starValue: 4, icon: 'light_crystal', desc: '华丽的水晶折射光芒', unlockRequirement: { level: 10 }, defaultScale: 1.1 },
  ...
  { id: 'orn_fountain',   name: '迷你喷泉',    slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE,   cost: 1253, starValue: 3, icon: 'orn_fountain',  desc: '轻线稿小喷泉，卵石底无方格地台', unlockRequirement: { level: 6 }, defaultScale: 1.2, decorationPanelTab: 'garden' },
  ...
  { id: 'orn_clock',      name: '复古挂钟',    slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE,   cost: 1272, starValue: 5, icon: 'orn_clock',     desc: '滴答滴答的复古时光', unlockRequirement: { level: 8 }, defaultScale: 0.55 },
  ...
  { id: 'wallart_relief', name: '艺术浮雕',    slot: DecoSlot.WALLART, rarity: DecoRarity.RARE,   cost: 2736, starValue: 3, icon: 'wallart_relief', desc: '精致的花卉浮雕壁饰', unlockRequirement: { level: 10 }, defaultScale: 0.67 },
  { id: 'wallart_window_meadow_arch', name: '拱窗花野景', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 2472, starValue: 4, icon: 'wallart_window_meadow_arch', desc: '奶油木拱窗里收进一片花野与蝶影', unlockRequirement: { level: 10 }, defaultScale: 1.32 },
  { id: 'wallart_window_lake_round',  name: '圆窗湖雾景', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 2100, starValue: 6, icon: 'wallart_window_lake_round',  desc: '复古圆窗映着薄雾湖景，像温室外的安静清晨', unlockRequirement: { level: 12 }, defaultScale: 1.28 },
  ...
  { id: 'garden_arch',     name: '玫瑰花廊',   slot: DecoSlot.GARDEN, rarity: DecoRarity.RARE,   cost: 2898, starValue: 9, icon: 'garden_arch',     desc: '双拱玫瑰廊轻线稿，无菱形草皮', unlockRequirement: { level: 7 }, defaultScale: 2.13 },
  { id: 'garden_zen',      name: '日式枯山水', slot: DecoSlot.GARDEN, rarity: DecoRarity.RARE, cost: 1584, starValue: 6, icon: 'garden_zen',      desc: '柔线枯山水浅皿，无硬方框', unlockRequirement: { level: 8 }, defaultScale: 1.63 },
  ...
  { id: 'table_rattan_twoset', name: '藤编边桌凳组', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE,   cost: 799,  starValue: 4, icon: 'table_rattan_twoset', desc: '圆几配双凳，度假风下午茶', unlockRequirement: { level: 3 }, defaultScale: 1.13, decorationPanelTab: 'furniture' },
  { id: 'light_plant_strip',  name: '植物补光灯',   slot: DecoSlot.LIGHT,   rarity: DecoRarity.FINE,   cost: 870,  starValue: 3, icon: 'light_plant_strip',  desc: '阴天也给小花一点阳光', unlockRequirement: { level: 7 },  defaultScale: 0.57 },
  { id: 'orn_window_garden',  name: '窗台花园组',   slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 1390,  starValue: 3, icon: 'orn_window_garden',  desc: '三盆小花排排站', unlockRequirement: { level: 6 }, defaultScale: 0.87 },
  ...
  { id: 'orn_flora_blooming_cactus', name: '开花仙人球', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 6000, starValue: 1, icon: 'orn_flora_blooming_cactus', desc: '陶盆里的圆滚滚仙人掌，顶着一朵艳粉花', unlockRequirement: { level: 7 }, defaultScale: 0.52 },
  { id: 'orn_flora_fern_terrarium', name: '蕨类生态瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 7200, starValue: 1, icon: 'orn_flora_fern_terrarium', desc: '软木塞玻璃罐里迷你苔藓与蕨叶', unlockRequirement: { level: 8 }, defaultScale: 0.48 },
  { id: 'orn_flora_hyacinth_glass_vase', name: '风信子水培瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 8400, starValue: 2, icon: 'orn_flora_hyacinth_glass_vase', desc: '球形玻璃瓶里紫粉风信子簇', unlockRequirement: { level: 9 }, defaultScale: 0.72 },
  { id: 'orn_flora_wildflower_mason_jar', name: '野花花束罐', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 9600, starValue: 1, icon: 'orn_flora_wildflower_mason_jar', desc: '蓝色梅森罐扎着虞美人与矢车菊', unlockRequirement: { level: 10 }, defaultScale: 0.76 },
  ...
  { id: 'wallart_rose_swag_drape', name: '玫瑰垂幔墙帘', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 1000, starValue: 4, icon: 'wallart_rose_swag_drape', desc: '暖木帘杆配樱粉垂幔与玫瑰扎饰，等距墙面透视', unlockRequirement: { level: 2 }, defaultScale: 1.85 },
  ...
  { id: 'orn_lounge_chaise',    name: '布艺躺椅',     slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE,   cost: 2898,  starValue: 9, icon: 'orn_lounge_chaise',    desc: '花店里偷个懒的贵妃榻', unlockRequirement: { level: 9 },  defaultScale: 0.93, decorationPanelTab: 'furniture' },
  ...
  { id: 'orn_rocking_chair',    name: '摇椅',         slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE,   cost: 2604,  starValue: 8, icon: 'orn_rocking_chair',    desc: '慢慢摇，闻花香', unlockRequirement: { level: 9 },  defaultScale: 0.98, decorationPanelTab: 'furniture' },
  { id: 'table_side_round',     name: '大理石小边几', slot: DecoSlot.TABLE,    rarity: DecoRarity.FINE,   cost: 1440,  starValue: 3, icon: 'table_side_round',     desc: '放一盆小绿植刚好', unlockRequirement: { level: 8 },  defaultScale: 0.97, decorationPanelTab: 'furniture' },
  { id: 'light_radio_vintage',  name: '复古收音机',   slot: DecoSlot.LIGHT,   rarity: DecoRarity.FINE,   cost: 1440,  starValue: 3, icon: 'light_radio_vintage',  desc: '店里轻声放老歌', unlockRequirement: { level: 8 },  defaultScale: 0.36 },
  ...
  { id: 'light_humidifier_cute', name: '桌面加湿器',  slot: DecoSlot.LIGHT,   rarity: DecoRarity.FINE,   cost: 1026,  starValue: 2, icon: 'light_humidifier_cute', desc: '给小花加一点湿润', unlockRequirement: { level: 6 },  defaultScale: 0.36 },
  ...
  { id: 'orn_greenhouse_flower_cart', name: '木轮鲜花推车', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 1584, starValue: 3, icon: 'orn_greenhouse_flower_cart', desc: '装满蔷薇与郁金香的双轮木推车', unlockRequirement: { level: 6 }, defaultScale: 1.05, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_shop'] },
  ...
  { id: 'butterfly_house_display_case',  name: '观蝶玻璃柜', slot: DecoSlot.SHELF,    rarity: DecoRarity.RARE,   cost: 3150, starValue: 5, icon: 'butterfly_house_display_case',  desc: '木框玻璃柜里陈列蝶影与枝叶', unlockRequirement: { level: 13 }, defaultScale: 1.78, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_writing_desk',  name: '观蝶书写桌', slot: DecoSlot.TABLE,    rarity: DecoRarity.FINE,   cost: 2100,  starValue: 4, icon: 'butterfly_house_writing_desk',  desc: '记录观察笔记的小书桌，静静贴着墙角', unlockRequirement: { level: 12 }, defaultScale: 1.12, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_sofa',          name: '蝶翼双人沙发', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 2100, starValue: 6, icon: 'butterfly_house_sofa',          desc: '柔软靠背像展开的蝶翼，适合小憩', unlockRequirement: { level: 12 }, defaultScale: 1.38, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_wicker_chair',  name: '藤编休闲椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE,   cost: 1805,  starValue: 3, icon: 'butterfly_house_wicker_chair',  desc: '轻盈藤编椅，把温室角落变成阅读位', unlockRequirement: { level: 11 }, defaultScale: 0.98, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_tea_table',     name: '圆茶几', slot: DecoSlot.TABLE,        rarity: DecoRarity.COMMON, cost: 1440,  starValue: 2, icon: 'butterfly_house_tea_table',     desc: '圆润小茶几，摆上点心就很有氛围', unlockRequirement: { level: 8 }, defaultScale: 0.96, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  { id: 'butterfly_house_wall_frame',    name: '蝶影挂画', slot: DecoSlot.WALLART,    rarity: DecoRarity.FINE,   cost: 1440,  starValue: 2, icon: 'butterfly_house_wall_frame',    desc: '把蝴蝶标本感做成柔和挂画，适合干净墙面', unlockRequirement: { level: 8 }, defaultScale: 0.88, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  // 蝴蝶小屋扩展（Lv10-14，观蝶/月辉/野趣套）
  { id: 'butterfly_house_study_field_stool', name: '野趣折叠凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 2208, starValue: 2, icon: 'butterfly_house_study_field_stool', desc: '木架帆布折叠凳，侧挂小布包，适合温室野趣角', unlockRequirement: { level: 10 }, defaultScale: 0.88, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  ...
  { id: 'villa_planter_urn', name: '玫瑰花卉瓮', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 4536, starValue: 4, icon: 'villa_planter_urn', desc: '陶瓮盛满浅粉玫瑰，摆在庭院或门廊都很体面', unlockRequirement: { level: 10 }, defaultScale: 1.32, decorationPanelTab: 'garden' },
  { id: 'villa_wrought_bench', name: '铁艺粉垫长椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 2835, starValue: 3, icon: 'villa_wrought_bench', desc: '深灰铁艺雕花靠背配粉色软垫，庭园休憩经典款', unlockRequirement: { level: 11 }, defaultScale: 1.65, decorationPanelTab: 'furniture' },
  ...
  { id: 'season_spring_shelf', name: '樱花花架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 3474, starValue: 10, icon: 'shelf_spring', desc: '樱花藤架纸灯笼，轻线稿卵石底', unlockRequirement: { level: 8 }, defaultScale: 1.85, decorationPanelTab: 'garden' },
  { id: 'season_spring_wall', name: '樱花挂画', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 2898, starValue: 8, icon: 'wallart_spring', desc: '鎏金框油画风樱花径，等距墙面透视', unlockRequirement: { level: 8 }, defaultScale: 0.81 },
  ...
  { id: 'season_summer_garden', name: '花园喷泉', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 4056, starValue: 11, icon: 'garden_summer', desc: '三层石喷泉，自然草边无菱形草皮', unlockRequirement: { level: 9 }, defaultScale: 1.68 },
  { id: 'season_autumn_orn', name: '南瓜灯笼', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 2898, starValue: 6, icon: 'orn_pumpkin', desc: '暖色调丰收风灯笼', unlockRequirement: { level: 9 }, defaultScale: 0.65 },
  { id: 'season_autumn_table', name: '枫叶柜台', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 3954, starValue: 5, icon: 'table_autumn', desc: '铺满红叶的木质柜台', unlockRequirement: { level: 10 }, defaultScale: 1.48 },
  { id: 'season_winter_wallart', name: '复古落地钟', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 2160, starValue: 7, icon: 'wallart_winter', desc: '胡桃木落地钟，柔线稿无数字', unlockRequirement: { level: 9 }, defaultScale: 1.34, decorationPanelTab: 'furniture' },
  { id: 'season_winter_orn', name: '节庆壁炉', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 4560, starValue: 6, icon: 'orn_christmas', desc: '圣诞袜花环灯串，精致柔线稿', unlockRequirement: { level: 10 }, defaultScale: 1.3, decorationPanelTab: 'furniture' },
  ...
  { id: 'deco_late_lv7_table_01', name: '豆沙绿圆桌', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 924, starValue: 3, icon: 'deco_late_lv7_table_01', desc: '细白搪瓷桌面、豆沙绿弯腿，配一杯花茶与小卡片', unlockRequirement: { level: 7 }, defaultScale: 0.95, decorationPanelTab: 'furniture' },
  { id: 'deco_late_lv7_wall_01', name: '干花三联框', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 810, starValue: 3, icon: 'deco_late_lv7_wall_01', desc: '浅橡木三联标本格，等距墙面透视', unlockRequirement: { level: 7 }, defaultScale: 0.92 },
  { id: 'deco_late_lv8_garden_01', name: '染井吉野樱', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 4632, starValue: 12, icon: 'deco_late_lv8_garden_01', desc: '透明底仅树干与树根，无地砖；冠幅浅粉樱花', unlockRequirement: { level: 9 }, defaultScale: 2.8, decorationPanelTab: 'garden' },
  ...
  { id: 'deco_late_lv8_light_01', name: '爱迪生壁灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 1314, starValue: 5, icon: 'deco_late_lv8_light_01', desc: '浅橡木支架+古铜小灯罩，单颗暖黄爱迪生灯泡', unlockRequirement: { level: 8 }, defaultScale: 0.55 },
  { id: 'deco_late_lv9_orn_furn_01', name: '海岛沙发椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 2280, starValue: 7, icon: 'deco_late_lv9_orn_furn_01', desc: '青绿条纹布艺单椅，白木细腿，清爽客座一角', unlockRequirement: { level: 9 }, defaultScale: 0.95, decorationPanelTab: 'furniture' },
  { id: 'deco_late_lv9_wall_01', name: '青柠水彩画', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 2898, starValue: 8, icon: 'deco_late_lv9_wall_01', desc: '黄绿青柠切片与水彩晕染长幅，无文字', unlockRequirement: { level: 9 }, defaultScale: 1.6 },
  ...
  { id: 'deco_late_lv9_garden_01', name: '香水柠檬树', slot: DecoSlot.GARDEN, rarity: DecoRarity.RARE, cost: 3324, starValue: 9, icon: 'deco_late_lv9_garden_01', desc: '透明底仅树干与树根，无地砖；冠上青柠与花', unlockRequirement: { level: 8 }, defaultScale: 2.8, decorationPanelTab: 'garden' },
  { id: 'deco_late_lv10_shelf_01', name: '自行车花架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 2856, starValue: 8, icon: 'deco_late_lv10_shelf_01', desc: '立式铁艺自行车轮廓作花架，圆环与横梁挂小花盆与藤', unlockRequirement: { level: 9 }, defaultScale: 1.48, decorationPanelTab: 'garden' },
  { id: 'deco_late_lv10_orn_01', name: '迷你洗手台', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 3750, starValue: 5, icon: 'deco_late_lv10_orn_01', desc: '半高柜+小椭圆镜+陶瓷盆与古铜龙头，角落实用', unlockRequirement: { level: 10 }, defaultScale: 1.2, decorationPanelTab: 'furniture' },
  ...
  { id: 'deco_lv15_garden_parasol', name: '海风遮阳伞', slot: DecoSlot.GARDEN, rarity: DecoRarity.RARE, cost: 2730, starValue: 8, icon: 'deco_lv15_garden_parasol', desc: '海盐蓝条纹大伞，浅柚木伞柄与小花盆底座', unlockRequirement: { level: 12 }, defaultScale: 1.65, decorationPanelTab: 'garden' },
  { id: 'deco_lv15_light_drink_cooler', name: '海盐饮品冰柜', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 5250, starValue: 7, icon: 'deco_lv15_light_drink_cooler', desc: '薄荷蓝小冰柜，玻璃门里排着清爽瓶饮与花冰块', unlockRequirement: { level: 11 }, defaultScale: 0.85 },
  ...
  { id: 'deco_lv19_wall_crystal_specimen', name: '水晶标本墙', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 10395, starValue: 11, icon: 'deco_lv19_wall_crystal_specimen', desc: '香槟金展示框里封存蝶翼水晶与干花标本，精致但无文字', unlockRequirement: { level: 19 }, defaultScale: 0.78 },
  { id: 'deco_lv19_orn_crescent_chaise', name: '月牙贵妃榻', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 12285, starValue: 7, icon: 'deco_lv19_orn_crescent_chaise', desc: '月牙形软榻配淡紫丝绒靠垫，适合高级休息角', unlockRequirement: { level: 19 }, defaultScale: 1.18, decorationPanelTab: 'furniture' },
  { id: 'deco_lv19_table_stardust_aroma', name: '星砂香氛台', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 9450, starValue: 9, icon: 'deco_lv19_table_stardust_aroma', desc: '圆角香氛小台摆着星砂玻璃瓶、月白托盘与迷你花束', unlockRequirement: { level: 19 }, defaultScale: 0.98, decorationPanelTab: 'furniture' },
  { id: 'deco_lv20_garden_moon_fountain', name: '月辉喷泉雕塑', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 13265, starValue: 10, icon: 'deco_lv20_garden_moon_fountain', desc: '月牙水晶喷泉与蝶翼雕塑组成庭院压轴大件', unlockRequirement: { level: 20 }, defaultScale: 1.4, decorationPanelTab: 'garden' },
  { id: 'deco_lv20_shelf_star_observatory', name: '星月观景陈列柜', slot: DecoSlot.SHELF, rarity: DecoRarity.LIMITED, cost: 16950, starValue: 9, icon: 'deco_lv20_shelf_star_observatory', desc: '小型观景台式陈列柜，玻璃穹顶里摆着星月花器', unlockRequirement: { level: 20 }, defaultScale: 1.32, decorationPanelTab: 'furniture' },
  { id: 'deco_lv20_wall_moon_sheer_curtain', name: '月纱蝶影帘', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 13450, starValue: 13, icon: 'deco_lv20_wall_moon_sheer_curtain', desc: '挂墙半透明月光纱帘，香槟金帘杆与蝶影坠饰让墙面更轻盈', unlockRequirement: { level: 20 }, defaultScale: 1.8 },
  ...
  { id: 'deco_lv10_table_zen_tea_low', name: '禅意茶台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 1512, starValue: 4, icon: 'deco_lv10_table_zen_tea_low', desc: '矮樱桃木茶台，青瓷茶具与一枝粉梅，安静茶席角落', unlockRequirement: { level: 10 }, defaultScale: 1.18, decorationPanelTab: 'furniture' },
  { id: 'deco_lv10_orn_zen_cushion_pair', name: '蒲团坐垫组', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 1260, starValue: 2, icon: 'deco_lv10_orn_zen_cushion_pair', desc: '玫粉与抹茶绿圆蒲团，配茶台正合适', unlockRequirement: { level: 10 }, defaultScale: 0.95, decorationPanelTab: 'furniture' },
  { id: 'deco_lv11_wallart_zen_ink_scroll', name: '水墨竹影挂轴', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 1345, starValue: 4, icon: 'deco_lv11_wallart_zen_ink_scroll', desc: '宣纸卷轴绘水墨竹与一点粉梅，配暖木轴头', unlockRequirement: { level: 11 }, defaultScale: 1.40 },

  // —— 蘑菇精灵套（坐墩+圆桌+陈列屋+精灵丛；童话森林感，适配蝶屋竹影房）——
  { id: 'deco_lv12_orn_mushroom_stool_pair', name: '蘑菇坐墩组', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 2100, starValue: 4, icon: 'deco_lv12_orn_mushroom_stool_pair', desc: '一红一米双蘑菇坐墩，森系小客座', unlockRequirement: { level: 12 }, defaultScale: 0.85, decorationPanelTab: 'furniture' },
  { id: 'deco_lv13_table_mushroom_round', name: '蘑菇圆茶桌', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 3150, starValue: 5, icon: 'deco_lv13_table_mushroom_round', desc: '粉色蘑菇伞盖做桌面，奶白菌柄做底座', unlockRequirement: { level: 13 }, defaultScale: 0.9, decorationPanelTab: 'furniture' },
  ...
  { id: 'deco_lv15_garden_mushroom_grove', name: '蘑菇精灵丛', slot: DecoSlot.GARDEN, rarity: DecoRarity.RARE, cost: 2940, starValue: 9, icon: 'deco_lv15_garden_mushroom_grove', desc: '三色蘑菇与苔藓丛，配萤火虫提灯', unlockRequirement: { level: 12 }, defaultScale: 1.60, decorationPanelTab: 'garden' },

  // —— 法式咖啡烘焙套（甜品柜+手冲架+复古烤箱+马卡龙塔；适配复古花坊 confetti）——
  { id: 'deco_lv13_table_french_pastry_counter', name: '法式甜品玻璃柜', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 3150, starValue: 6, icon: 'deco_lv13_table_french_pastry_counter', desc: '奶薄荷柜身配玻璃罩，里面摆着马卡龙与小塔', unlockRequirement: { level: 13 }, defaultScale: 1.30, decorationPanelTab: 'furniture' },
  ...
  { id: 'deco_lv15_light_vintage_oven', name: '奶黄复古烤箱', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 5250, starValue: 8, icon: 'deco_lv15_light_vintage_oven', desc: '圆胖奶黄烤箱，玻璃门里看见可颂在烤', unlockRequirement: { level: 12 }, defaultScale: 0.65 },
  ...
  { id: 'deco_lv15_shelf_antique_library', name: '复古胡桃书架', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 3045, starValue: 9, icon: 'deco_lv15_shelf_antique_library', desc: '维多利亚胡桃木书架，皮革精装书与黄铜地球仪', unlockRequirement: { level: 12 }, defaultScale: 1.45 },
  ...
  { id: 'deco_lv19_light_aurora_floor_lantern', name: '极光落地灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 9765, starValue: 10, icon: 'deco_lv19_light_aurora_floor_lantern', desc: '香槟金细杆托起雾面玻璃灯罩，灯罩里流动极光蓝紫', unlockRequirement: { level: 19 }, defaultScale: 1.30 },
  ...
  { id: 'deco_lv19_table_cloud_dessert_island', name: '棉花云中岛', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 10710, starValue: 6, icon: 'deco_lv19_table_cloud_dessert_island', desc: '云朵造型桌面带粉色糖霜流挂，香槟金弯腿与小甜点', unlockRequirement: { level: 19 }, defaultScale: 1, decorationPanelTab: 'furniture' },
  { id: 'deco_lv20_garden_cloud_swing', name: '云端长秋千', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 17505, starValue: 9, icon: 'deco_lv20_garden_cloud_swing', desc: '云朵长椅吊在香槟金 A 形架上，弦月坠与星形抱枕', unlockRequirement: { level: 20 }, defaultScale: 1.9, decorationPanelTab: 'garden' },
  ...
  { id: 'deco_lv11_orn_cat_tower', name: '樱桃猫爬架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 2730, starValue: 4, icon: 'deco_lv11_orn_cat_tower', desc: '蜜木立柱+缠绳+樱桃形顶台与粉色软垫', unlockRequirement: { level: 11 }, defaultScale: 0.9, decorationPanelTab: 'furniture' },
  { id: 'deco_lv11_light_phonograph_vintage', name: '古董留声机', slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE, cost: 1260, starValue: 4, icon: 'deco_lv11_light_phonograph_vintage', desc: '胡桃木底座配黄铜花喇叭，唱针架在黑胶上', unlockRequirement: { level: 11 }, defaultScale: 0.65 },
  { id: 'deco_lv12_orn_pastel_postbox', name: '草莓邮筒', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 2100, starValue: 3, icon: 'deco_lv12_orn_pastel_postbox', desc: '草莓粉立式邮筒，圆胖身段与小信件露出', unlockRequirement: { level: 12 }, defaultScale: 1 },
  { id: 'deco_lv13_orn_teddy_armchair', name: '泰迪熊扶手椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 3150, starValue: 5, icon: 'deco_lv13_orn_teddy_armchair', desc: '小熊造型椅背，焦糖蜜色绒面，配奶色小毯', unlockRequirement: { level: 13 }, defaultScale: 0.85, decorationPanelTab: 'furniture' },
  ...
  { id: 'deco_lv15_light_terrarium_lamp', name: '玻璃花房灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 2415, starValue: 7, icon: 'deco_lv15_light_terrarium_lamp', desc: '尖顶玻璃罩做小温室，里面有暖黄灯泡与小花苔藓', unlockRequirement: { level: 11 }, defaultScale: 0.65 },
  ...
  { id: 'deco_lv20_orn_white_grand_piano', name: '白色三角钢琴', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 62370, starValue: 12, icon: 'deco_lv20_orn_white_grand_piano', desc: '奶白漆三角钢琴，香槟金腿与玫瑰花束、水晶烛台', unlockRequirement: { level: 20 }, defaultScale: 1.5, decorationPanelTab: 'furniture' },
  { id: 'jiangnan_wash_bench', name: '临河浣衣凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 6635, starValue: 1, icon: 'jiangnan_wash_bench', desc: '旧木矮凳叠着白布，底下藤篮装着浣衣日常', unlockRequirement: { level: 20 }, defaultScale: 0.95, decorationPanelTab: 'furniture' },

  // ═══════ ⑭ 仙气古风扩展 Lv21–30（batch53 · 全场景通用 · 家具/摆件/墙饰/庭院 Tab）
  { id: 'xianqi_maple_tier_shelf', name: '果篮层架', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 11840, starValue: 4, icon: 'xianqi_maple_tier_shelf', desc: '三层原木架配藤篮与柿子梨，顶栏枫叶花饰', unlockRequirement: { level: 21 }, defaultScale: 1.75 },
  { id: 'xianqi_maple_round_table', name: '枫影圆几', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 12615, starValue: 5, icon: 'xianqi_maple_round_table', desc: '桦木圆几嵌珊瑚枫叶纹，两只琥珀小茶杯', unlockRequirement: { level: 21 }, defaultScale: 0.88 },
  { id: 'xianqi_maple_incense_stand', name: '香云几', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 11325, starValue: 4, icon: 'xianqi_maple_incense_stand', desc: '双层浅木香案，青瓷香炉与轻烟', unlockRequirement: { level: 22 }, defaultScale: 1.27 },
  { id: 'xianqi_maple_folding_chair', name: '折扇游椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 13125, starValue: 5, icon: 'xianqi_maple_folding_chair', desc: '扇形靠背游椅，桃色坐垫与金扇骨', unlockRequirement: { level: 22 }, defaultScale: 0.98, decorationPanelTab: 'furniture' },
  { id: 'xianqi_plum_padded_stool', name: '暖绒绣墩', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 11070, starValue: 4, icon: 'xianqi_plum_padded_stool', desc: '梅粉绒面圆墩，白木底座配银流苏', unlockRequirement: { level: 23 }, defaultScale: 0.45, decorationPanelTab: 'furniture' },
  { id: 'xianqi_maple_landscape_screen', name: '秋山屏风', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 14415, starValue: 6, icon: 'xianqi_maple_landscape_screen', desc: '四扇绢屏绘珊瑚枫山，奶油木框无文字', unlockRequirement: { level: 23 }, defaultScale: 1.82 },
  { id: 'xianqi_plum_snow_window', name: '梅枝雪窗', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 12225, starValue: 5, icon: 'xianqi_plum_snow_window', desc: '圆月窗框，磨砂玻璃上梅枝与细雪', unlockRequirement: { level: 24 }, defaultScale: 1.28 },
  { id: 'xianqi_plum_snow_basin', name: '雪梅水钵', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 13900, starValue: 6, icon: 'xianqi_plum_snow_basin', desc: '白石水钵浮着淡蓝水面与梅瓣', unlockRequirement: { level: 24 }, defaultScale: 0.92 },
  { id: 'xianqi_plum_wardrobe', name: '雪白轻柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 15185, starValue: 6, icon: 'xianqi_plum_wardrobe', desc: '白漆衣柜嵌银梅枝，淡蓝云形拉手', unlockRequirement: { level: 25 }, defaultScale: 1.45 },
  { id: 'xianqi_plum_canopy_bed', name: '寒梅纱床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 23165, starValue: 8, icon: 'xianqi_plum_canopy_bed', desc: '白木四柱床垂冰蓝梅粉纱幔，雪花刺绣', unlockRequirement: { level: 25 }, defaultScale: 2.2, decorationPanelTab: 'furniture' },
  { id: 'xianqi_koi_twin_stone_seat', name: '双鲤石凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 13660, starValue: 5, icon: 'xianqi_koi_twin_stone_seat', desc: '一对石凳刻鲤纹，青绿软垫', unlockRequirement: { level: 26 }, defaultScale: 0.78, decorationPanelTab: 'furniture' },
  { id: 'xianqi_koi_scale_cabinet', name: '鱼鳞圆柜', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 25630, starValue: 6, icon: 'xianqi_koi_scale_cabinet', desc: '鼓形圆柜门绘青金鱼鳞纹', unlockRequirement: { level: 26 }, defaultScale: 0.92 },
  { id: 'xianqi_koi_wall_fountain', name: '壁泉游鳞', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 18000, starValue: 5, icon: 'xianqi_koi_wall_fountain', desc: '挂墙玉色泉板，金鲤浮雕与细流', unlockRequirement: { level: 27 }, defaultScale: 1.25 },
  { id: 'xianqi_koi_pond_tea_table', name: '临池茶台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 27115, starValue: 7, icon: 'xianqi_koi_pond_tea_table', desc: '矮茶台侧嵌小池，青瓷茶具与游鳞', unlockRequirement: { level: 27 }, defaultScale: 1.82 },
  { id: 'xianqi_orchid_pavilion_mirror', name: '兰月妆镜台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 26080, starValue: 6, icon: 'xianqi_orchid_pavilion_mirror', desc: '淡紫木妆台，圆银镜与兰紫绢屏', unlockRequirement: { level: 28 }, defaultScale: 1.4 },
  { id: 'xianqi_koi_stream_bridge', name: '游鳞小桥', slot: DecoSlot.GARDEN, rarity: DecoRarity.LIMITED, cost: 30085, starValue: 8, icon: 'xianqi_koi_stream_bridge', desc: '青玉短桥金栏，拱下可见锦鲤', unlockRequirement: { level: 28 }, defaultScale: 1.6 },
  { id: 'xianqi_bamboo_mist_fence', name: '翠竹篱段', slot: DecoSlot.GARDEN, rarity: DecoRarity.COMMON, cost: 8710, starValue: 4, icon: 'xianqi_bamboo_mist_fence', desc: '短竹篱系雾灰丝带，清新庭院边栏', unlockRequirement: { level: 29 }, defaultScale: 1 },
  { id: 'xianqi_bamboo_joint_desk', name: '竹节书案', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 19100, starValue: 5, icon: 'xianqi_bamboo_joint_desk', desc: '竹节腿书案，淡绿纸卷与玉镇纸', unlockRequirement: { level: 29 }, defaultScale: 1.18 },
  { id: 'xianqi_bamboo_book_tower', name: '竹筒书塔', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 28890, starValue: 6, icon: 'xianqi_bamboo_book_tower', desc: '竹筒螺旋书塔，素卷与兰芽点缀', unlockRequirement: { level: 29 }, defaultScale: 1.55 },
  { id: 'xianqi_bamboo_mist_daybed', name: '竹影卧榻', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 49500, starValue: 7, icon: 'xianqi_bamboo_mist_daybed', desc: '竹框卧榻配鼠尾草垫，一端垂雾灰纱', unlockRequirement: { level: 29 }, defaultScale: 1.55, decorationPanelTab: 'furniture' },

  // ═══════ ⑭.4 现代生活扩展 Lv25–35（高价常驻 · 电器 / 露营 / 软装 / 店铺小设备）
  { id: 'modern_folding_laundry_rack', name: '阳台折叠晾衣架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 21430, starValue: 4, icon: 'modern_folding_laundry_rack', desc: '白管折叠架挂满柔色衣物，带来阳台生活气', unlockRequirement: { level: 25 }, defaultScale: 1.15, decorationPanelTab: 'furniture' },
  { id: 'modern_kitchen_base_counter', name: '奶油蓝长厨柜', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 31045, starValue: 4, icon: 'modern_kitchen_base_counter', desc: '淡蓝拱形柜门连成一排，奶油台面空无一物，方便摆小家电与摆件', unlockRequirement: { level: 25 }, defaultScale: 1.98, decorationPanelTab: 'furniture' },
  { id: 'modern_hotdog_roller', name: '迷你烤肠机', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 23745, starValue: 5, icon: 'modern_hotdog_roller', desc: '透明罩小烤肠机，银色滚轴与面包托盘，可摆在厨柜台面', unlockRequirement: { level: 21 }, defaultScale: 0.92, depthSortFeetYFudge: 130 },
  { id: 'modern_glass_drink_dispenser', name: '玻璃饮料机', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 24905, starValue: 5, icon: 'modern_glass_drink_dispenser', desc: '双缸水果饮料机，柠檬茶与莓果茶清爽并排，适合厨柜台面', unlockRequirement: { level: 21 }, defaultScale: 0.72, depthSortFeetYFudge: 130 },
  { id: 'modern_camping_tent', name: '奶油露营帐篷', slot: DecoSlot.GARDEN, rarity: DecoRarity.RARE, cost: 41745, starValue: 6, icon: 'modern_camping_tent', desc: '奶油帆布小帐篷配串灯与花盆，庭院立刻有露营感', unlockRequirement: { level: 27 }, defaultScale: 1.65, decorationPanelTab: 'garden' },
  { id: 'modern_picnic_cooler_cart', name: '野餐冰桶推车', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 25485, starValue: 5, icon: 'modern_picnic_cooler_cart', desc: '薄荷冰桶小推车，饮料水果与格纹毯准备好出发', unlockRequirement: { level: 22 }, defaultScale: 1.05, decorationPanelTab: 'furniture' },
  { id: 'modern_plush_cloud_pile', name: '毛绒云朵玩具堆', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 39070, starValue: 5, icon: 'modern_plush_cloud_pile', desc: '云朵、兔兔、小熊与柠檬抱枕叠成软乎乎角落', unlockRequirement: { level: 28 }, defaultScale: 0.9 },
  { id: 'modern_wall_fairy_lights', name: '节日星星串灯', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 37065, starValue: 4, icon: 'modern_wall_fairy_lights', desc: '星星月亮小挂灯串，墙面多一点节日暖光', unlockRequirement: { level: 28 }, defaultScale: 1.25 },
  { id: 'modern_tall_flower_vase', name: '高身鲜花陶瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 35240, starValue: 5, icon: 'modern_tall_flower_vase', desc: '高身奶油陶瓶插满郁金香与小雏菊，清新但有体量', unlockRequirement: { level: 28 }, defaultScale: 0.85 },
  { id: 'modern_capsule_drink_fridge', name: '胶囊饮料冰柜', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 11350, starValue: 4, icon: 'modern_capsule_drink_fridge', desc: '圆角胶囊冰柜排满彩色饮品，可摆在厨柜或台面上', unlockRequirement: { level: 22 }, defaultScale: 0.85, depthSortFeetYFudge: 130 },
  { id: 'modern_waffle_snack_cart', name: '华夫点心小车', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 28725, starValue: 6, icon: 'modern_waffle_snack_cart', desc: '暖橙棚顶小车摆着华夫饼、浆果与糖浆瓶', unlockRequirement: { level: 21 }, defaultScale: 1.05, decorationPanelTab: 'furniture' },
  { id: 'modern_robot_vacuum_dock', name: '圆圆扫地机座', slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE, cost: 20940, starValue: 5, icon: 'modern_robot_vacuum_dock', desc: '猫耳扫地机停在充电座旁，店里也要轻松保持整洁', unlockRequirement: { level: 29 }, defaultScale: 0.85 },
  ...
  { id: 'modern_citrus_soda_machine', name: '柑橘气泡饮料机', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 32430, starValue: 6, icon: 'modern_citrus_soda_machine', desc: '橙黄色气泡饮料机，玻璃缸里冒着柑橘泡泡，适合厨柜台面', unlockRequirement: { level: 22 }, defaultScale: 0.72, depthSortFeetYFudge: 130 },
  ...
  { id: 'modern_countertop_icecream_machine', name: '软冰淇淋机', slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE, cost: 36485, starValue: 7, icon: 'modern_countertop_icecream_machine', desc: '薄荷奶油色冰淇淋机，两个小甜筒刚好接住软雪糕，适合厨柜台面', unlockRequirement: { level: 24 }, defaultScale: 0.72, depthSortFeetYFudge: 130 },
  ...
  { id: 'modern_plush_clownfish', name: '小丑鱼玩偶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 36000, starValue: 7, icon: 'modern_plush_clownfish', desc: '橙白条纹小丑鱼毛绒，圆眼睛与短鳍摇摇晃晃，像从水族箱跳出来的', unlockRequirement: { level: 36 }, defaultScale: 0.7 },
  { id: 'modern_plush_tree_spirit', name: '树人玩偶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 27000, starValue: 8, icon: 'modern_plush_tree_spirit', desc: '苔藓绿小树人毛绒，叶子头发与胸前花苞，森林精灵也软乎乎', unlockRequirement: { level: 37 }, defaultScale: 0.75 },

  // ═══════ ⑭.4b 海蓝慵懒夏日 Lv38–45（参考地中海阳台蓝系软装）
  { id: 'azure_lazy_wicker_loveseat', name: '海蓝藤编双人沙发', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 44565, starValue: 7, icon: 'azure_lazy_wicker_loveseat', desc: '浅藤编低沙发配天蓝坐垫，星图毯与柠檬片抱枕，慵懒午后标配', unlockRequirement: { level: 38 }, defaultScale: 1.35, decorationPanelTab: 'furniture' },
  { id: 'azure_lazy_wicker_armchair', name: '海蓝藤编单椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 36465, starValue: 7, icon: 'azure_lazy_wicker_armchair', desc: '圆角藤编单椅搭粉蓝猫脸抱枕，一个人也能窝着发呆', unlockRequirement: { level: 39 }, defaultScale: 1.05, decorationPanelTab: 'furniture' },
  { id: 'azure_lazy_ladder_towel_rack', name: '海蓝梯式毛巾架', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 28695, starValue: 6, icon: 'azure_lazy_ladder_towel_rack', desc: '天蓝木梯挂着柔色毛巾与海星小挂饰，像迷你阳台角落', unlockRequirement: { level: 40 }, defaultScale: 1.3, decorationPanelTab: 'furniture' },
  ...
  { id: 'gucha_tea_bench', name: '茶寮长凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 4375, starValue: 1, icon: 'gucha_tea_bench', desc: '素木长凳磨得发亮，台面留着一圈茶渍印', unlockRequirement: { level: 25 }, defaultScale: 1.1, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'jiangnan_lattice_window', name: '花窗栏', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 12615, starValue: 5, icon: 'jiangnan_lattice_window', desc: '冰裂纹花窗格，淡蓝天空映在磨砂玻璃上', unlockRequirement: { level: 25 }, defaultScale: 1.28, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'gucha_water_jar', name: '陶瓮水缸', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 11840, starValue: 4, icon: 'gucha_water_jar', desc: '粗陶大水瓮配竹勺，茶寮取水必备', unlockRequirement: { level: 25 }, defaultScale: 0.82, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'gucha_charcoal_brazier', name: '竹风炉', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 24145, starValue: 5, icon: 'gucha_charcoal_brazier', desc: '竹编风炉炭火微红，陶壶上袅袅茶烟', unlockRequirement: { level: 26 }, defaultScale: 0.88, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'jiangnan_rattan_daybed', name: '藤枕榻', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 28010, starValue: 7, icon: 'jiangnan_rattan_daybed', desc: '竹框卧榻配靛蓝垫与青花枕，午后小憩位', unlockRequirement: { level: 26 }, defaultScale: 1.55, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'gucha_tea_boat', name: '茶则舟', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 25040, starValue: 5, icon: 'gucha_tea_boat', desc: '竹茶船托盘上摆着盖碗与公道杯', unlockRequirement: { level: 27 }, defaultScale: 1.05, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'jiangnan_willow_cart', name: '柳编花车', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 27900, starValue: 6, icon: 'jiangnan_willow_cart', desc: '柳编小车木轮，桶里盛着牡丹与荷花', unlockRequirement: { level: 27 }, defaultScale: 1.22, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'gucha_tea_chest', name: '封箱茶仓', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 17525, starValue: 6, icon: 'gucha_tea_chest', desc: '双层木架堆着蜡封茶砖与纸包', unlockRequirement: { level: 28 }, defaultScale: 1.35, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'xianxia_herb_rack', name: '悬索晒药架', slot: DecoSlot.SHELF, rarity: DecoRarity.FINE, cost: 26080, starValue: 6, icon: 'xianxia_herb_rack', desc: '竹架悬着干花束与草药纸包，茶香伴药香', unlockRequirement: { level: 28 }, defaultScale: 1.68, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  { id: 'jiangnan_blue_cabinet', name: '青花博古柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 31070, starValue: 7, icon: 'jiangnan_blue_cabinet', desc: '红木博古架陈列青花瓶盏与折扇', unlockRequirement: { level: 29 }, defaultScale: 1.65, decorationPanelTab: 'flower_room', allowedSceneIds: ['tea_house'] },
  ...
  { id: 'sea_wheel_wall', name: '舵轮墙挂', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 12600, starValue: 7, icon: 'sea_wheel_wall', desc: '旧木舵轮悬在麻绳上，黄铜毂心闪着冒险光泽', unlockRequirement: { level: 35 }, defaultScale: 0.92, decorationPanelTab: 'flower_room', allowedSceneIds: ['forest_treehouse'] },
  { id: 'sea_anchor_bench', name: '船锚绳凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 30780, starValue: 7, icon: 'sea_anchor_bench', desc: '锈色船锚作靠背，麻绳缠腿托着木纹坐板', unlockRequirement: { level: 36 }, defaultScale: 1.28, decorationPanelTab: 'flower_room', allowedSceneIds: ['forest_treehouse'] },
  { id: 'sea_treasure_chest', name: '珍珠藏箱', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 31320, starValue: 8, icon: 'sea_treasure_chest', desc: '橡木宝箱半开，珍珠珊瑚与黄铜罗盘满溢而出', unlockRequirement: { level: 37 }, defaultScale: 1.02, decorationPanelTab: 'flower_room', allowedSceneIds: ['forest_treehouse'] },
  { id: 'sea_coral_cabinet', name: '珊瑚展柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 31950, starValue: 8, icon: 'sea_coral_cabinet', desc: '拱顶玻璃木柜，粉珊瑚与贝壳分层陈列', unlockRequirement: { level: 38 }, defaultScale: 1.58, decorationPanelTab: 'flower_room', allowedSceneIds: ['forest_treehouse'] },

  // ═══════ ⑭.7 梦云小屋专属家具（dream_cloud_house Lv20–24 · 梦幻卧室休闲套）
  { id: 'dream_cloud_bed', name: '月云大软床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 61425, starValue: 8, icon: 'dream_cloud_bed', desc: '云朵床框托起浅紫绗缝被，月亮与星星抱枕软乎乎地窝在床头', unlockRequirement: { level: 20 }, defaultScale: 1.95, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },
  { id: 'dream_cloud_sofa', name: '星月转角沙发', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 51595, starValue: 8, icon: 'dream_cloud_sofa', desc: '奶油白大转角沙发配粉紫蓝抱枕，像睡前云朵客厅一样柔软', unlockRequirement: { level: 20 }, defaultScale: 2.18, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },
  { id: 'dream_cloud_star_rug', name: '星云软绒地毯', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 21995, starValue: 6, icon: 'dream_cloud_star_rug', desc: '浅蓝星云绒毯铺在月石地面上，轻柔星光像云雾一样散开', unlockRequirement: { level: 21 }, defaultScale: 1.65, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'], depthSortYLift: 0, depthSortFloorMat: true },
  { id: 'dream_cloud_moon_nightstand', name: '月灯床头柜', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 22930, starValue: 6, icon: 'dream_cloud_moon_nightstand', desc: '小云柜托着暖黄色月牙夜灯，星星抽屉把手带来睡前微光', unlockRequirement: { level: 21 }, defaultScale: 1.15, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },
  { id: 'dream_cloud_star_vanity', name: '星镜梳妆台', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 37205, starValue: 7, icon: 'dream_cloud_star_vanity', desc: '粉紫梳妆台配星形镜框和月金描边，适合摆在梦云卧室一角', unlockRequirement: { level: 22 }, defaultScale: 1.48, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },
  { id: 'dream_cloud_tea_table', name: '薄荷云茶几', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 24335, starValue: 6, icon: 'dream_cloud_tea_table', desc: '薄荷蓝圆茶几踩着云朵小脚，月金边框和小茶具让休闲角更温柔', unlockRequirement: { level: 22 }, defaultScale: 1.24, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },
  { id: 'dream_cloud_bookshelf', name: '浮云星书架', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 25505, starValue: 6, icon: 'dream_cloud_bookshelf', desc: '漂浮云朵书架摆着彩色睡前书和水晶月球，下方垂着小星星', unlockRequirement: { level: 23 }, defaultScale: 1.32, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },
  { id: 'dream_cloud_crescent_cushion', name: '月牙懒人坐垫', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 26675, starValue: 6, icon: 'dream_cloud_crescent_cushion', desc: '金黄月牙抱着软垫和星星靠枕，是二楼休闲角的梦境座位', unlockRequirement: { level: 23 }, defaultScale: 1.18, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },
  { id: 'dream_cloud_floor_lamp', name: '星梦落地灯', slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE, cost: 20475, starValue: 6, icon: 'dream_cloud_floor_lamp', desc: '云朵底座托起细高灯杆，月星灯罩洒下温暖睡前光', unlockRequirement: { level: 24 }, defaultScale: 1.28, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },
  { id: 'dream_cloud_storage_chest', name: '梦境收纳箱', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 23165, starValue: 6, icon: 'dream_cloud_storage_chest', desc: '奶油云朵箱身配浅紫箱盖，月牙锁扣收藏睡前小秘密', unlockRequirement: { level: 24 }, defaultScale: 0.98, decorationPanelTab: 'flower_room', allowedSceneIds: ['dream_cloud_house'] },
  ...
  { id: 'farm_fu_sticker_wall', name: '福字贴纸', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 18255, starValue: 8, icon: 'farm_fu_sticker_wall', desc: '菱形大红福字贴纸，贴在院墙添年味', unlockRequirement: { level: 34 }, defaultScale: 0.92, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_farm_house'] },
  { id: 'farm_ivy_wall', name: '满墙爬山虎', slot: DecoSlot.WALLART, rarity: DecoRarity.RARE, cost: 35010, starValue: 8, icon: 'farm_ivy_wall', desc: '鲜绿爬山虎从墙脚爬满大半墙面，春意盎然', unlockRequirement: { level: 34 }, defaultScale: 2.08, decorationPanelTab: 'flower_room', allowedSceneIds: ['flower_farm_house'] },
  ...
  { id: 'ancient_inkstone_desk', name: '砚台书案', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 37535, starValue: 6, icon: 'ancient_inkstone_desk', desc: '红木矮案嵌砚台，青瓷水盂与笔搁一字排开', unlockRequirement: { level: 29 }, defaultScale: 1.2 },
  ...
  { id: 'cake_orn_wedding_cake_centerpiece', name: '婚礼蛋糕台',  slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 16215, starValue: 18, icon: 'cake_orn_wedding_cake_centerpiece', desc: '三层奶白翻糖蛋糕配粉玫瑰与糖珠，瓷台金边', unlockRequirement: { level: 20 }, defaultScale: 1.10, decorationPanelTab: 'flower_room', allowedSceneIds: ['cake_shop'] },
