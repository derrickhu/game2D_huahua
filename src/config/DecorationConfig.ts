...
export const DECO_DEFS: DecoDef[] = [
  ...
  { id: 'shelf_glass',   name: '玻璃展示柜',  slot: DecoSlot.SHELF, rarity: DecoRarity.RARE,   cost: 2025, starValue: 6, icon: 'shelf_glass',  desc: '高端玻璃门展示柜', unlockRequirement: { level: 10 }, defaultScale: 1.45 },
  ...
  { id: 'light_crystal',  name: '水晶灯',      slot: DecoSlot.LIGHT, rarity: DecoRarity.RARE,   cost: 1940, starValue: 4, icon: 'light_crystal', desc: '华丽的水晶折射光芒', unlockRequirement: { level: 10 }, defaultScale: 1.1 },
  ...
  { id: 'wallart_relief', name: '艺术浮雕',    slot: DecoSlot.WALLART, rarity: DecoRarity.RARE,   cost: 2280, starValue: 3, icon: 'wallart_relief', desc: '精致的花卉浮雕壁饰', unlockRequirement: { level: 10 }, defaultScale: 0.67 },
  { id: 'wallart_window_meadow_arch', name: '拱窗花野景', slot: DecoSlot.WALLART, rarity: DecoRarity.FINE, cost: 2060, starValue: 4, icon: 'wallart_window_meadow_arch', desc: '奶油木拱窗里收进一片花野与蝶影', unlockRequirement: { level: 10 }, defaultScale: 1.32 },
  ...
  { id: 'orn_flora_blooming_cactus', name: '开花仙人球', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 5000, starValue: 1, icon: 'orn_flora_blooming_cactus', desc: '陶盆里的圆滚滚仙人掌，顶着一朵艳粉花', unlockRequirement: { level: 7 }, defaultScale: 0.52 },
  { id: 'orn_flora_fern_terrarium', name: '蕨类生态瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 6000, starValue: 1, icon: 'orn_flora_fern_terrarium', desc: '软木塞玻璃罐里迷你苔藓与蕨叶', unlockRequirement: { level: 8 }, defaultScale: 0.48 },
  { id: 'orn_flora_hyacinth_glass_vase', name: '风信子水培瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 7000, starValue: 2, icon: 'orn_flora_hyacinth_glass_vase', desc: '球形玻璃瓶里紫粉风信子簇', unlockRequirement: { level: 9 }, defaultScale: 0.72 },
  { id: 'orn_flora_wildflower_mason_jar', name: '野花花束罐', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 8000, starValue: 1, icon: 'orn_flora_wildflower_mason_jar', desc: '蓝色梅森罐扎着虞美人与矢车菊', unlockRequirement: { level: 10 }, defaultScale: 0.76 },
  ...
  { id: 'butterfly_house_study_field_stool', name: '野趣折叠凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 1840, starValue: 2, icon: 'butterfly_house_study_field_stool', desc: '木架帆布折叠凳，侧挂小布包，适合温室野趣角', unlockRequirement: { level: 10 }, defaultScale: 0.88, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
  ...
  { id: 'villa_planter_urn', name: '玫瑰花卉瓮', slot: DecoSlot.GARDEN, rarity: DecoRarity.FINE, cost: 3780, starValue: 4, icon: 'villa_planter_urn', desc: '陶瓮盛满浅粉玫瑰，摆在庭院或门廊都很体面', unlockRequirement: { level: 10 }, defaultScale: 1.32, decorationPanelTab: 'garden' },
  ...
  { id: 'season_autumn_table', name: '枫叶柜台', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 3295, starValue: 5, icon: 'table_autumn', desc: '铺满红叶的木质柜台', unlockRequirement: { level: 10 }, defaultScale: 1.48 },
  ...
  { id: 'season_winter_orn', name: '节庆壁炉', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 3800, starValue: 6, icon: 'orn_christmas', desc: '圣诞袜花环灯串，精致柔线稿', unlockRequirement: { level: 10 }, defaultScale: 1.3, decorationPanelTab: 'furniture' },
  ...
  { id: 'deco_late_lv10_orn_01', name: '迷你洗手台', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 3125, starValue: 5, icon: 'deco_late_lv10_orn_01', desc: '半高柜+小椭圆镜+陶瓷盆与古铜龙头，角落实用', unlockRequirement: { level: 10 }, defaultScale: 1.2, decorationPanelTab: 'furniture' },
  ...
  { id: 'deco_lv10_table_zen_tea_low', name: '禅意茶台', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 1260, starValue: 4, icon: 'deco_lv10_table_zen_tea_low', desc: '矮樱桃木茶台，青瓷茶具与一枝粉梅，安静茶席角落', unlockRequirement: { level: 10 }, defaultScale: 1.18, decorationPanelTab: 'furniture' },
  { id: 'deco_lv10_orn_zen_cushion_pair', name: '蒲团坐垫组', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 1050, starValue: 2, icon: 'deco_lv10_orn_zen_cushion_pair', desc: '玫粉与抹茶绿圆蒲团，配茶台正合适', unlockRequirement: { level: 10 }, defaultScale: 0.95, decorationPanelTab: 'furniture' },
  ...
  { id: 'deco_lv10_orn_kitten_bed', name: '奶油猫窝', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.COMMON, cost: 2100, starValue: 2, icon: 'deco_lv10_orn_kitten_bed', desc: '奶白绒毛甜甜圈猫窝，里面有针织球与粉毯', unlockRequirement: { level: 10 }, defaultScale: 0.72, decorationPanelTab: 'furniture' },
  ...
  { id: 'qinglian_cloud_book_desk', name: '祥云书案', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 12285, starValue: 4, icon: 'qinglian_cloud_book_desk', desc: '浅木书案配祥云腿雕，青瓷笔架与素卷', unlockRequirement: { level: 10 }, defaultScale: 1.30, decorationPanelTab: 'qinglian' },
