...
export const DECO_DEFS: DecoDef[] = [
  ...
  { id: 'workshop_round_nest_bed', name: '圆窝软床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 10, icon: 'workshop_round_nest_bed', desc: '工坊匠心：奶白圆形软窝床配正红抱枕，低趴慵懒可染色', workshopExclusive: true, defaultScale: 1.95, decorationPanelTab: 'furniture' },
  { id: 'workshop_round_nest_bed_honey', name: '蜜黄圆窝软床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 10, icon: 'workshop_round_nest_bed_honey', desc: '工坊染色：奶白圆窝配蜜黄抱枕，同款圆形软床', workshopExclusive: true, defaultScale: 1.95, decorationPanelTab: 'furniture' },
  { id: 'workshop_round_nest_bed_sakura', name: '樱粉圆窝软床', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.LIMITED, cost: 0, starValue: 10, icon: 'workshop_round_nest_bed_sakura', desc: '工坊染色：奶油圆窝配樱粉抱枕，同款圆形软床', workshopExclusive: true, defaultScale: 1.95, decorationPanelTab: 'furniture' },
  ...
  // ═══════ ⑩.6 花园别墅专属家具（garden_villa Lv35–38 · 法式沙龙 / 奶油厨餐 / 月光卧室）═══════
  { id: 'villa_salon_curved_sofa', name: '弧形玫瑰沙发', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.RARE, cost: 52000, starValue: 8, icon: 'villa_salon_curved_sofa', desc: '豆沙玫瑰弧形双人沙发，奶油滚边与深木短腿，沙龙客厅焦点', unlockRequirement: { level: 35 }, defaultScale: 1.78, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  { id: 'villa_salon_marble_tea', name: '玫瑰花座茶几', slot: DecoSlot.TABLE, rarity: DecoRarity.FINE, cost: 42000, starValue: 7, icon: 'villa_salon_marble_tea', desc: '玫瑰浮雕花座托起粉纹大理石面，沙龙客厅一眼认出的贵气茶几', unlockRequirement: { level: 35 }, defaultScale: 1.28, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  ...
  { id: 'villa_kitchen_island', name: '奶油中岛橱柜', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 58000, starValue: 8, icon: 'villa_kitchen_island', desc: '奶油柜身配淡石台面与金龙头，开放厨房的中心岛', unlockRequirement: { level: 35 }, defaultScale: 1.55, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  { id: 'villa_kitchen_fridge', name: '高柜双门冰箱', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 54000, starValue: 8, icon: 'villa_kitchen_fridge', desc: '奶油双门冰箱配香槟金把手，轻奢厨房标配家电', unlockRequirement: { level: 36 }, defaultScale: 1.62, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  { id: 'villa_dining_long_table', name: '橡木长餐桌', slot: DecoSlot.TABLE, rarity: DecoRarity.RARE, cost: 56000, starValue: 8, icon: 'villa_dining_long_table', desc: '蜂蜜橡木长桌铺奶油桌旗，四人餐位立刻像样', unlockRequirement: { level: 36 }, defaultScale: 1.48, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  { id: 'villa_dining_chair_pair', name: '高背丝绒餐椅', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 41200, starValue: 6, icon: 'villa_dining_chair_pair', desc: '豆沙高背丝绒餐椅，金钉滚边，一把就撑起餐桌仪式感', unlockRequirement: { level: 37 }, defaultScale: 1.22, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  { id: 'villa_kitchen_pendant', name: '奶油双炉烤箱灶', slot: DecoSlot.LIGHT, rarity: DecoRarity.FINE, cost: 43800, starValue: 7, icon: 'villa_kitchen_pendant', desc: '奶油双层烤箱配四眼灶台与金旋钮，别墅厨房的烟火核心', unlockRequirement: { level: 37 }, defaultScale: 1.48, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
  { id: 'villa_kitchen_sideboard', name: '餐边收纳柜', slot: DecoSlot.SHELF, rarity: DecoRarity.RARE, cost: 52500, starValue: 8, icon: 'villa_kitchen_sideboard', desc: '奶油餐边柜配浅木台面，碗碟与花瓶都有了归宿', unlockRequirement: { level: 38 }, defaultScale: 1.52, decorationPanelTab: 'flower_room', allowedSceneIds: ['garden_villa'] },
