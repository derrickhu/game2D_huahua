...
export const DECO_DEFS: DecoDef[] = [
  ...
  { id: 'orn_flora_hyacinth_glass_vase', name: '风信子水培瓶', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 1560, starValue: 2, icon: 'orn_flora_hyacinth_glass_vase', desc: '球形玻璃瓶里紫粉风信子簇', unlockRequirement: { level: 9 }, defaultScale: 0.72 },
  ...
  { id: 'table_square_bistro',  name: '方桌',         slot: DecoSlot.TABLE,    rarity: DecoRarity.COMMON, cost: 648,  starValue: 3, icon: 'table_square_bistro',  desc: '方正好用的边角桌', unlockRequirement: { level: 4 },  defaultScale: 1.4,  decorationPanelTab: 'furniture' },
  ...
  { id: 'butterfly_house_study_field_stool', name: '野趣折叠凳', slot: DecoSlot.ORNAMENT, rarity: DecoRarity.FINE, cost: 2200, starValue: 2, icon: 'butterfly_house_study_field_stool', desc: '木架帆布折叠凳，侧挂小布包，适合温室野趣角', unlockRequirement: { level: 10 }, defaultScale: 0.88, decorationPanelTab: 'flower_room', allowedSceneIds: ['butterfly_house'] },
