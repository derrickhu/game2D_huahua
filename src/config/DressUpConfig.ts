...
export const ALL_OUTFITS: Outfit[] = [
  ...
  { id: 'outfit_florist',  name: '花店小姐姐',  desc: '专业花艺师的精致工装，满满花香',            icon: '💐', hualuCost: 240, unlockRequirement: { level: 2 } },
  { id: 'outfit_spring',   name: '春日樱花',    desc: '樱花盛开的季节，粉嫩少女感满分',           icon: '🌸', hualuCost: 450, unlockRequirement: { level: 4 } },
  { id: 'outfit_summer',   name: '夏日向日葵',  desc: '明媚阳光下，活力四射的夏日装扮',           icon: '🌻', hualuCost: 450, unlockRequirement: { level: 4 } },
  { id: 'outfit_vintage',  name: '复古花坊',    desc: '优雅复古的欧式风情，精致迷人',             icon: '🎀', hualuCost: 900, unlockRequirement: { level: 8 } },
