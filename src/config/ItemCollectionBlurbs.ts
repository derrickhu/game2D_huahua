...
const ITEM_UNLOCK_BLURB_EXTRA: Record<string, string> = {
  ...
  drink_dessert_5: '淡蓝淋面托着蓝莓，一口凉意漫上来。',
  drink_dessert_6: '双果和夹层一起出现，层次终于变得分明。',
  drink_dessert_7: '什果铺满圆面，已经有了招牌蛋糕的样子。',
  drink_dessert_8: '奶油蓬松如云朵，巧酱细细点缀，甜意刚刚好。',
  ...
  tool_farm_1: '第一把小锄头，准备把果香种进花园。',
  tool_farm_2: '荒地翻开，等一场甜甜的发芽。',
  tool_farm_3: '果田初成，红绿黄紫的收获快来了。',
  tool_farm_4: '丰收大果田，一铲一浇都是满格果香。',
  tool_fruit_cut_1: '小刀亮起，水果有了新吃法。',
  tool_fruit_cut_2: '砧板摆好，切片切块都更顺手。',
  tool_fruit_cut_3: '果切盘一上桌，颜色也变成了招牌。',
  tool_fruit_cut_4: '高级果切台出手，整果直接变成精致拼盘。',

  food_fruit_strawberry_1: '红红一颗，甜香从指尖冒出来。',
  food_fruit_watermelon_1: '圆滚滚的大西瓜，切开就是夏天。',
  food_fruit_pineapple_1: '金黄菠萝带着小冠，热带气息很醒目。',
  food_fruit_grape_1: '紫葡萄一串串，像小小的水晶铃。',
  food_cut_strawberry_1: '草莓切成小杯，颜色先甜了起来。',
  food_cut_strawberry_2: '莓果像花一样排开，少女心满格。',
  food_cut_strawberry_3: '莓红果切盘端上桌，酸甜香气很有记忆点。',
  food_cut_watermelon_1: '西瓜块清清爽爽，第一口就很解暑。',
  food_cut_watermelon_2: '西瓜杯叠出红绿层次，拿在手里像小夏天。',
  food_cut_watermelon_3: '西瓜披萨盘切面漂亮，派对感一下来了。',
  food_cut_pineapple_1: '菠萝块金灿灿，酸甜味醒得很快。',
  food_cut_pineapple_2: '菠萝船装满果香，像从热带小岛驶来。',
  food_cut_pineapple_3: '热带菠萝盘层次丰富，亮黄色一眼就能认出。',
  food_cut_grape_1: '葡萄串杯晶莹圆润，紫色很乖。',
  food_cut_grape_2: '葡萄晶冻杯透着清凉，像小小紫水晶。',
  food_cut_grape_3: '紫晶葡萄盘闪闪发亮，高级果切的压轴色。',
