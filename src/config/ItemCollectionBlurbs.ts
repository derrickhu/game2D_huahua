...
const ITEM_UNLOCK_BLURB_EXTRA: Record<string, string> = {
  ...
  food_fruit_avocado_1: '深绿一颗，摸上去有点糙，切开才见奶黄。',
  food_fruit_watermelon_1: '圆滚滚的大西瓜，切开就是夏天。',
  food_fruit_pineapple_1: '金黄菠萝带着小冠，热带气息很醒目。',
  food_fruit_dragonfruit_1: '玫红外皮像鳞片，整颗就很有热带味。',
  food_cut_avocado_1: '半切露大核，绿皮黄肉一眼分得清。',
  food_cut_avocado_2: '木盘扇排牛油果片，配青柠角很清爽。',
  food_cut_avocado_3: '粗陶碗盛牛油果丁，圣女果和玉米粒点彩。',
  food_cut_watermelon_1: '四分之一西瓜角，红绿分明，第一口就很解暑。',
  food_cut_watermelon_2: '竹盘扇排西瓜片，配薄荷叶，清爽又体面。',
  food_cut_watermelon_3: '藤编果篮盛方块西瓜，点缀莓果与猕猴桃，派对感来了。',
  food_cut_pineapple_1: '厚切菠萝环片，金肉中空，热带味先到了。',
  food_cut_pineapple_2: '竹盘扇排菠萝楔，樱桃点缀，亮黄很精神。',
  food_cut_pineapple_3: '半壳菠萝船满装果块，猕猴桃和樱桃一起上。',
  food_cut_dragonfruit_1: '半切白肉黑籽，玫红外皮像一圈花边。',
  food_cut_dragonfruit_2: '粉边瓷盘排圆片，芒果粒和蓝莓打破单色。',
  food_cut_dragonfruit_3: '粉漆礼盒浅盘，方块火龙果配热带点缀，压轴感足。',
