...
export const BOARD_PRESETS: CellPreset[] = [
  // ── 第0行 - 外围迷雾 ──
  { row: 0, col: 0, state: CellState.FOG,  itemId: 'tool_plant_6',       keyPrice: 0, unlockPriority: 40 },
  ...
  { row: 0, col: 6, state: CellState.FOG,  itemId: 'tool_tea_set_5',      keyPrice: 0, unlockPriority: 45 },

  // ── 第1行 - 外围迷雾/窥视 ──
  { row: 1, col: 0, state: CellState.FOG,  itemId: 'drink_dessert_3',     keyPrice: 0, unlockPriority: 36 },
  { row: 1, col: 1, state: CellState.FOG,  itemId: 'flower_fresh_3',      keyPrice: 0, unlockPriority: 25 },
  { row: 1, col: 2, state: CellState.PEEK, itemId: 'flower_bouquet_2',    keyPrice: 0, unlockPriority: 15 },
  { row: 1, col: 3, state: CellState.FOG,  itemId: null,                  keyPrice: 0, unlockPriority: 26 },
  { row: 1, col: 4, state: CellState.PEEK, itemId: 'flower_fresh_2',      keyPrice: 0, unlockPriority: 16 },
  ...
  { row: 2, col: 1, state: CellState.PEEK, itemId: 'flower_fresh_3',      keyPrice: 0, unlockPriority: 17 },
  ...
  // ── 第3行 - 初始核心区 ──
  { row: 3, col: 0, state: CellState.FOG,  itemId: 'flower_bouquet_3',    keyPrice: 0, unlockPriority: 28 },
  ...
  { row: 5, col: 1, state: CellState.FOG,  itemId: 'tool_plant_2',        keyPrice: 0, unlockPriority: 20 },
  { row: 5, col: 2, state: CellState.FOG,  itemId: null,                  keyPrice: 0, unlockPriority: 21 },
  { row: 5, col: 3, state: CellState.FOG,  itemId: 'flower_fresh_1',      keyPrice: 0, unlockPriority: 22 },
  { row: 5, col: 4, state: CellState.FOG,  itemId: null,                  keyPrice: 0, unlockPriority: 23 },
  { row: 5, col: 5, state: CellState.FOG,  itemId: 'tool_tea_set_2',      keyPrice: 0, unlockPriority: 24 },
  ...
  { row: 6, col: 1, state: CellState.PEEK, itemId: 'flower_green_2',       keyPrice: 0, unlockPriority: 34 },
  { row: 6, col: 2, state: CellState.FOG,  itemId: 'tool_arrange_1',      keyPrice: 0, unlockPriority: 47 },
  ...
  { row: 6, col: 5, state: CellState.PEEK, itemId: 'flower_bouquet_3',    keyPrice: 0, unlockPriority: 50 },
  ...
  { row: 7, col: 2, state: CellState.FOG,  itemId: 'tool_plant_6',       keyPrice: 0, unlockPriority: 54 },
  { row: 7, col: 3, state: CellState.FOG,  itemId: null,                  keyPrice: 0, unlockPriority: 55 },
  { row: 7, col: 4, state: CellState.FOG,  itemId: 'tool_tea_set_5',      keyPrice: 0, unlockPriority: 56 },
  ...
  { row: 8, col: 2, state: CellState.FOG,  itemId: 'flower_green_4',       keyPrice: 0, unlockPriority: 61 },
