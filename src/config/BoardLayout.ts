...
export const BOARD_PRESETS: CellPreset[] = [
  ...
  { row: 3, col: 0, state: CellState.FOG,  itemId: 'flower_bouquet_6', keyPrice: 0, unlockPriority: 50 },
  ...
  { row: 3, col: 6, state: CellState.FOG,  itemId: 'drink_tea_6',      keyPrice: 0, unlockPriority: 54 },

  { row: 4, col: 0, state: CellState.FOG,  itemId: 'flower_green_5',   keyPrice: 0, unlockPriority: 40 },
  { row: 4, col: 1, state: CellState.FOG,  itemId: 'flower_bouquet_3', keyPrice: 0, unlockPriority: 41 },
  ...
  { row: 5, col: 3, state: CellState.FOG,  itemId: 'drink_tea_2',      keyPrice: 0, unlockPriority: 36 },
  { row: 5, col: 4, state: CellState.FOG,  itemId: 'flower_green_1',   keyPrice: 0, unlockPriority: 37 },
  { row: 5, col: 5, state: CellState.FOG,  itemId: 'tool_tea_set_2',   keyPrice: 0, unlockPriority: 38 },
  ...
  { row: 6, col: 5, state: CellState.FOG,  itemId: 'flower_bouquet_4', keyPrice: 0, unlockPriority: 25 },
  ...
  { row: 7, col: 3, state: CellState.FOG,  itemId: 'drink_tea_5',      keyPrice: 0, unlockPriority: 13 },
  { row: 7, col: 4, state: CellState.FOG,  itemId: 'flower_bouquet_5', keyPrice: 0, unlockPriority: 14 },
  { row: 7, col: 5, state: CellState.FOG,  itemId: 'tool_mixer_4',     keyPrice: 0, unlockPriority: 15 },
