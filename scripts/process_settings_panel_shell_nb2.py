#!/usr/bin/env python3
"""
设置面板壳：NB2 绿幕原图 → 四边洪水去绿 → 轻量绿边 despill → 入库。

用法（仓库根）:
  python3 scripts/process_settings_panel_shell_nb2.py [raw.png]
"""
...
SRC_DEFAULT = os.path.join(REPO, "../game_assets/huahua/assets/raw/settings_panel_shell_nb2.png")
OUT = os.path.join(REPO, "minigame/subpkg_panels/images/ui/settings_panel_shell_nb2.png")
