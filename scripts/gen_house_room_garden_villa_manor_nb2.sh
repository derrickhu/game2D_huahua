#!/usr/bin/env bash
# NB2 生成花园别墅西式双层房壳 → rembg → 写入 minigame/house
# 布局锁：bg_room_tea_house_xianqi_two_story_nb2.png（双层 cutaway 结构，材质换欧式花园洋房）
set -euo pipefail
...
NAME="bg_room_garden_villa_manor_nb2"
PROMPT="house_bg_room_garden_villa_manor_nb2_prompt.txt"
...
echo "== NB2 $NAME (ref: xianqi two-story layout) =="
