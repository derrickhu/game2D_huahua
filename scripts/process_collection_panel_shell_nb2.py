#!/usr/bin/env python3
"""
图鉴面板壳：NB2 / GenerateImage 绿幕原图 → 四边洪水去绿 → 轻量绿边 despill → 入库。

UI 整页壳体勿用 rembg。

用法（仓库根）:
  python3 scripts/process_collection_panel_shell_nb2.py [raw.png]
"""
...
SRC_DEFAULT = os.path.join(
    REPO, "../game_assets/huahua/assets/raw/collection_panel_shell_v4_painted_nb2.png"
)
OUT = os.path.join(
    REPO, "minigame/subpkg_panels/images/ui/collection_panel_shell_nb2.png"
)
